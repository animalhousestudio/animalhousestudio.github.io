...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function Xc(){return new li({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:_a(),fragmentShader:`
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function jc(){return new li({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:_a(),fragmentShader:`
...
`)}function Qg(s,e){const t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(e,i),o=r.name;let a=1;r.type===s.FLOAT_MAT2&&(a=2),r.type===s.FLOAT_MAT3&&(a=3),r.type===s.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:s.getAttribLocation(e,o),locationSize:a}}return t}function xs(s){return s!==""}function tl(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function nl(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const e0=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ko(s){return s.replace(e0,n0)}const t0=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function n0(s,e){let t=Be[e];if(t===void 0){const n=t0.get(e);if(n!==void 0)t=Be[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Ko(t)}const i0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function il(s){return s.replace(i0,s0)}function s0(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function sl(s){let e="precision "+s.precision+` float;
precision `+s.precision+" int;";return s.precision==="highp"?e+=`
#define HIGH_PRECISION`:s.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:s.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function r0(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Xl?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===Mh?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===Tn&&(e="SHADOWMAP_TYPE_VSM"),e}function o0(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Vi:case Hi:e="ENVMAP_TYPE_CUBE";break;case Or:e="ENVMAP_TYPE_CUBE_UV";break}return e}function a0(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Hi:e="ENVMAP_MODE_REFRACTION";break}return e}function c0(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case jl:e="ENVMAP_BLENDING_MULTIPLY";break;case Xh:e="ENVMAP_BLENDING_MIX";break;case jh:e="ENVMAP_BLENDING_ADD";break}return e}function l0(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function u0(s,e,t,n){const i=s.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=r0(t),l=o0(t),u=a0(t),h=c0(t),d=l0(t),f=t.isWebGL2?"":Kg(t),g=$g(r),_=i.createProgram();let m,p,M=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
  ...
  `,_.addEventListener("touchstart",L=>{L.preventDefault(),n.Space=!0,o(),_.style.background="rgba(50, 50, 60, 0.9)",_.style.transform="scale(0.95)"}),_.addEventListener("touchend",L=>{L.preventDefault(),n.Space=!1,o(),_.style.background="rgba(30, 30, 40, 0.7)",_.style.transform="scale(1)"}),g.appendChild(_),f.appendChild(g),"ontouchstart"in window||navigator.maxTouchPoints>0){let Q=function(){Z=null,P=!1,G=0,J=0,B.style.transform="translate(0, 0)"},K=function(O,$){const ee=F.getBoundingClientRect(),se=Math.max(-ne,Math.min(ne,O-(ee.left+ee.width/2))),Me=Math.max(-ne,Math.min(ne,$-(ee.top+ee.height/2))),ve=Math.hypot(se,Me),N=5;G=ve>N?se/ne:0,J=ve>N?Me/ne:0,B.style.transform=`translate(${se}px, ${Me}px)`},D=function(O){const $=Math.min((O-q)/1e3,.05);q=O,P&&!(window.__APP&&window.__APP.inputBlocked)&&t.rotateView(G*220*$,J*220*$),requestAnimationFrame(D)},H=function(O){for(const $ of O)if($.identifier===L)return $;return null},fe=function(O){for(const $ of O)if($.clientX>=window.innerWidth*.35)return $;return null},z=function(O){return O instanceof Element&&!!O.closest(".mobile-controls")},W=function(O){L!==null&&H(O.changedTouches)&&(L=null)};var p=Q,M=K,x=D,v=H,b=fe,C=z,w=W;s.style.touchAction="none",document.body.style.touchAction="none",document.documentElement.style.touchAction="none";let L=null,y=0,T=0;const F=document.createElement("div");F.className="camera-joystick",F.setAttribute("aria-label","Controllo visuale"),F.style.cssText=`
    ...
    `;const B=document.createElement("div");B.style.cssText=`
      ...
      pointer-events: none;
    `,F.appendChild(B),g.appendChild(F);let Z=null,P=!1,G=0,J=0,q=performance.now();const ne=33;if(requestAnimationFrame(D),F.addEventListener("pointerdown",O=>{window.__APP&&window.__APP.inputBlocked||(Z=O.pointerId,P=!0,K(O.clientX,O.clientY),F.setPointerCapture(O.pointerId),O.preventDefault())}),F.addEventListener("pointermove",O=>{O.pointerId===Z&&(K(O.clientX,O.clientY),O.preventDefault())}),F.addEventListener("pointerup",O=>{O.pointerId===Z&&Q()}),F.addEventListener("pointercancel",O=>{O.pointerId===Z&&Q()}),!window.PointerEvent){let O=null;const $=se=>{for(const Me of se)if(Me.identifier===O)return Me;return null};F.addEventListener("touchstart",se=>{if(window.__APP&&window.__APP.inputBlocked)return;const Me=se.changedTouches[0];!Me||O!==null||(O=Me.identifier,P=!0,K(Me.clientX,Me.clientY),se.preventDefault())},{passive:!1}),F.addEventListener("touchmove",se=>{const Me=$(se.changedTouches);Me&&(K(Me.clientX,Me.clientY),se.preventDefault())},{passive:!1});const ee=se=>{$(se.changedTouches)&&(O=null,Q())};F.addEventListener("touchend",ee),F.addEventListener("touchcancel",ee)}window.addEventListener("touchstart",O=>{if(window.__APP&&window.__APP.inputBlocked||z(O.target)||L!==null)return;const $=fe(O.changedTouches);$&&(L=$.identifier,y=$.clientX,T=$.clientY,O.preventDefault())},{passive:!1,capture:!0}),window.addEventListener("touchmove",O=>{if(L===null)return;const $=H(O.changedTouches);$&&(t.rotateView(($.clientX-y)*.85,($.clientY-T)*.85),y=$.clientX,T=$.clientY,O.preventDefault())},{passive:!1,capture:!0}),window.addEventListener("touchend",W),window.addEventListener("touchcancel",W)}}const ps=new A;function qt(s,e,t,n,i,r){const o=2*Math.PI*i/4,a=Math.max(r-2*i,0),c=Math.PI/4;ps.copy(e),ps[n]=0,ps.normalize();const l=.5*o/(o+a),u=1-ps.angleTo(s)/c;return Math.sign(ps[t])===1?u*l:a/(o+a)+l+l*(1-u)}class ix extends je{constructor(e=1,t=1,n=1,i=2,r=.1){if(i=i*2+1,r=Math.min(e/2,t/2,n/2,r),super(1,1,1,i,i,i),i===1)return;const o=this.toNonIndexed();this.index=null,this.attributes.position=o.attributes.position,this.attributes.normal=o.attributes.normal,this.attributes.uv=o.attributes.uv;const a=new A,c=new A,l=new A(e,t,n).divideScalar(2).subScalar(r),u=this.attributes.position.array,h=this.attributes.normal.array,d=this.attributes.uv.array,f=u.length/6,g=new A,_=.5/i;for(let m=0,p=0;m<u.length;m+=3,p+=2)switch(a.fromArray(u,m),c.copy(a),c.x-=Math.sign(c.x)*_,c.y-=Math.sign(c.y)*_,c.z-=Math.sign(c.z)*_,c.normalize(),u[m+0]=l.x*Math.sign(a.x)+c.x*r,u[m+1]=l.y*Math.sign(a.y)+c.y*r,u[m+2]=l.z*Math.sign(a.z)+c.z*r,h[m+0]=c.x,h[m+1]=c.y,h[m+2]=c.z,Math.floor(m/f)){case 0:g.set(1,0,0),d[p+0]=qt(g,c,"z","y",r,n),d[p+1]=1-qt(g,c,"y","z",r,t);break;case 1:g.set(-1,0,0),d[p+0]=1-qt(g,c,"z","y",r,n),d[p+1]=1-qt(g,c,"y","z",r,t);break;case 2:g.set(0,1,0),d[p+0]=1-qt(g,c,"x","z",r,e),d[p+1]=qt(g,c,"z","x",r,n);break;case 3:g.set(0,-1,0),d[p+0]=1-qt(g,c,"x","z",r,e),d[p+1]=1-qt(g,c,"z","x",r,n);break;case 4:g.set(0,0,1),d[p+0]=1-qt(g,c,"x","y",r,e),d[p+1]=1-qt(g,c,"y","x",r,t);break;case 5:g.set(0,0,-1),d[p+0]=qt(g,c,"x","y",r,e),d[p+1]=1-qt(g,c,"y","x",r,t);break}}}function wn(s,e,t,n=.12){const i=Math.min(n,s/2-.01,e/2-.01,t/2-.01);return new ix(s,e,t,2,Math.max(.01,i))}function Wr(s,e,t,n,i=40){const r=new ba;r.moveTo(-s/2,-e/2),r.lineTo(s/2,-e/2),r.lineTo(s/2,e/2),r.lineTo(-s/2,e/2),r.closePath();const o=new ta;o.absarc(0,0,t,0,Math.PI*2,!0),r.holes.push(o);const a=new Vr(r,i);n.side=kt;const c=new ie(a,n);return c.rotation.x=Math.PI/2,c.userData.collidable=!1,c}function sx(){const s=new ut;s.name="Observatory",s.userData.roomName="Osservatorio";const e=14.2,t=12,n=14,i=5.45,r=new ie(new je(t,.06,n-.8),new pe({color:2434378,roughness:.75}));r.position.set(0,e-.03,-.4),r.userData.collidable=!1,s.add(r);const o=new ie(new fn(t,n),new en({visible:!1}));o.rotation.x=-Math.PI/2,o.position.set(0,e,0),o.userData.collidable=!0,s.add(o);const a=new pe({color:2434629,roughness:.8}),c=new ie(wn(.2,i,n),a);c.position.set(-t/2-.1,e+i/2,0),c.userData.collidable=!0,s.add(c);const l=c.clone();l.position.set(t/2+.1,e+i/2,0),s.add(l);const u=new ie(wn(t,i,.2),a);u.position.set(0,e+i/2,-n/2-.1),u.userData.collidable=!0,s.add(u);const h=4.4,d=Wr(t,n,h,new pe({color:3042135,roughness:.8}));d.position.set(0,e+i,0),s.add(d);const f=new ie(new dt(h+.15,h+.15,.45,28,1,!0),new pe({color:1850675,roughness:.75,side:kt}));f.position.set(0,e+i+.22,0),f.userData.collidable=!1,s.add(f);const g=new ie(new Wn(h+.2,32,16,0,Math.PI*2,0,Math.PI/2),new pe({color:1119025,emissive:3547483,emissiveIntensity:.42,metalness:.2,transparent:!0,opacity:.55,roughness:.25,side:kt}));g.position.set(0,e+i+.45,0),g.userData.collidable=!1,s.add(g),s.userData.shells=[c,l,u,d,f,g];const _=new pe({color:855586,roughness:.6});for(let w=0;w<8;w++){const L=w/8*Math.PI*2,y=new ie(new wa(h+.2,.035,6,16,Math.PI),_);y.rotation.x=Math.PI/2,y.rotation.z=L,y.position.set(0,e+i+.45,0),y.userData.collidable=!1,s.add(y)}const m=new pe({color:1710618,metalness:.6,roughness:.3}),p=new ie(new dt(.22,.3,3.4,16),m);p.rotation.z=Math.PI/2.2,p.position.set(1.4,e+1.8,-1.2),p.userData.collidable=!0,s.add(p);const M=new ie(new dt(.34,.34,.16,16),new pe({color:8054783,emissive:1272467,emissiveIntensity:.8,metalness:.7}));M.rotation.z=Math.PI/2.2,M.position.set(2.9,e+2.48,-1.2),M.userData.collidable=!1,s.add(M);for(const[w,L]of[[1.1,-1.7],[1.8,-1.7],[1.45,-.55]]){const y=new ie(new dt(.07,.07,1.8,8),m);y.position.set(w,e+.9,L),y.rotation.z=(w-1.45)*.25,y.userData.collidable=!1,s.add(y)}const x=new pe({color:5917242}),v=new ie(new je(2.2,.75,1),x);v.position.set(-3.8,e+.6,3.7),v.userData.collidable=!0,s.add(v);const b=new ie(new dt(.48,.58,.75,8),new pe({color:9198238}));b.position.set(-3.8,e+.38,5),b.userData.collidable=!0,s.add(b);const C=new pe({color:1647681,emissive:2506627,emissiveIntensity:.35});for(const w of[-3.8,-1.5,1.5,3.8]){const L=new ie(new je(1.45,1.05,.05),C);L.position.set(w,e+1.9,-n/2+.13),L.userData.collidable=!1,s.add(L);const y=new ie(new Wn(.07,8,8),new pe({color:15129087,emissive:10717695,emissiveIntensity:1}));y.position.set(w,e+2,-n/2+.08),y.userData.collidable=!1,s.add(y)}return s}const rx="/casa3d/assets/animal-house-logo-BXBQ06OO.png",ox="/casa3d/assets/animal-house-intro-TpwfSi1P.mp4";function ax(){const s=new ut;s.name="LivingRoom",s.userData.roomName="Salotto";const e=1.05,t=18,n=18,i=5.95,r=new ie(new je(t,.06,n-.8),new pe({color:3230558,roughness:.82}));r.position.set(0,e-.03,-.4),r.userData.collidable=!1,s.add(r);const o=new ie(new fn(t,n),new en({visible:!1}));o.rotation.x=-Math.PI/2,o.position.set(0,e,0),o.userData.collidable=!0,s.add(o);const a=new pe({color:3424859,roughness:.82}),c=new ie(wn(.2,i,n),a);c.position.set(-t/2-.1,e+i/2,0),c.userData.collidable=!0,s.add(c);const l=c.clone();l.position.set(t/2+.1,e+i/2,0),s.add(l);const u=new ie(wn(t,i,.2),a);u.position.set(0,e+i/2,-n/2-.1),u.userData.collidable=!0,s.add(u);const h=Wr(t,n,2,new pe({color:2701394,roughness:.88}));h.position.set(0,e+i,0),s.add(h),s.userData.shells=[c,l,u,h];const d=new pe({color:8408465,roughness:.65}),f=new ie(new je(3.6,.45,1.25),d);f.position.set(-1.1,e+.45,-1.2),f.userData.collidable=!0,s.add(f);const g=new ie(new je(3.6,.9,.26),d);g.position.set(-1.1,e+.95,-1.72),g.userData.collidable=!0,s.add(g);for(const P of[-2.15,-1.1,-.05]){const G=new ie(new Wn(.42,12,8),new pe({color:14118813}));G.scale.set(1,.55,1),G.position.set(P,e+.78,-1.18),G.userData.collidable=!1,s.add(G)}const _=new ut;_.name="AnimalHouseTV",_.position.set(-1.1,e,2.55);const m=new pe({color:1513511,metalness:.55,roughness:.3}),p=new ie(wn(3.35,1.95,.24,.13),m);p.position.y=1.65,p.userData.collidable=!0,_.add(p);const M=document.createElement("video");M.src=ox,M.muted=!0,M.loop=!0,M.playsInline=!0,M.preload="auto",M.autoplay=!0;const x=new q0(M);x.colorSpace=ot,x.minFilter=Rt,_.userData.video=M;const v=new ie(new fn(3.05,1.68),new en({map:x,toneMapped:!1}));v.position.set(0,1.65,-.125),v.rotation.y=Math.PI,v.userData.collidable=!1,_.add(v),M.addEventListener("canplay",()=>{M.play().catch(P=>console.warn("TV video autoplay was blocked:",P))},{once:!0}),M.load();const b=new Fu().load(rx);b.colorSpace=ot;const C=new ie(new fn(1.62,1.62),new en({map:b,transparent:!0,toneMapped:!1}));C.position.set(0,1.65,.126),C.userData.collidable=!1,_.add(C);const w=new ie(new dt(.42,.55,.18,16),m);w.position.set(0,.18,0),w.userData.collidable=!0,_.add(w),_.userData.interactable=!0,s.add(_);const L=new ie(new je(1.2,2.4,.35),new pe({color:2827586}));L.position.set(5.5,e+1.2,-4),L.userData.collidable=!0,s.add(L);const y=new ie(new je(1.8,1.4,.6),new pe({color:4993099}));y.position.set(-5.2,e+.7,-5.5),y.userData.collidable=!0,s.add(y);const T=new ie(new Ns(.35,.7,8),new pe({color:16742938,emissive:16719514,emissiveIntensity:1.1}));T.position.set(-5.2,e+.75,-5.14),T.userData.collidable=!1,s.add(T);const F=new ie(new dt(.95,1.05,.35,6),new pe({color:4112824,metalness:.25}));F.position.set(-1.1,e+.18,.9),F.userData.collidable=!0,s.add(F);const B=new ie(new zi(3.5,32),new pe({color:2381686,roughness:.9}));B.rotation.x=-Math.PI/2,B.position.set(-1.1,e+.011,.9),B.userData.collidable=!1,s.add(B);const Z=new ie(new je(1.2,2.4,.35),new pe({color:2827586}));return Z.position.set(5.5,e+1.2,-1.8),Z.userData.collidable=!0,s.add(Z),s}function cx(){const s=new ut;s.name="Kitchen",s.userData.roomName="Cucina";const e=7,t=18,n=18,i=6.05,r=new ie(new je(t,.06,n-.8),new pe({color:12175301,roughness:.8}));r.position.set(0,e-.03,-.4),r.userData.collidable=!1,s.add(r);const o=new ie(new fn(t,n),new en({visible:!1}));o.rotation.x=-Math.PI/2,o.position.set(0,e,0),o.userData.collidable=!0,s.add(o);const a=new pe({color:7377819,roughness:.75}),c=new ie(wn(.2,i,n),a);c.position.set(-t/2-.1,e+i/2,0),c.userData.collidable=!0,s.add(c);const l=c.clone();l.position.set(t/2+.1,e+i/2,0),s.add(l);const u=new ie(wn(t,i,.2),a);u.position.set(0,e+i/2,-n/2-.1),u.userData.collidable=!0,s.add(u);const h=Wr(t,n,2,new pe({color:9414051,roughness:.85}));h.position.set(0,e+i,0),s.add(h),s.userData.shells=[c,l,u,h];const d=new pe({color:15329755,metalness:.25,roughness:.35}),f=new ie(new je(1.5,2.4,1),d);f.position.set(6.2,e+1.2,-4.8),f.userData.collidable=!0,s.add(f);const g=new ie(new je(1.32,1.05,.04),new pe({color:11984861,emissive:1858928,emissiveIntensity:.15}));g.position.set(6.2,e+1.55,-4.28),g.userData.collidable=!1,s.add(g);const _=new ie(new dt(.035,.035,.65,8),new pe({color:3754853,metalness:.8}));_.position.set(6.7,e+1.55,-4.22),_.userData.collidable=!1,s.add(_);const m=new ie(new dt(1.65,1.45,.16,6),new pe({color:11823992,roughness:.6}));m.position.set(0,e+.9,2.8),m.userData.collidable=!0,s.add(m);const p=new ie(new dt(.17,.3,.9,12),new pe({color:5978454}));p.position.set(0,e+.45,2.8),p.userData.collidable=!1,s.add(p);const M=new pe({color:6771362,roughness:.6});for(const[F,B]of[[-2.2,2.8],[2.2,2.8],[0,5]]){const Z=new ie(new dt(.48,.55,.62,8),M);Z.position.set(F,e+.31,B),Z.userData.collidable=!0,s.add(Z);const P=new ie(new je(.8,.75,.13),M);P.position.set(F,e+.72,B+.35),P.userData.collidable=!1,s.add(P)}const x=new pe({color:2829099,metalness:.4,roughness:.5}),v=new ie(new je(1.4,1.05,.9),x);v.position.set(-6.1,e+.53,-4.8),v.userData.collidable=!0,s.add(v);const b=new pe({color:1118481});for(const F of[-6.45,-5.75]){const B=new ie(new dt(.18,.18,.03,16),b);B.position.set(F,e+1.06,-4.8),B.userData.collidable=!1,s.add(B)}const C=new pe({color:14272936}),w=new ie(new je(3.6,1,.85),C);w.position.set(1.7,e+.5,-5),w.userData.collidable=!0,s.add(w);const L=new ie(new je(3.8,.12,1),new pe({color:4798287,roughness:.35}));L.position.set(1.7,e+1.06,-5),L.userData.collidable=!1,s.add(L);const y=new pe({color:16771496,emissive:16764779,emissiveIntensity:.5}),T=new ie(new Ns(.48,.55,12),y);return T.position.set(0,e+2.6,2.8),T.userData.collidable=!1,s.add(T),s}function lx(){const s=new ut;s.name="Basement",s.userData.roomName="Cantina";const e=-5.5,t=18,n=18,i=6.55,r=new ie(new je(t,.2,n),new pe({color:3681096,roughness:.9}));r.position.set(0,e,0),r.userData.collidable=!0,s.add(r);const o=new pe({color:2828608,roughness:.92}),a=new ie(wn(.2,i,n),o);a.position.set(-t/2-.1,e+i/2,0),a.userData.collidable=!0,s.add(a);const c=a.clone();c.position.set(t/2+.1,e+i/2,0),s.add(c);const l=new ie(wn(t,i,.2),o);l.position.set(0,e+i/2,-n/2-.1),l.userData.collidable=!0,s.add(l);const u=Wr(t,n,2,new pe({color:2366771,roughness:.95}));u.position.set(0,e+i,0),s.add(u),s.userData.shells=[a,c,l,u];const h=new ie(new je(1.25,2.1,.8),new pe({color:15706688,metalness:.15}));h.position.set(-4.4,e+1.05,4.5),h.userData.collidable=!0,s.add(h);const d=new ie(new je(1.35,.45,.68),new pe({color:13717907,emissive:6231629,emissiveIntensity:.35}));d.position.set(-4.4,e+1.82,4.58),d.rotation.x=-.35,d.userData.collidable=!1,s.add(d);const f=new pe({color:5979951}),g=new ie(new je(4.5,1.4,.7),f);g.position.set(5.5,e+1.2,4.8),g.userData.collidable=!0,s.add(g);const _=new ie(new je(1.5,1.05,.6),new pe({color:3484226}));_.position.set(5.3,e+1.5,-4.6),_.userData.collidable=!0,s.add(_);const m=new ie(new je(1.18,.72,.02),new pe({color:1118481,emissive:2789317,emissiveIntensity:.65}));m.position.set(5.3,e+1.5,-4.28),m.userData.collidable=!1,s.add(m);const p=new pe({color:9137991});for(let x=0;x<3;x++){const v=new ie(new je(.9,.9,.9),p);v.position.set(-5.8,e+.45+x*.92,-4.7),v.userData.collidable=x===0,s.add(v)}const M=new ie(new je(.75,.6,.05),new pe({color:1118481,emissive:7791871,emissiveIntensity:.65}));return M.position.set(-4.4,e+1.38,4.91),M.userData.collidable=!1,s.add(M),s}function Ul(s,e){if(e===ld)return console.warn("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles."),s;if(e===Yo||e===tu){let t=s.getIndex();if(t===null){const o=[],a=s.getAttribute("position");if(a!==void 0){for(let c=0;c<a.count;c++)o.push(c);s.setIndex(o),t=s.getIndex()}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible."),s}const n=t.count-2,i=[];if(e===Yo)for(let o=1;o<=n;o++)i.push(t.getX(0)),i.push(t.getX(o)),i.push(t.getX(o+1));else for(let o=0;o<n;o++)o%2===0?(i.push(t.getX(o)),i.push(t.getX(o+1)),i.push(t.getX(o+2))):(i.push(t.getX(o+2)),i.push(t.getX(o+1)),i.push(t.getX(o)));i.length/3!==n&&console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.");const r=s.clone();return r.setIndex(i),r.clearGroups(),r}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:",e),s}class ms extends ns{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(t){return new px(t)}),this.register(function(t){return new Sx(t)}),this.register(function(t){return new Ex(t)}),this.register(function(t){return new Tx(t)}),this.register(function(t){return new gx(t)}),this.register(function(t){return new _x(t)}),this.register(function(t){return new xx(t)}),this.register(function(t){return new vx(t)}),this.register(function(t){return new fx(t)}),this.register(function(t){return new yx(t)}),this.register(function(t){return new mx(t)}),this.register(function(t){return new Mx(t)}),this.register(function(t){return new hx(t)}),this.register(function(t){return new bx(t)}),this.register(function(t){return new Ax(t)})}load(e,t,n,i){const r=this;let o;this.resourcePath!==""?o=this.resourcePath:this.path!==""?o=this.path:o=sa.extractUrlBase(e),this.manager.itemStart(e);const a=function(l){i?i(l):console.error(l),r.manager.itemError(e),r.manager.itemEnd(e)},c=new Ou(this.manager);c.setPath(this.path),c.setResponseType("arraybuffer"),c.setRequestHeader(this.requestHeader),c.setWithCredentials(this.withCredentials),c.load(e,function(l){try{r.parse(l,o,function(u){t(u),r.manager.itemEnd(e)},a)}catch(u){a(u)}},n,a)}setDRACOLoader(e){return this.dracoLoader=e,this}setDDSLoader(){throw new Error('THREE.GLTFLoader: "MSFT_texture_dds" no longer supported. Please update to "KHR_texture_basisu".')}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,i){let r;const o={},a={},c=new TextDecoder;if(typeof e=="string")r=JSON.parse(e);else if(e instanceof ArrayBuffer)if(c.decode(new Uint8Array(e,0,4))===zu){try{o[He.KHR_BINARY_GLTF]=new wx(e)}catch(h){i&&i(h);return}r=JSON.parse(o[He.KHR_BINARY_GLTF].content)}else r=JSON.parse(c.decode(e));else r=e;if(r.asset===void 0||r.asset.version[0]<2){i&&i(new Error("THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported."));return}const l=new kx(r,{path:t||this.resourcePath||"",crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});l.fileLoader.setRequestHeader(this.requestHeader);for(let u=0;u<this.pluginCallbacks.length;u++){const h=this.pluginCallbacks[u](l);h.name||console.error("THREE.GLTFLoader: Invalid plugin found: missing name"),a[h.name]=h,o[h.name]=!0}if(r.extensionsUsed)for(let u=0;u<r.extensionsUsed.length;++u){const h=r.extensionsUsed[u],d=r.extensionsRequired||[];switch(h){case He.KHR_MATERIALS_UNLIT:o[h]=new dx;break;case He.KHR_DRACO_MESH_COMPRESSION:o[h]=new Rx(r,this.dracoLoader);break;case He.KHR_TEXTURE_TRANSFORM:o[h]=new Cx;break;case He.KHR_MESH_QUANTIZATION:o[h]=new Lx;break;default:d.indexOf(h)>=0&&a[h]===void 0&&console.warn('THREE.GLTFLoader: Unknown extension "'+h+'".')}}l.setExtensions(o),l.setPlugins(a),l.parse(n,i)}parseAsync(e,t){const n=this;return new Promise(function(i,r){n.parse(e,t,i,r)})}}function ux(){let s={};return{get:function(e){return s[e]},add:function(e,t){s[e]=t},remove:function(e){delete s[e]},removeAll:function(){s={}}}}const He={KHR_BINARY_GLTF:"KHR_binary_glTF",KHR_DRACO_MESH_COMPRESSION:"KHR_draco_mesh_compression",KHR_LIGHTS_PUNCTUAL:"KHR_lights_punctual",KHR_MATERIALS_CLEARCOAT:"KHR_materials_clearcoat",KHR_MATERIALS_IOR:"KHR_materials_ior",KHR_MATERIALS_SHEEN:"KHR_materials_sheen",KHR_MATERIALS_SPECULAR:"KHR_materials_specular",KHR_MATERIALS_TRANSMISSION:"KHR_materials_transmission",KHR_MATERIALS_IRIDESCENCE:"KHR_materials_iridescence",KHR_MATERIALS_ANISOTROPY:"KHR_materials_anisotropy",KHR_MATERIALS_UNLIT:"KHR_materials_unlit",KHR_MATERIALS_VOLUME:"KHR_materials_volume",KHR_TEXTURE_BASISU:"KHR_texture_basisu",KHR_TEXTURE_TRANSFORM:"KHR_texture_transform",KHR_MESH_QUANTIZATION:"KHR_mesh_quantization",KHR_MATERIALS_EMISSIVE_STRENGTH:"KHR_materials_emissive_strength",EXT_TEXTURE_WEBP:"EXT_texture_webp",EXT_TEXTURE_AVIF:"EXT_texture_avif",EXT_MESHOPT_COMPRESSION:"EXT_meshopt_compression",EXT_MESH_GPU_INSTANCING:"EXT_mesh_gpu_instancing"};class hx{constructor(e){this.parser=e,this.name=He.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){const e=this.parser,t=this.parser.json.nodes||[];for(let n=0,i=t.length;n<i;n++){const r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){const t=this.parser,n="light:"+e;let i=t.cache.get(n);if(i)return i;const r=t.json,c=((r.extensions&&r.extensions[this.name]||{}).lights||[])[e];let l;const u=new Ce(16777215);c.color!==void 0&&u.setRGB(c.color[0],c.color[1],c.color[2],Lt);const h=c.range!==void 0?c.range:0;switch(c.type){case"directional":l=new Bu(u),l.target.position.set(0,0,-1),l.add(l.target);break;case"point":l=new Ca(u),l.distance=h;break;case"spot":l=new z_(u),l.distance=h,c.spot=c.spot||{},c.spot.innerConeAngle=c.spot.innerConeAngle!==void 0?c.spot.innerConeAngle:0,c.spot.outerConeAngle=c.spot.outerConeAngle!==void 0?c.spot.outerConeAngle:Math.PI/4,l.angle=c.spot.outerConeAngle,l.penumbra=1-c.spot.innerConeAngle/c.spot.outerConeAngle,l.target.position.set(0,0,-1),l.add(l.target);break;default:throw new Error("THREE.GLTFLoader: Unexpected light type: "+c.type)}return l.position.set(0,0,0),l.decay=2,Bn(l,c),c.intensity!==void 0&&(l.intensity=c.intensity),l.name=t.createUniqueName(c.name||"light_"+e),i=Promise.resolve(l),t.cache.add(n,i),i}getDependency(e,t){if(e==="light")return this._loadLight(t)}createNodeAttachment(e){const t=this,n=this.parser,r=n.json.nodes[e],a=(r.extensions&&r.extensions[this.name]||{}).light;return a===void 0?null:this._loadLight(a).then(function(c){return n._getNodeRef(t.cache,a,c)})}}class dx{constructor(){this.name=He.KHR_MATERIALS_UNLIT}getMaterialType(){return en}extendParams(e,t,n){const i=[];e.color=new Ce(1,1,1),e.opacity=1;const r=t.pbrMetallicRoughness;if(r){if(Array.isArray(r.baseColorFactor)){const o=r.baseColorFactor;e.color.setRGB(o[0],o[1],o[2],Lt),e.opacity=o[3]}r.baseColorTexture!==void 0&&i.push(n.assignTexture(e,"map",r.baseColorTexture,ot))}return Promise.all(i)}}class fx{constructor(e){this.parser=e,this.name=He.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){const i=this.parser.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=i.extensions[this.name].emissiveStrength;return r!==void 0&&(t.emissiveIntensity=r),Promise.resolve()}}class px{constructor(e){this.parser=e,this.name=He.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Xn}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[],o=i.extensions[this.name];if(o.clearcoatFactor!==void 0&&(t.clearcoat=o.clearcoatFactor),o.clearcoatTexture!==void 0&&r.push(n.assignTexture(t,"clearcoatMap",o.clearcoatTexture)),o.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=o.clearcoatRoughnessFactor),o.clearcoatRoughnessTexture!==void 0&&r.push(n.assignTexture(t,"clearcoatRoughnessMap",o.clearcoatRoughnessTexture)),o.clearcoatNormalTexture!==void 0&&(r.push(n.assignTexture(t,"clearcoatNormalMap",o.clearcoatNormalTexture)),o.clearcoatNormalTexture.scale!==void 0)){const a=o.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new de(a,a)}return Promise.all(r)}}class mx{constructor(e){this.parser=e,this.name=He.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Xn}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[],o=i.extensions[this.name];return o.iridescenceFactor!==void 0&&(t.iridescence=o.iridescenceFactor),o.iridescenceTexture!==void 0&&r.push(n.assignTexture(t,"iridescenceMap",o.iridescenceTexture)),o.iridescenceIor!==void 0&&(t.iridescenceIOR=o.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),o.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=o.iridescenceThicknessMinimum),o.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=o.iridescenceThicknessMaximum),o.iridescenceThicknessTexture!==void 0&&r.push(n.assignTexture(t,"iridescenceThicknessMap",o.iridescenceThicknessTexture)),Promise.all(r)}}class gx{constructor(e){this.parser=e,this.name=He.KHR_MATERIALS_SHEEN}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Xn}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[];t.sheenColor=new Ce(0,0,0),t.sheenRoughness=0,t.sheen=1;const o=i.extensions[this.name];if(o.sheenColorFactor!==void 0){const a=o.sheenColorFactor;t.sheenColor.setRGB(a[0],a[1],a[2],Lt)}return o.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=o.sheenRoughnessFactor),o.sheenColorTexture!==void 0&&r.push(n.assignTexture(t,"sheenColorMap",o.sheenColorTexture,ot)),o.sheenRoughnessTexture!==void 0&&r.push(n.assignTexture(t,"sheenRoughnessMap",o.sheenRoughnessTexture)),Promise.all(r)}}class _x{constructor(e){this.parser=e,this.name=He.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Xn}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[],o=i.extensions[this.name];return o.transmissionFactor!==void 0&&(t.transmission=o.transmissionFactor),o.transmissionTexture!==void 0&&r.push(n.assignTexture(t,"transmissionMap",o.transmissionTexture)),Promise.all(r)}}class xx{constructor(e){this.parser=e,this.name=He.KHR_MATERIALS_VOLUME}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Xn}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[],o=i.extensions[this.name];t.thickness=o.thicknessFactor!==void 0?o.thicknessFactor:0,o.thicknessTexture!==void 0&&r.push(n.assignTexture(t,"thicknessMap",o.thicknessTexture)),t.attenuationDistance=o.attenuationDistance||1/0;const a=o.attenuationColor||[1,1,1];return t.attenuationColor=new Ce().setRGB(a[0],a[1],a[2],Lt),Promise.all(r)}}class vx{constructor(e){this.parser=e,this.name=He.KHR_MATERIALS_IOR}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Xn}extendMaterialParams(e,t){const i=this.parser.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=i.extensions[this.name];return t.ior=r.ior!==void 0?r.ior:1.5,Promise.resolve()}}class yx{constructor(e){this.parser=e,this.name=He.KHR_MATERIALS_SPECULAR}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Xn}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[],o=i.extensions[this.name];t.specularIntensity=o.specularFactor!==void 0?o.specularFactor:1,o.specularTexture!==void 0&&r.push(n.assignTexture(t,"specularIntensityMap",o.specularTexture));const a=o.specularColorFactor||[1,1,1];return t.specularColor=new Ce().setRGB(a[0],a[1],a[2],Lt),o.specularColorTexture!==void 0&&r.push(n.assignTexture(t,"specularColorMap",o.specularColorTexture,ot)),Promise.all(r)}}class Mx{constructor(e){this.parser=e,this.name=He.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Xn}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[],o=i.extensions[this.name];return o.anisotropyStrength!==void 0&&(t.anisotropy=o.anisotropyStrength),o.anisotropyRotation!==void 0&&(t.anisotropyRotation=o.anisotropyRotation),o.anisotropyTexture!==void 0&&r.push(n.assignTexture(t,"anisotropyMap",o.anisotropyTexture)),Promise.all(r)}}class Sx{constructor(e){this.parser=e,this.name=He.KHR_TEXTURE_BASISU}loadTexture(e){const t=this.parser,n=t.json,i=n.textures[e];if(!i.extensions||!i.extensions[this.name])return null;const r=i.extensions[this.name],o=t.options.ktx2Loader;if(!o){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures");return null}return t.loadTextureImage(e,r.source,o)}}class Ex{constructor(e){this.parser=e,this.name=He.EXT_TEXTURE_WEBP,this.isSupported=null}loadTexture(e){const t=this.name,n=this.parser,i=n.json,r=i.textures[e];if(!r.extensions||!r.extensions[t])return null;const o=r.extensions[t],a=i.images[o.source];let c=n.textureLoader;if(a.uri){const l=n.options.manager.getHandler(a.uri);l!==null&&(c=l)}return this.detectSupport().then(function(l){if(l)return n.loadTextureImage(e,o.source,c);if(i.extensionsRequired&&i.extensionsRequired.indexOf(t)>=0)throw new Error("THREE.GLTFLoader: WebP required by asset but unsupported.");return n.loadTexture(e)})}detectSupport(){return this.isSupported||(this.isSupported=new Promise(function(e){const t=new Image;t.src="data:image/webp;base64,UklGRiIAAABXRUJQVlA4IBYAAAAwAQCdASoBAAEADsD+JaQAA3AAAAAA",t.onload=t.onerror=function(){e(t.height===1)}})),this.isSupported}}class Tx{constructor(e){this.parser=e,this.name=He.EXT_TEXTURE_AVIF,this.isSupported=null}loadTexture(e){const t=this.name,n=this.parser,i=n.json,r=i.textures[e];if(!r.extensions||!r.extensions[t])return null;const o=r.extensions[t],a=i.images[o.source];let c=n.textureLoader;if(a.uri){const l=n.options.manager.getHandler(a.uri);l!==null&&(c=l)}return this.detectSupport().then(function(l){if(l)return n.loadTextureImage(e,o.source,c);if(i.extensionsRequired&&i.extensionsRequired.indexOf(t)>=0)throw new Error("THREE.GLTFLoader: AVIF required by asset but unsupported.");return n.loadTexture(e)})}detectSupport(){return this.isSupported||(this.isSupported=new Promise(function(e){const t=new Image;t.src="data:image/avif;base64,",t.onload=t.onerror=function(){e(t.height===1)}})),this.isSupported}}class bx{constructor(e){this.name=He.EXT_MESHOPT_COMPRESSION,this.parser=e}loadBufferView(e){const t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){const i=n.extensions[this.name],r=this.parser.getDependency("buffer",i.buffer),o=this.parser.options.meshoptDecoder;if(!o||!o.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files");return null}return r.then(function(a){const c=i.byteOffset||0,l=i.byteLength||0,u=i.count,h=i.byteStride,d=new Uint8Array(a,c,l);return o.decodeGltfBufferAsync?o.decodeGltfBufferAsync(u,h,d,i.mode,i.filter).then(function(f){return f.buffer}):o.ready.then(function(){const f=new ArrayBuffer(u*h);return o.decodeGltfBuffer(new Uint8Array(f),u,h,d,i.mode,i.filter),f})})}else return null}}class Ax{constructor(e){this.name=He.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){const t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;const i=t.meshes[n.mesh];for(const l of i.primitives)if(l.mode!==Zt.TRIANGLES&&l.mode!==Zt.TRIANGLE_STRIP&&l.mode!==Zt.TRIANGLE_FAN&&l.mode!==void 0)return null;const o=n.extensions[this.name].attributes,a=[],c={};for(const l in o)a.push(this.parser.getDependency("accessor",o[l]).then(u=>(c[l]=u,c[l])));return a.length<1?null:(a.push(this.parser.createNodeMesh(e)),Promise.all(a).then(l=>{const u=l.pop(),h=u.isGroup?u.children:[u],d=l[0].count,f=[];for(const g of h){const _=new Oe,m=new A,p=new Ln,M=new A(1,1,1),x=new Au(g.geometry,g.material,d);for(let v=0;v<d;v++)c.TRANSLATION&&m.fromBufferAttribute(c.TRANSLATION,v),c.ROTATION&&p.fromBufferAttribute(c.ROTATION,v),c.SCALE&&M.fromBufferAttribute(c.SCALE,v),x.setMatrixAt(v,_.compose(m,p,M));for(const v in c)if(v==="_COLOR_0"){const b=c[v];x.instanceColor=new $o(b.array,b.itemSize,b.normalized)}else v!=="TRANSLATION"&&v!=="ROTATION"&&v!=="SCALE"&&g.geometry.setAttribute(v,c[v]);at.prototype.copy.call(x,g),this.parser.assignFinalMaterial(x),f.push(x)}return u.isGroup?(u.clear(),u.add(...f),u):f[0]}))}}const zu="glTF",gs=12,Ol={JSON:1313821514,BIN:5130562};class wx{constructor(e){this.name=He.KHR_BINARY_GLTF,this.content=null,this.body=null;const t=new DataView(e,0,gs),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==zu)throw new Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");if(this.header.version<2)throw new Error("THREE.GLTFLoader: Legacy binary file detected.");const i=this.header.length-gs,r=new DataView(e,gs);let o=0;for(;o<i;){const a=r.getUint32(o,!0);o+=4;const c=r.getUint32(o,!0);if(o+=4,c===Ol.JSON){const l=new Uint8Array(e,gs+o,a);this.content=n.decode(l)}else if(c===Ol.BIN){const l=gs+o;this.body=e.slice(l,l+a)}o+=a}if(this.content===null)throw new Error("THREE.GLTFLoader: JSON content not found.")}}class Rx{constructor(e,t){if(!t)throw new Error("THREE.GLTFLoader: No DRACOLoader instance provided.");this.name=He.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){const n=this.json,i=this.dracoLoader,r=e.extensions[this.name].bufferView,o=e.extensions[this.name].attributes,a={},c={},l={};for(const u in o){const h=oa[u]||u.toLowerCase();a[h]=o[u]}for(const u in e.attributes){const h=oa[u]||u.toLowerCase();if(o[u]!==void 0){const d=n.accessors[e.attributes[u]],f=ki[d.componentType];l[h]=f.name,c[h]=d.normalized===!0}}return t.getDependency("bufferView",r).then(function(u){return new Promise(function(h){i.decodeDracoFile(u,function(d){for(const f in d.attributes){const g=d.attributes[f],_=c[f];_!==void 0&&(g.normalized=_)}h(d)},a,l)})})}}class Cx{constructor(){this.name=He.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0||(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0),e}}class Lx{constructor(){this.name=He.KHR_MESH_QUANTIZATION}}class ku extends Us{constructor(e,t,n,i){super(e,t,n,i)}copySampleValue_(e){const t=this.resultBuffer,n=this.sampleValues,i=this.valueSize,r=e*i*3+i;for(let o=0;o!==i;o++)t[o]=n[r+o];return t}interpolate_(e,t,n,i){const r=this.resultBuffer,o=this.sampleValues,a=this.valueSize,c=a*2,l=a*3,u=i-t,h=(n-t)/u,d=h*h,f=d*h,g=e*l,_=g-l,m=-2*f+3*d,p=f-d,M=1-m,x=p-d+h;for(let v=0;v!==a;v++){const b=o[_+v+a],C=o[_+v+c]*u,w=o[g+v+a],L=o[g+v]*u;r[v]=M*b+x*C+m*w+p*L}return r}}const Px=new Ln;class Ix extends ku{interpolate_(e,t,n,i){const r=super.interpolate_(e,t,n,i);return Px.fromArray(r).normalize().toArray(r),r}}const Zt={POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6},ki={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},Fl={9728:bt,9729:Rt,9984:jo,9985:ql,9986:Sr,9987:ai},Bl={33071:Kt,33648:Rr,10497:pn},Fo={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},oa={POSITION:"position",NORMAL:"normal",TANGENT:"tangent",TEXCOORD_0:"uv",TEXCOORD_1:"uv1",TEXCOORD_2:"uv2",TEXCOORD_3:"uv3",COLOR_0:"color",WEIGHTS_0:"skinWeight",JOINTS_0:"skinIndex"},Fn={scale:"scale",translation:"position",rotation:"quaternion",weights:"morphTargetInfluences"},Dx={CUBICSPLINE:void 0,LINEAR:Xi,STEP:As},Bo={OPAQUE:"OPAQUE",MASK:"MASK",BLEND:"BLEND"};function Nx(s){return s.DefaultMaterial===void 0&&(s.DefaultMaterial=new pe({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:Rn})),s.DefaultMaterial}function $n(s,e,t){for(const n in t.extensions)s[n]===void 0&&(e.userData.gltfExtensions=e.userData.gltfExtensions||{},e.userData.gltfExtensions[n]=t.extensions[n])}function Bn(s,e){e.extras!==void 0&&(typeof e.extras=="object"?Object.assign(s.userData,e.extras):console.warn("THREE.GLTFLoader: Ignoring primitive type .extras, "+e.extras))}function Ux(s,e,t){let n=!1,i=!1,r=!1;for(let l=0,u=e.length;l<u;l++){const h=e[l];if(h.POSITION!==void 0&&(n=!0),h.NORMAL!==void 0&&(i=!0),h.COLOR_0!==void 0&&(r=!0),n&&i&&r)break}if(!n&&!i&&!r)return Promise.resolve(s);const o=[],a=[],c=[];for(let l=0,u=e.length;l<u;l++){const h=e[l];if(n){const d=h.POSITION!==void 0?t.getDependency("accessor",h.POSITION):s.attributes.position;o.push(d)}if(i){const d=h.NORMAL!==void 0?t.getDependency("accessor",h.NORMAL):s.attributes.normal;a.push(d)}if(r){const d=h.COLOR_0!==void 0?t.getDependency("accessor",h.COLOR_0):s.attributes.color;c.push(d)}}return Promise.all([Promise.all(o),Promise.all(a),Promise.all(c)]).then(function(l){const u=l[0],h=l[1],d=l[2];return n&&(s.morphAttributes.position=u),i&&(s.morphAttributes.normal=h),r&&(s.morphAttributes.color=d),s.morphTargetsRelative=!0,s})}function Ox(s,e){if(s.updateMorphTargets(),e.weights!==void 0)for(let t=0,n=e.weights.length;t<n;t++)s.morphTargetInfluences[t]=e.weights[t];if(e.extras&&Array.isArray(e.extras.targetNames)){const t=e.extras.targetNames;if(s.morphTargetInfluences.length===t.length){s.morphTargetDictionary={};for(let n=0,i=t.length;n<i;n++)s.morphTargetDictionary[t[n]]=n}else console.warn("THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.")}}function Fx(s){let e;const t=s.extensions&&s.extensions[He.KHR_DRACO_MESH_COMPRESSION];if(t?e="draco:"+t.bufferView+":"+t.indices+":"+zo(t.attributes):e=s.indices+":"+zo(s.attributes)+":"+s.mode,s.targets!==void 0)for(let n=0,i=s.targets.length;n<i;n++)e+=":"+zo(s.targets[n]);return e}function zo(s){let e="";const t=Object.keys(s).sort();for(let n=0,i=t.length;n<i;n++)e+=t[n]+":"+s[t[n]]+";";return e}function aa(s){switch(s){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw new Error("THREE.GLTFLoader: Unsupported normalized accessor component type.")}}function Bx(s){return s.search(/\.jpe?g($|\?)/i)>0||s.search(/^data\:image\/jpeg/)===0?"image/jpeg":s.search(/\.webp($|\?)/i)>0||s.search(/^data\:image\/webp/)===0?"image/webp":"image/png"}const zx=new Oe;class kx{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new ux,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,i=!1,r=-1;typeof navigator<"u"&&(n=/^((?!chrome|android).)*safari/i.test(navigator.userAgent)===!0,i=navigator.userAgent.indexOf("Firefox")>-1,r=i?navigator.userAgent.match(/Firefox\/([0-9]+)\./)[1]:-1),typeof createImageBitmap>"u"||n||i&&r<98?this.textureLoader=new Fu(this.options.manager):this.textureLoader=new H_(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new Ou(this.options.manager),this.fileLoader.setResponseType("arraybuffer"),this.options.crossOrigin==="use-credentials"&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){const n=this,i=this.json,r=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(o){return o._markDefs&&o._markDefs()}),Promise.all(this._invokeAll(function(o){return o.beforeRoot&&o.beforeRoot()})).then(function(){return Promise.all([n.getDependencies("scene"),n.getDependencies("animation"),n.getDependencies("camera")])}).then(function(o){const a={scene:o[0][i.scene||0],scenes:o[0],animations:o[1],cameras:o[2],asset:i.asset,parser:n,userData:{}};return $n(r,a,i),Bn(a,i),Promise.all(n._invokeAll(function(c){return c.afterRoot&&c.afterRoot(a)})).then(function(){e(a)})}).catch(t)}_markDefs(){const e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let i=0,r=t.length;i<r;i++){const o=t[i].joints;for(let a=0,c=o.length;a<c;a++)e[o[a]].isBone=!0}for(let i=0,r=e.length;i<r;i++){const o=e[i];o.mesh!==void 0&&(this._addNodeRef(this.meshCache,o.mesh),o.skin!==void 0&&(n[o.mesh].isSkinnedMesh=!0)),o.camera!==void 0&&this._addNodeRef(this.cameraCache,o.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;const i=n.clone(),r=(o,a)=>{const c=this.associations.get(o);c!=null&&this.associations.set(a,c);for(const[l,u]of o.children.entries())r(u,a.children[l])};return r(n,i),i.name+="_instance_"+e.uses[t]++,i}_invokeOne(e){const t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){const i=e(t[n]);if(i)return i}return null}_invokeAll(e){const t=Object.values(this.plugins);t.unshift(this);const n=[];for(let i=0;i<t.length;i++){const r=e(t[i]);r&&n.push(r)}return n}getDependency(e,t){const n=e+":"+t;let i=this.cache.get(n);if(!i){switch(e){case"scene":i=this.loadScene(t);break;case"node":i=this._invokeOne(function(r){return r.loadNode&&r.loadNode(t)});break;case"mesh":i=this._invokeOne(function(r){return r.loadMesh&&r.loadMesh(t)});break;case"accessor":i=this.loadAccessor(t);break;case"bufferView":i=this._invokeOne(function(r){return r.loadBufferView&&r.loadBufferView(t)});break;case"buffer":i=this.loadBuffer(t);break;case"material":i=this._invokeOne(function(r){return r.loadMaterial&&r.loadMaterial(t)});break;case"texture":i=this._invokeOne(function(r){return r.loadTexture&&r.loadTexture(t)});break;case"skin":i=this.loadSkin(t);break;case"animation":i=this._invokeOne(function(r){return r.loadAnimation&&r.loadAnimation(t)});break;case"camera":i=this.loadCamera(t);break;default:if(i=this._invokeOne(function(r){return r!=this&&r.getDependency&&r.getDependency(e,t)}),!i)throw new Error("Unknown type: "+e);break}this.cache.add(n,i)}return i}getDependencies(e){let t=this.cache.get(e);if(!t){const n=this,i=this.json[e+(e==="mesh"?"es":"s")]||[];t=Promise.all(i.map(function(r,o){return n.getDependency(e,o)})),this.cache.add(e,t)}return t}loadBuffer(e){const t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!=="arraybuffer")throw new Error("THREE.GLTFLoader: "+t.type+" buffer type is not supported.");if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[He.KHR_BINARY_GLTF].body);const i=this.options;return new Promise(function(r,o){n.load(sa.resolveURL(t.uri,i.path),r,void 0,function(){o(new Error('THREE.GLTFLoader: Failed to load buffer "'+t.uri+'".'))})})}loadBufferView(e){const t=this.json.bufferViews[e];return this.getDependency("buffer",t.buffer).then(function(n){const i=t.byteLength||0,r=t.byteOffset||0;return n.slice(r,r+i)})}loadAccessor(e){const t=this,n=this.json,i=this.json.accessors[e];if(i.bufferView===void 0&&i.sparse===void 0){const o=Fo[i.type],a=ki[i.componentType],c=i.normalized===!0,l=new a(i.count*o);return Promise.resolve(new Ct(l,o,c))}const r=[];return i.bufferView!==void 0?r.push(this.getDependency("bufferView",i.bufferView)):r.push(null),i.sparse!==void 0&&(r.push(this.getDependency("bufferView",i.sparse.indices.bufferView)),r.push(this.getDependency("bufferView",i.sparse.values.bufferView))),Promise.all(r).then(function(o){const a=o[0],c=Fo[i.type],l=ki[i.componentType],u=l.BYTES_PER_ELEMENT,h=u*c,d=i.byteOffset||0,f=i.bufferView!==void 0?n.bufferViews[i.bufferView].byteStride:void 0,g=i.normalized===!0;let _,m;if(f&&f!==h){const p=Math.floor(d/f),M="InterleavedBuffer:"+i.bufferView+":"+i.componentType+":"+p+":"+i.count;let x=t.cache.get(M);x||(_=new l(a,p*f,i.count*f/u),x=new Su(_,f/u),t.cache.add(M,x)),m=new Rs(x,c,d%f/u,g)}else a===null?_=new l(i.count*c):_=new l(a,d,i.count*c),m=new Ct(_,c,g);if(i.sparse!==void 0){const p=Fo.SCALAR,M=ki[i.sparse.indices.componentType],x=i.sparse.indices.byteOffset||0,v=i.sparse.values.byteOffset||0,b=new M(o[1],x,i.sparse.count*p),C=new l(o[2],v,i.sparse.count*c);a!==null&&(m=new Ct(m.array.slice(),m.itemSize,m.normalized));for(let w=0,L=b.length;w<L;w++){const y=b[w];if(m.setX(y,C[w*c]),c>=2&&m.setY(y,C[w*c+1]),c>=3&&m.setZ(y,C[w*c+2]),c>=4&&m.setW(y,C[w*c+3]),c>=5)throw new Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.")}}return m})}loadTexture(e){const t=this.json,n=this.options,r=t.textures[e].source,o=t.images[r];let a=this.textureLoader;if(o.uri){const c=n.manager.getHandler(o.uri);c!==null&&(a=c)}return this.loadTextureImage(e,r,a)}loadTextureImage(e,t,n){const i=this,r=this.json,o=r.textures[e],a=r.images[t],c=(a.uri||a.bufferView)+":"+o.sampler;if(this.textureCache[c])return this.textureCache[c];const l=this.loadImageSource(t,n).then(function(u){u.flipY=!1,u.name=o.name||a.name||"",u.name===""&&typeof a.uri=="string"&&a.uri.startsWith("data:image/")===!1&&(u.name=a.uri);const d=(r.samplers||{})[o.sampler]||{};return u.magFilter=Fl[d.magFilter]||Rt,u.minFilter=Fl[d.minFilter]||ai,u.wrapS=Bl[d.wrapS]||pn,u.wrapT=Bl[d.wrapT]||pn,i.associations.set(u,{textures:e}),u}).catch(function(){return null});return this.textureCache[c]=l,l}loadImageSource(e,t){const n=this,i=this.json,r=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(h=>h.clone());const o=i.images[e],a=self.URL||self.webkitURL;let c=o.uri||"",l=!1;if(o.bufferView!==void 0)c=n.getDependency("bufferView",o.bufferView).then(function(h){l=!0;const d=new Blob([h],{type:o.mimeType});return c=a.createObjectURL(d),c});else if(o.uri===void 0)throw new Error("THREE.GLTFLoader: Image "+e+" is missing URI and bufferView");const u=Promise.resolve(c).then(function(h){return new Promise(function(d,f){let g=d;t.isImageBitmapLoader===!0&&(g=function(_){const m=new vt(_);m.needsUpdate=!0,d(m)}),t.load(sa.resolveURL(h,r.path),g,void 0,f)})}).then(function(h){return l===!0&&a.revokeObjectURL(c),h.userData.mimeType=o.mimeType||Bx(o.uri),h}).catch(function(h){throw console.error("THREE.GLTFLoader: Couldn't load texture",c),h});return this.sourceCache[e]=u,u}assignTexture(e,t,n,i){const r=this;return this.getDependency("texture",n.index).then(function(o){if(!o)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(o=o.clone(),o.channel=n.texCoord),r.extensions[He.KHR_TEXTURE_TRANSFORM]){const a=n.extensions!==void 0?n.extensions[He.KHR_TEXTURE_TRANSFORM]:void 0;if(a){const c=r.associations.get(o);o=r.extensions[He.KHR_TEXTURE_TRANSFORM].extendTexture(o,a),r.associations.set(o,c)}}return i!==void 0&&(o.colorSpace=i),e[t]=o,o})}assignFinalMaterial(e){const t=e.geometry;let n=e.material;const i=t.attributes.tangent===void 0,r=t.attributes.color!==void 0,o=t.attributes.normal===void 0;if(e.isPoints){const a="PointsMaterial:"+n.uuid;let c=this.cache.get(a);c||(c=new kr,cn.prototype.copy.call(c,n),c.color.copy(n.color),c.map=n.map,c.sizeAttenuation=!1,this.cache.add(a,c)),n=c}else if(e.isLine){const a="LineBasicMaterial:"+n.uuid;let c=this.cache.get(a);c||(c=new ya,cn.prototype.copy.call(c,n),c.color.copy(n.color),c.map=n.map,this.cache.add(a,c)),n=c}if(i||r||o){let a="ClonedMaterial:"+n.uuid+":";i&&(a+="derivative-tangents:"),r&&(a+="vertex-colors:"),o&&(a+="flat-shading:");let c=this.cache.get(a);c||(c=n.clone(),r&&(c.vertexColors=!0),o&&(c.flatShading=!0),i&&(c.normalScale&&(c.normalScale.y*=-1),c.clearcoatNormalScale&&(c.clearcoatNormalScale.y*=-1)),this.cache.add(a,c),this.associations.set(c,this.associations.get(n))),n=c}e.material=n}getMaterialType(){return pe}loadMaterial(e){const t=this,n=this.json,i=this.extensions,r=n.materials[e];let o;const a={},c=r.extensions||{},l=[];if(c[He.KHR_MATERIALS_UNLIT]){const h=i[He.KHR_MATERIALS_UNLIT];o=h.getMaterialType(),l.push(h.extendParams(a,r,t))}else{const h=r.pbrMetallicRoughness||{};if(a.color=new Ce(1,1,1),a.opacity=1,Array.isArray(h.baseColorFactor)){const d=h.baseColorFactor;a.color.setRGB(d[0],d[1],d[2],Lt),a.opacity=d[3]}h.baseColorTexture!==void 0&&l.push(t.assignTexture(a,"map",h.baseColorTexture,ot)),a.metalness=h.metallicFactor!==void 0?h.metallicFactor:1,a.roughness=h.roughnessFactor!==void 0?h.roughnessFactor:1,h.metallicRoughnessTexture!==void 0&&(l.push(t.assignTexture(a,"metalnessMap",h.metallicRoughnessTexture)),l.push(t.assignTexture(a,"roughnessMap",h.metallicRoughnessTexture))),o=this._invokeOne(function(d){return d.getMaterialType&&d.getMaterialType(e)}),l.push(Promise.all(this._invokeAll(function(d){return d.extendMaterialParams&&d.extendMaterialParams(e,a)})))}r.doubleSided===!0&&(a.side=kt);const u=r.alphaMode||Bo.OPAQUE;if(u===Bo.BLEND?(a.transparent=!0,a.depthWrite=!1):(a.transparent=!1,u===Bo.MASK&&(a.alphaTest=r.alphaCutoff!==void 0?r.alphaCutoff:.5)),r.normalTexture!==void 0&&o!==en&&(l.push(t.assignTexture(a,"normalMap",r.normalTexture)),a.normalScale=new de(1,1),r.normalTexture.scale!==void 0)){const h=r.normalTexture.scale;a.normalScale.set(h,h)}if(r.occlusionTexture!==void 0&&o!==en&&(l.push(t.assignTexture(a,"aoMap",r.occlusionTexture)),r.occlusionTexture.strength!==void 0&&(a.aoMapIntensity=r.occlusionTexture.strength)),r.emissiveFactor!==void 0&&o!==en){const h=r.emissiveFactor;a.emissive=new Ce().setRGB(h[0],h[1],h[2],Lt)}return r.emissiveTexture!==void 0&&o!==en&&l.push(t.assignTexture(a,"emissiveMap",r.emissiveTexture,ot)),Promise.all(l).then(function(){const h=new o(a);return r.name&&(h.name=r.name),Bn(h,r),t.associations.set(h,{materials:e}),r.extensions&&$n(i,h,r),h})}createUniqueName(e){const t=$e.sanitizeNodeName(e||"");return t in this.nodeNamesUsed?t+"_"+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){const t=this,n=this.extensions,i=this.primitiveCache;function r(a){return n[He.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(a,t).then(function(c){return zl(c,a,t)})}const o=[];for(let a=0,c=e.length;a<c;a++){const l=e[a],u=Fx(l),h=i[u];if(h)o.push(h.promise);else{let d;l.extensions&&l.extensions[He.KHR_DRACO_MESH_COMPRESSION]?d=r(l):d=zl(new xt,l,t),i[u]={primitive:l,promise:d},o.push(d)}}return Promise.all(o)}loadMesh(e){const t=this,n=this.json,i=this.extensions,r=n.meshes[e],o=r.primitives,a=[];for(let c=0,l=o.length;c<l;c++){const u=o[c].material===void 0?Nx(this.cache):this.getDependency("material",o[c].material);a.push(u)}return a.push(t.loadGeometries(o)),Promise.all(a).then(function(c){const l=c.slice(0,c.length-1),u=c[c.length-1],h=[];for(let f=0,g=u.length;f<g;f++){const _=u[f],m=o[f];let p;const M=l[f];if(m.mode===Zt.TRIANGLES||m.mode===Zt.TRIANGLE_STRIP||m.mode===Zt.TRIANGLE_FAN||m.mode===void 0)p=r.isSkinnedMesh===!0?new V0(_,M):new ie(_,M),p.isSkinnedMesh===!0&&p.normalizeSkinWeights(),m.mode===Zt.TRIANGLE_STRIP?p.geometry=Ul(p.geometry,tu):m.mode===Zt.TRIANGLE_FAN&&(p.geometry=Ul(p.geometry,Yo));else if(m.mode===Zt.LINES)p=new j0(_,M);else if(m.mode===Zt.LINE_STRIP)p=new zr(_,M);else if(m.mode===Zt.LINE_LOOP)p=new Y0(_,M);else if(m.mode===Zt.POINTS)p=new Ma(_,M);else throw new Error("THREE.GLTFLoader: Primitive mode unsupported: "+m.mode);Object.keys(p.geometry.morphAttributes).length>0&&Ox(p,r),p.name=t.createUniqueName(r.name||"mesh_"+e),Bn(p,r),m.extensions&&$n(i,p,m),t.assignFinalMaterial(p),h.push(p)}for(let f=0,g=h.length;f<g;f++)t.associations.set(h[f],{meshes:e,primitives:f});if(h.length===1)return r.extensions&&$n(i,h[0],r),h[0];const d=new ut;r.extensions&&$n(i,d,r),t.associations.set(d,{meshes:e});for(let f=0,g=h.length;f<g;f++)d.add(h[f]);return d})}loadCamera(e){let t;const n=this.json.cameras[e],i=n[n.type];if(!i){console.warn("THREE.GLTFLoader: Missing camera parameters.");return}return n.type==="perspective"?t=new zt(ru.radToDeg(i.yfov),i.aspectRatio||1,i.znear||1,i.zfar||2e6):n.type==="orthographic"&&(t=new ga(-i.xmag,i.xmag,i.ymag,-i.ymag,i.znear,i.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),Bn(t,n),Promise.resolve(t)}loadSkin(e){const t=this.json.skins[e],n=[];for(let i=0,r=t.joints.length;i<r;i++)n.push(this._loadNodeShallow(t.joints[i]));return t.inverseBindMatrices!==void 0?n.push(this.getDependency("accessor",t.inverseBindMatrices)):n.push(null),Promise.all(n).then(function(i){const r=i.pop(),o=i,a=[],c=[];for(let l=0,u=o.length;l<u;l++){const h=o[l];if(h){a.push(h);const d=new Oe;r!==null&&d.fromArray(r.array,l*16),c.push(d)}else console.warn('THREE.GLTFLoader: Joint "%s" could not be found.',t.joints[l])}return new va(a,c)})}loadAnimation(e){const t=this.json,n=this,i=t.animations[e],r=i.name?i.name:"animation_"+e,o=[],a=[],c=[],l=[],u=[];for(let h=0,d=i.channels.length;h<d;h++){const f=i.channels[h],g=i.samplers[f.sampler],_=f.target,m=_.node,p=i.parameters!==void 0?i.parameters[g.input]:g.input,M=i.parameters!==void 0?i.parameters[g.output]:g.output;_.node!==void 0&&(o.push(this.getDependency("node",m)),a.push(this.getDependency("accessor",p)),c.push(this.getDependency("accessor",M)),l.push(g),u.push(_))}return Promise.all([Promise.all(o),Promise.all(a),Promise.all(c),Promise.all(l),Promise.all(u)]).then(function(h){const d=h[0],f=h[1],g=h[2],_=h[3],m=h[4],p=[];for(let M=0,x=d.length;M<x;M++){const v=d[M],b=f[M],C=g[M],w=_[M],L=m[M];if(v===void 0)continue;v.updateMatrix&&v.updateMatrix();const y=n._createAnimationTracks(v,b,C,w,L);if(y)for(let T=0;T<y.length;T++)p.push(y[T])}return new P_(r,void 0,p)})}createNodeMesh(e){const t=this.json,n=this,i=t.nodes[e];return i.mesh===void 0?null:n.getDependency("mesh",i.mesh).then(function(r){const o=n._getNodeRef(n.meshCache,i.mesh,r);return i.weights!==void 0&&o.traverse(function(a){if(a.isMesh)for(let c=0,l=i.weights.length;c<l;c++)a.morphTargetInfluences[c]=i.weights[c]}),o})}loadNode(e){const t=this.json,n=this,i=t.nodes[e],r=n._loadNodeShallow(e),o=[],a=i.children||[];for(let l=0,u=a.length;l<u;l++)o.push(n.getDependency("node",a[l]));const c=i.skin===void 0?Promise.resolve(null):n.getDependency("skin",i.skin);return Promise.all([r,Promise.all(o),c]).then(function(l){const u=l[0],h=l[1],d=l[2];d!==null&&u.traverse(function(f){f.isSkinnedMesh&&f.bind(d,zx)});for(let f=0,g=h.length;f<g;f++)u.add(h[f]);return u})}_loadNodeShallow(e){const t=this.json,n=this.extensions,i=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];const r=t.nodes[e],o=r.name?i.createUniqueName(r.name):"",a=[],c=i._invokeOne(function(l){return l.createNodeMesh&&l.createNodeMesh(e)});return c&&a.push(c),r.camera!==void 0&&a.push(i.getDependency("camera",r.camera).then(function(l){return i._getNodeRef(i.cameraCache,r.camera,l)})),i._invokeAll(function(l){return l.createNodeAttachment&&l.createNodeAttachment(e)}).forEach(function(l){a.push(l)}),this.nodeCache[e]=Promise.all(a).then(function(l){let u;if(r.isBone===!0?u=new bu:l.length>1?u=new ut:l.length===1?u=l[0]:u=new at,u!==l[0])for(let h=0,d=l.length;h<d;h++)u.add(l[h]);if(r.name&&(u.userData.name=r.name,u.name=o),Bn(u,r),r.extensions&&$n(n,u,r),r.matrix!==void 0){const h=new Oe;h.fromArray(r.matrix),u.applyMatrix4(h)}else r.translation!==void 0&&u.position.fromArray(r.translation),r.rotation!==void 0&&u.quaternion.fromArray(r.rotation),r.scale!==void 0&&u.scale.fromArray(r.scale);return i.associations.has(u)||i.associations.set(u,{}),i.associations.get(u).nodes=e,u}),this.nodeCache[e]}loadScene(e){const t=this.extensions,n=this.json.scenes[e],i=this,r=new ut;n.name&&(r.name=i.createUniqueName(n.name)),Bn(r,n),n.extensions&&$n(t,r,n);const o=n.nodes||[],a=[];for(let c=0,l=o.length;c<l;c++)a.push(i.getDependency("node",o[c]));return Promise.all(a).then(function(c){for(let u=0,h=c.length;u<h;u++)r.add(c[u]);const l=u=>{const h=new Map;for(const[d,f]of i.associations)(d instanceof cn||d instanceof vt)&&h.set(d,f);return u.traverse(d=>{const f=i.associations.get(d);f!=null&&h.set(d,f)}),h};return i.associations=l(r),r})}_createAnimationTracks(e,t,n,i,r){const o=[],a=e.name?e.name:e.uuid,c=[];Fn[r.path]===Fn.weights?e.traverse(function(d){d.morphTargetInfluences&&c.push(d.name?d.name:d.uuid)}):c.push(a);let l;switch(Fn[r.path]){case Fn.weights:l=qi;break;case Fn.rotation:l=hi;break;case Fn.position:case Fn.scale:l=Zi;break;default:switch(n.itemSize){case 1:l=qi;break;case 2:case 3:default:l=Zi;break}break}const u=i.interpolation!==void 0?Dx[i.interpolation]:Xi,h=this._getArrayFromAccessor(n);for(let d=0,f=c.length;d<f;d++){const g=new l(c[d]+"."+Fn[r.path],t.array,h,u);i.interpolation==="CUBICSPLINE"&&this._createCubicSplineTrackInterpolant(g),o.push(g)}return o}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){const n=aa(t.constructor),i=new Float32Array(t.length);for(let r=0,o=t.length;r<o;r++)i[r]=t[r]*n;t=i}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(n){const i=this instanceof hi?Ix:ku;return new i(this.times,this.values,this.getValueSize()/3,n)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}}function Gx(s,e,t){const n=e.attributes,i=new nn;if(n.POSITION!==void 0){const a=t.json.accessors[n.POSITION],c=a.min,l=a.max;if(c!==void 0&&l!==void 0){if(i.set(new A(c[0],c[1],c[2]),new A(l[0],l[1],l[2])),a.normalized){const u=aa(ki[a.componentType]);i.min.multiplyScalar(u),i.max.multiplyScalar(u)}}else{console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.");return}}else return;const r=e.targets;if(r!==void 0){const a=new A,c=new A;for(let l=0,u=r.length;l<u;l++){const h=r[l];if(h.POSITION!==void 0){const d=t.json.accessors[h.POSITION],f=d.min,g=d.max;if(f!==void 0&&g!==void 0){if(c.setX(Math.max(Math.abs(f[0]),Math.abs(g[0]))),c.setY(Math.max(Math.abs(f[1]),Math.abs(g[1]))),c.setZ(Math.max(Math.abs(f[2]),Math.abs(g[2]))),d.normalized){const _=aa(ki[d.componentType]);c.multiplyScalar(_)}a.max(c)}else console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.")}}i.expandByVector(a)}s.boundingBox=i;const o=new ln;i.getCenter(o.center),o.radius=i.min.distanceTo(i.max)/2,s.boundingSphere=o}function zl(s,e,t){const n=e.attributes,i=[];function r(o,a){return t.getDependency("accessor",o).then(function(c){s.setAttribute(a,c)})}for(const o in n){const a=oa[o]||o.toLowerCase();a in s.attributes||i.push(r(n[o],a))}if(e.indices!==void 0&&!s.index){const o=t.getDependency("accessor",e.indices).then(function(a){s.setIndex(a)});i.push(o)}return Ke.workingColorSpace!==Lt&&"COLOR_0"in n&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${Ke.workingColorSpace}" not supported.`),Bn(s,e),Gx(s,e,t),Promise.all(i).then(function(){return e.targets!==void 0?Ux(s,e.targets,t):s})}const Vx="data:model/gltf-binary;base64,",Hx="/casa3d/assets/alien-rock-outcrop-CFto1PsC.glb",Wx="/casa3d/assets/exterior-home-CTIf6HU-.glb",Xx="/casa3d/assets/grass-blade-HskW7sY2.glb",jx="/casa3d/assets/rocks-Bd6hQ_gw.glb",Yx="/casa3d/assets/soccer-pitch-CKvzog4j.glb";function Os(s=128){const e=document.createElement("canvas");return e.width=e.height=s,{canvas:e,ctx:e.getContext("2d")}}function Xr(s,e,t){return s.wrapS=pn,s.wrapT=pn,s.repeat.set(e,t),s.needsUpdate=!0,s}function Xe(s){const e=Math.sin(s*12.9898+78.233)*43758.5453;return e-Math.floor(e)}function qx(){const{canvas:s,ctx:e}=Os(128);e.fillStyle="#3a7d2e",e.fillRect(0,0,128,128);for(let t=0;t<40;t++){const n=Xe(t*3.1)*128,i=Xe(t*5.7)*128,r=6+Xe(t*7.3)*14,o=20+Xe(t*9.1)*25;e.fillStyle=`rgba(${20+o*.3},${60-o*.4},25,${.18+Xe(t*2.2)*.14})`,e.beginPath(),e.ellipse(n,i,r,r*.6,Xe(t)*Math.PI,0,Math.PI*2),e.fill()}for(let t=0;t<260;t++){const n=Xe(t*4.3+1)*128,i=Xe(t*6.9+1)*128,r=1.5+Xe(t*1.7)*2.5,o=120+Xe(t*3.3)*90;e.strokeStyle=`rgba(70,${o},60,${.25+Xe(t*8.8)*.3})`,e.lineWidth=.8,e.beginPath(),e.moveTo(n,i),e.lineTo(n+(Xe(t*2.1)-.5)*2,i-r),e.stroke()}return Xr(new fi(s),14,14)}function Zx(){const{canvas:s,ctx:e}=Os(128),t=e.createLinearGradient(0,0,128,128);t.addColorStop(0,"#1b7d94"),t.addColorStop(1,"#0e4f61"),e.fillStyle=t,e.fillRect(0,0,128,128);for(let n=0;n<18;n++){const i=Xe(n*3.7)*128,r=Xe(n*5.1)*128,o=8+Xe(n*2.6)*26;e.strokeStyle=`rgba(200,235,245,${.08+Xe(n*4.4)*.1})`,e.lineWidth=1+Xe(n*1.3)*1.5,e.beginPath(),e.ellipse(i,r,o,o*.4,0,0,Math.PI*2),e.stroke()}return e.fillStyle="rgba(255,255,255,0.06)",e.fillRect(0,40,128,10),Xr(new fi(s),3,3)}function Jx(){const{canvas:s,ctx:e}=Os(64);e.fillStyle="#5a3a2a",e.fillRect(0,0,64,128);for(let n=0;n<22;n++){const i=Xe(n*2.9)*64;e.strokeStyle=`rgba(${30+Xe(n*1.1)*20},${18+Xe(n*3.3)*15},10,${.3+Xe(n*5.5)*.3})`,e.lineWidth=1+Xe(n*2.2)*2,e.beginPath(),e.moveTo(i,0);let r=i;for(let o=0;o<=128;o+=16)r+=(Xe(n*7+o)-.5)*6,e.lineTo(r,o);e.stroke()}const t=new fi(s);return t.wrapS=pn,t.wrapT=pn,t.repeat.set(2,3),t.needsUpdate=!0,t}function Kx(){const{canvas:s,ctx:e}=Os(64);e.fillStyle="#9b9b8b",e.fillRect(0,0,64,64);for(let t=0;t<90;t++){const n=Xe(t*3.4)*64,i=Xe(t*5.8)*64,r=1+Xe(t*2.1)*2.5,o=Xe(t*6.6)>.5?"40,40,35":"210,210,195";e.fillStyle=`rgba(${o},${.12+Xe(t*1.4)*.18})`,e.beginPath(),e.arc(n,i,r,0,Math.PI*2),e.fill()}return Xr(new fi(s),1,1)}function $x(){const{canvas:s,ctx:e}=Os(64);e.fillStyle="#6b4a34",e.fillRect(0,0,64,64);for(let t=0;t<64;t+=3)e.strokeStyle=`rgba(40,25,15,${.15+Xe(t*.7)*.2})`,e.lineWidth=1,e.beginPath(),e.moveTo(0,t+(Xe(t)-.5)*1.5),e.lineTo(64,t+(Xe(t*2.1)-.5)*1.5),e.stroke();return Xr(new fi(s),2,1)}function Qx(){const s=new ut;s.name="Garden",s.userData.roomName="Giardino",new ms().loadAsync(Wx).then(z=>{const W=z.scene;W.name="ExteriorHome",W.position.set(1.65,0,-.57),W.traverse(O=>{(O.name==="EXT_DoorFrameTop"||O.name==="EXT_DoorFrame_-0.88"||O.name==="EXT_DoorFrame_0.88")&&(O.visible=!1),O.isMesh&&(O.castShadow=!0,O.receiveShadow=!0,O.userData.collidable=!1)}),s.userData.exteriorHome=W,s.add(W)}).catch(z=>{console.warn("Exterior home failed to load.",z)});const e=qx(),t=Zx(),n=Jx();Kx();const i=$x(),r=(z,W)=>!(Math.abs(z)<9.4&&Math.abs(W)<9.4||Math.abs(z)<2.1&&W>3&&W<17||Math.hypot(z-10,W-10)<3.9||z>10.5&&z<20.4&&W>9.2&&W<18.4||z>10.4&&z<21.6&&W>-10.8&&W<7.8),o=new pe({color:16777215,map:e,roughness:.85,metalness:0}),a=new ie(new fn(52,52),o);a.rotation.x=-Math.PI/2,a.position.y=0,a.receiveShadow=!0,a.userData.collidable=!0,s.add(a);const c=typeof window<"u"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,l=typeof navigator<"u"&&/Android|iPhone|iPad|iPod/i.test(navigator.userAgent),u=typeof navigator<"u"&&navigator.hardwareConcurrency||4,h=c?{primary:0,alien:0}:l||u<=4?{primary:7500,alien:3e3}:{primary:24e3,alien:1e4},d=(z,W)=>{const O=Math.sin((z+1)*12.9898+W*78.233)*43758.5453;return O-Math.floor(O)};function f(z,W,O,$=0){const ee=new Au(z,W,O),se=new Oe,Me=new A,ve=new Ds,N=new A;let Ze=$;for(let ye=0;ye<O;ye++){let be=0,Te=0;do Ze+=1,be=-25.3+d(Ze,1)*50.6,Te=-25.3+d(Ze,2)*50.6;while(!r(be,Te));Me.set(be,.012,Te),ve.set(0,d(Ze,3)*Math.PI,(d(Ze,4)-.5)*.12);const Je=.5+d(Ze,5)*.4;N.set(.8+d(Ze,6)*.55,Je,1),se.compose(Me,new Ln().setFromEuler(ve),N),ee.setMatrixAt(ye,se)}return ee.instanceMatrix.needsUpdate=!0,ee.computeBoundingSphere(),ee.userData.collidable=!1,ee.name="InstancedGrassBlades",ee}function g(z,W,O,$,ee){return z.side=kt,z.onBeforeCompile=se=>{se.uniforms.uGrassWindTime=W,se.vertexShader=se.vertexShader.replace("#include <common>",`#include <common>
uniform float uGrassWindTime;`),se.vertexShader=se.vertexShader.replace("#include <begin_vertex>",`#include <begin_vertex>
          ...
          transformed.z += cos(grassPhase * 0.8) * ${ee.toFixed(3)} * grassBend;`)},z.customProgramCacheKey=()=>`grass-wind-${O}`,z.needsUpdate=!0,z}function _({bladeHeight:z,windWidth:W,windDepth:O,...$}){const ee={value:0};return{material:g(new pe($),ee,z,W,O),windTime:ee}}function m(z,W,O={value:0}){const $=(Array.isArray(z)?z:[z]).map(ee=>g(ee.clone(),O,W.bladeHeight,W.windWidth,W.windDepth));return{material:Array.isArray(z)?$:$[0],windTime:O}}if(h.primary>0){let ee=function(se,Me,ve,N){return new ms().loadAsync(se).then(Ze=>{const ye=[];if(Ze.scene.traverse(Je=>{Je.isMesh&&ye.push(Je)}),ye.length===0)throw new Error("Grass GLB has no mesh");const be={value:0},Te=new ut;return Te.name="InstancedGrassTuft",ye.forEach(Je=>{const Fe=m(Je.material,N,be);Te.add(f(Je.geometry,Fe.material,Me,ve))}),{tuftInstances:Te,windTime:be}})};var fe=ee;const z=new fn(.016,.08,1,2);z.translate(0,.04,0);const W=_({color:5216827,roughness:.92,side:kt,bladeHeight:.08,windWidth:.025,windDepth:.014}),O=[W.windTime];let $=f(z,W.material,h.primary);s.add($),s.userData.animateGrass=se=>{O.forEach(Me=>{Me.value=se})},ee(Xx,h.primary,0,{bladeHeight:.182,windWidth:.045,windDepth:.025}).then(({tuftInstances:se,windTime:Me})=>{s.remove($),$.geometry.dispose(),$.material.dispose(),s.add(se),O[0]=Me,$=null}).catch(se=>{console.warn("Sculpted grass blade failed to load, keeping flat fallback.",se)}),ee(Vx,h.alien,1e5,{bladeHeight:.222,windWidth:.065,windDepth:.038}).then(({tuftInstances:se,windTime:Me})=>{se.name="InstancedAlienGrassTuft",s.add(se),O.push(Me)}).catch(se=>{console.warn("Alien grass tuft failed to load.",se)})}const p=[new pe({color:2645304,roughness:.88}),new pe({color:3766082,roughness:.86}),new pe({color:4952397,roughness:.84})];function M(z,W,O=1){const $=new ut;[[0,0,.52],[-.38,.05,.38],[.38,.02,.42],[.06,.2,.36]].forEach(([se,Me,ve],N)=>{const Ze=new ie(new Wn(ve*O,10,7),p[N%p.length]);Ze.scale.set(1.15,.72,1),Ze.position.set(se*O,(ve*.58+Me)*O,0),Ze.userData.collidable=!1,$.add(Ze)}),$.position.set(z,0,W),s.add($)}const x=new pe({color:16777215,map:n,roughness:.82});function v(z,W,O=1){const $=new ut,ee=new ie(new dt(.22*O,.34*O,3.4*O,10),x);ee.position.y=1.7*O,ee.userData.collidable=!0,$.add(ee);const se=new pe({color:2976573,roughness:.75});[[0,3.55,0,1.38],[-.72,3.2,.15,1.05],[.72,3.25,-.12,1.08],[.05,4.15,0,1]].forEach(([Me,ve,N,Ze])=>{const ye=new ie(new Wn(Ze*O,12,8),se);ye.scale.set(1,.82,1),ye.position.set(Me*O,ve*O,N*O),ye.userData.collidable=!1,$.add(ye)}),$.position.set(z,0,W),s.add($)}const b=new pe({color:16777215,map:t,emissive:537671,emissiveIntensity:.2,metalness:.45,roughness:.28}),C=new ie(new zi(3.45,40),new pe({color:16777215,map:e,roughness:.95}));C.rotation.x=-Math.PI/2,C.position.set(10,.015,10),C.userData.collidable=!1,s.add(C);const w=new ie(new zi(3.12,40),b);w.rotation.x=-Math.PI/2,w.position.set(10,.03,10),w.userData.collidable=!1,s.add(w);const L=new pe({color:4357694,roughness:.75});[[9.1,9.45,.34],[10.65,10.45,.26],[11.35,9.25,.22],[9.7,11.2,.2]].forEach(([z,W,O])=>{const $=new ie(new zi(O,12),L);$.rotation.x=-Math.PI/2,$.position.set(z,.055,W),$.userData.collidable=!1,s.add($)});const y=new pe({color:6720835,roughness:.9});function T(z,W){[-.13,0,.14].forEach((O,$)=>{const ee=new ie(new dt(.025,.035,.65+$*.08,5),y);ee.position.set(z+O,.32+$*.04,W+($-1)*.06),ee.rotation.z=($-1)*.12,ee.userData.collidable=!1,s.add(ee)})}[[7.45,9.1],[7.65,11.1],[12.3,8.9],[12.45,10.9]].forEach(([z,W])=>T(z,W));const F=new ba;[[11.8,10.2],[13.6,10.9],[14.8,12.7],[16.1,14.2],[18.6,15.6],[19.3,17.4],[18.3,17.7],[17.1,16.2],[15.2,14.9],[13.7,13.3],[12.5,11.7],[11.2,11.15]].forEach(([z,W],O)=>O===0?F.moveTo(z,W):F.lineTo(z,W)),F.closePath();const B=new ie(new Vr(F),b);B.rotation.x=-Math.PI/2,B.position.y=.028,B.userData.collidable=!1,s.add(B),[[7.25,8.1,.75],[7,10.35,.85],[8,12.25,.72],[10,13.05,.78],[12.3,12.15,.68],[13.45,11.4,.66],[14.45,13,.72],[15.9,14.9,.78],[17.75,16.3,.7],[19.35,16,.82]].forEach(([z,W,O])=>M(z,W,O));const Z=new pe({color:16777215,map:i,roughness:.85}),P=new ut,G=new ie(new je(1.6,.1,.55),Z);G.position.set(0,.46,0),P.add(G);const J=new ie(new je(1.6,.55,.08),Z);J.position.set(0,.75,-.24),P.add(J);for(const[z,W]of[[-.7,.2],[.7,.2],[-.7,-.2],[.7,-.2]]){const O=new ie(new je(.08,.46,.08),Z);O.position.set(z,.23,W),O.userData.collidable=!1,P.add(O)}G.userData.collidable=!0,G.userData.interactable=!0,P.position.set(7.2,0,8.5),P.rotation.y=-.5,s.add(P),new ms().loadAsync(Yx).then(z=>{const W=z.scene;W.name="BlenderSoccerPitch",W.position.set(16,.02,-1.5),W.rotation.y=Math.PI/2,W.traverse(O=>{O.isMesh&&(O.castShadow=!0,O.receiveShadow=!0,O.userData.collidable=!1)}),s.add(W)}).catch(z=>{console.warn("Blender soccer pitch failed to load.",z)}),[[-22,-1,1.1],[-6,-21,.92],[23,-18,1.04],[23,10,1.08],[-17,17,1],[19,14,.95],[-21,5,.88],[3,-20,.9]].forEach(([z,W,O])=>v(z,W,O)),[[-22,-5,.9],[-4,-20,.72],[-3,-18,.85],[-4,-18,.8],[23,-18,.82],[23,6,.9],[-22,10,.78],[-13,19,.88],[2,20,.82],[20,20,.9],[-9,9,.7],[5,15,.75]].forEach(([z,W,O])=>M(z,W,O)),new ms().loadAsync(jx).then(z=>{const W=new ut;W.name="BlenderRockClusters",[[-20,2,1.8,.2],[-8,-20,1.6,1.1],[23,-20,1.9,2.4],[23,10,1.7,3.1],[-20,13,1.8,4.2],[16,19,1.7,5],[-15,3,1.5,5.8]].forEach(([$,ee,se,Me])=>{const ve=z.scene.clone(!0);ve.position.set($,.11,ee),ve.rotation.y=Me,ve.scale.setScalar(se),ve.traverse(N=>{N.isMesh&&(N.castShadow=!0,N.receiveShadow=!0,N.userData.collidable=!1)}),W.add(ve)}),s.add(W)}).catch(z=>{console.warn("Blender rocks failed to load.",z)}),new ms().loadAsync(Hx).then(z=>{const W=new ut;W.name="BlenderAlienRockOutcrops",[[23,14,.78,.4],[18,18,.92,2.3],[-21,13,.8,4.7],[20,5,.67,5.6]].forEach(([$,ee,se,Me])=>{const ve=z.scene.clone(!0);ve.position.set($,.03,ee),ve.rotation.y=Me,ve.scale.setScalar(se),ve.traverse(N=>{N.isMesh&&(N.castShadow=!0,N.receiveShadow=!0,N.userData.collidable=!1)}),W.add(ve)}),s.add(W)}).catch(z=>{console.warn("Detailed Blender rock outcrop failed to load.",z)});const q=new pe({color:3959602,roughness:.85}),Q=[15228011,15909198,9333713,16052714].map(z=>new pe({color:z,roughness:.55}));function K(z,W,O){const $=new ie(new dt(.014,.018,.32,5),q);$.position.set(z,.16,W),$.userData.collidable=!1,s.add($);const ee=new ie(new Aa(.07,0),Q[Math.floor(Xe(O)*Q.length)]);ee.position.set(z,.34,W),ee.scale.set(1,.7,1),ee.userData.collidable=!1,s.add(ee)}const D=[[3,6],[-2.5,9],[6.5,6.5],[8.6,12.6],[11.6,12.3],[6.4,9.6],[3.6,12.4]];let H=0;return D.forEach(([z,W])=>{for(let O=0;O<3;O++){H+=1;const $=z+(Xe(H*4.3)-.5)*1.1,ee=W+(Xe(H*6.7)-.5)*1.1;r($,ee)&&K($,ee,H*9.1)}}),s}class ev{constructor(e){this.container=e||document.body,this.el=document.createElement("div"),this.el.className="room-label",this.container.appendChild(this.el),this._timeout=null}show(e,t=2e3){this.el.textContent=e.toUpperCase(),this.el.style.opacity="1",this._timeout&&clearTimeout(this._timeout),this._timeout=setTimeout(()=>{this.el.style.opacity="0"},t)}}function tv(){const s=new ut;s.name="SpiralStairs",s.userData.isStairs=!0;const e=new ut,t=new pe({color:7429045,emissive:2168649,emissiveIntensity:.35,metalness:.45,roughness:.45}),n=120,i=19.7;for(let l=0;l<n;l++){const u=l/(n-1),h=u*Math.PI*2*2,d=1.35,f=Math.cos(h)*d,g=Math.sin(h)*d,_=-5.5+u*i,m=new ie(new je(.75,.1,.3),t);m.position.set(f,_,g),m.rotation.y=-h,m.userData.collidable=!1,e.add(m)}s.add(e),e.userData.isStepsGroup=!0;const r=new ie(new dt(1.75,1.75,.12,24),new pe({color:5560530,emissive:1330281,emissiveIntensity:.8,metalness:.5,roughness:.28}));r.position.set(0,14.28,0),r.userData.isStairsLanding=!0,s.add(r);const o=new ie(new Ns(.32,.65,4),new pe({color:16766073,emissive:10699354,emissiveIntensity:.65}));o.position.set(0,14.66,0),o.rotation.x=Math.PI,o.userData.isStairsLanding=!0,s.add(o);const a=new ie(new dt(.2,.2,i,12),new pe({color:3355443}));a.position.set(0,4.35,0),a.userData.collidable=!0,s.add(a);const c=new ie(new dt(2.4,2.4,i,24),new pe({visible:!1}));return c.position.set(0,4.35,0),c.userData.collidable=!1,c.userData.isStairsBound=!0,s.add(c),s}const gt=[-5.5,1.05,7,14.2],Cn=new Mu({antialias:!0});Cn.setSize(window.innerWidth,window.innerHeight);Cn.shadowMap.enabled=!0;Cn.setClearColor(462885,1);document.body.appendChild(Cn.domElement);window.__APP={inputBlocked:!0};const Nt=document.createElement("div");Nt.style.position="fixed";Nt.style.left="12px";Nt.style.top="12px";Nt.style.padding="6px 10px";Nt.style.background="rgba(0,0,0,0.7)";Nt.style.color="#9fd";Nt.style.zIndex="9999";Nt.style.fontFamily="monospace";Nt.textContent="Initializing...";document.body.appendChild(Nt);window.addEventListener("error",s=>{Nt.style.background="rgba(80,0,0,0.9)",Nt.textContent="ERROR: "+(s.message||s.error||s),console.error(s)});window.addEventListener("unhandledrejection",s=>{Nt.style.background="rgba(80,0,0,0.9)",Nt.textContent="UNHANDLED REJECTION: "+(s.reason&&s.reason.message?s.reason.message:s.reason),console.error(s)});const wt=new z0;wt.fog=new xa(725024,.02);const sn=new zt(75,window.innerWidth/window.innerHeight,.1,1e3);wt.add(sn);const Gu=new Ca(16773334,1,6);Gu.position.set(0,.2,.5);sn.add(Gu);const nv=new V_(16777215,.62);wt.add(nv);const Vu=new Bu(15266815,.8);Vu.position.set(5,10,2);wt.add(Vu);function iv(){const s=document.createElement("canvas");s.width=s.height=96;const e=s.getContext("2d"),t=e.createRadialGradient(48,48,0,48,48,48);t.addColorStop(0,"rgba(255,255,255,1)"),t.addColorStop(.12,"rgba(232,244,255,0.98)"),t.addColorStop(.3,"rgba(180,211,255,0.46)"),t.addColorStop(.62,"rgba(128,174,255,0.08)"),t.addColorStop(1,"rgba(128,174,255,0)"),e.fillStyle=t,e.fillRect(0,0,96,96);const n=new fi(s);return n.colorSpace=ot,n}const Hu=iv(),Wu=new xt,Xu=600,Tr=new Float32Array(Xu*3);for(let s=0;s<Xu;s++){const e=40+Math.random()*80,t=Math.random()*Math.PI*2,n=Math.acos(Math.random()*2-1);Tr[s*3]=e*Math.sin(n)*Math.cos(t),Tr[s*3+1]=e*Math.sin(n)*Math.sin(t),Tr[s*3+2]=e*Math.cos(n)}Wu.setAttribute("position",new Ct(Tr,3));const ju=new kr({color:15397887,map:Hu,size:.24,transparent:!0,opacity:.9,alphaTest:.03,depthWrite:!1,blending:Ar,sizeAttenuation:!0}),Yu=new Ma(Wu,ju);wt.add(Yu);const qu=new xt,Zu=120,br=new Float32Array(Zu*3);for(let s=0;s<Zu;s++){const e=50+Math.random()*75,t=Math.random()*Math.PI*2,n=Math.acos(Math.random()*2-1);br[s*3]=e*Math.sin(n)*Math.cos(t),br[s*3+1]=e*Math.sin(n)*Math.sin(t),br[s*3+2]=e*Math.cos(n)}qu.setAttribute("position",new Ct(br,3));const Ju=new kr({color:13097215,map:Hu,size:.42,transparent:!0,opacity:.76,alphaTest:.03,depthWrite:!1,blending:Ar,sizeAttenuation:!0}),Ku=new Ma(qu,Ju);wt.add(Ku);function sv(s,e){const t=document.createElement("canvas");t.width=t.height=256;const n=t.getContext("2d"),i=n.createRadialGradient(128,128,0,128,128,128);return i.addColorStop(0,s),i.addColorStop(.45,e),i.addColorStop(1,"rgba(0,0,0,0)"),n.fillStyle=i,n.fillRect(0,0,256,256),new fi(t)}const Ia=new ut;[{position:[-48,25,-62],scale:[35,18,1],inner:"rgba(125,75,195,0.25)",outer:"rgba(35,35,115,0.08)"},{position:[42,18,-60],scale:[28,14,1],inner:"rgba(54,122,178,0.20)",outer:"rgba(35,55,130,0.06)"}].forEach(({position:s,scale:e,inner:t,outer:n})=>{const i=new k0(new Eu({map:sv(t,n),transparent:!0,depthWrite:!1,opacity:.8}));i.position.set(...s),i.scale.set(...e),Ia.add(i)});wt.add(Ia);const $u=new xt().setFromPoints([new A,new A]),ca=new ya({color:15267327,transparent:!0,opacity:0}),Qu=new zr($u,ca);Qu.frustumCulled=!1;wt.add(Qu);const Mr=new A,ko=new A,kl=new A,Gl=new A;let Vl=performance.now()+2800+Math.random()*4e3,_s=0;function rv(s){const e=s*.001;if(ju.opacity=.88+Math.sin(e*.75)*.035,Ju.opacity=.72+Math.sin(e*1.15+1.7)*.075,Yu.rotation.y=e*15e-5,Ku.rotation.y=-e*25e-5,Ia.rotation.y=e*.006,!_s&&s>=Vl){_s=s;const t=sn.getWorldDirection(new A);t.y=0,t.normalize();const n=new A().crossVectors(t,new A(0,1,0)),i=34+Math.random()*16;Mr.copy(sn.position).addScaledVector(t,i).addScaledVector(n,(Math.random()-.5)*30).add(new A(0,7+Math.random()*22,0)),ko.copy(Mr).addScaledVector(n,6+Math.random()*8).add(new A(0,-3-Math.random()*3,-2)),ca.opacity=.95}if(_s){const t=(s-_s)/320;kl.lerpVectors(Mr,ko,t),Gl.lerpVectors(Mr,ko,Math.max(0,t-.28)),$u.setFromPoints([Gl,kl]),ca.opacity=Math.max(0,.95*(1-t)),t>=1&&(_s=0,Vl=s+4500+Math.random()*8500)}}const ov=new Wn(60,32,32),av=new pe({color:3231025,roughness:.92,metalness:.02}),Da=new ie(ov,av);Da.position.y=-60;Da.receiveShadow=!0;wt.add(Da);const Nr=Qx();wt.add(Nr);const eh=lx();wt.add(eh);const th=cx();wt.add(th);const nh=ax();wt.add(nh);const ih=sx();wt.add(ih);const Fs=tv();wt.add(Fs);const cv=[{y:gt[0]+3,color:16757370,intensity:1.1},{y:gt[1]+3,color:16769200,intensity:1.3},{y:gt[2]+3,color:16773840,intensity:1.2},{y:gt[3]+2.7,color:10471167,intensity:1}];cv.forEach(s=>{const e=new Ca(s.color,s.intensity,9,2);e.position.set(0,s.y,-2),wt.add(e)});const jr=[Nr,eh,th,nh,ih],la=new Q_,Go=new de;function lv(){const s=[];return jr.forEach(e=>{e.traverse(t=>{if(t.userData&&t.userData.collidable){const n=new nn().setFromObject(t);s.push(n)}})}),Fs.traverse(e=>{e.userData&&e.userData.collidable&&s.push(new nn().setFromObject(e))}),s}let uv=lv();const _t=new ex(sn,null,{gravity:-6,speed:4.2,runMultiplier:1.9}),hv=new A(0,_t.colliderRadius+.02,24.5),sh=new A(0,13,24.5);_t.setPosition(sh);const rh=new A(0,5.4,0);function oh(s){const e=new A().subVectors(s,_t.getPosition()).normalize();_t.yaw=Math.atan2(e.x,e.z),_t.pitch=Math.asin(e.y),_t.updateCamera()}oh(rh);let ti={start:sh.clone(),end:hv.clone(),startedAt:performance.now(),duration:4200};const dv=null;nx(Cn.domElement,dv,_t);const fv=new ev(document.getElementById("ui-root")),Na=document.createElement("div");Na.className="world-title";Na.textContent="ANIMAL HOUSE";document.getElementById("ui-root").appendChild(Na);const ah=document.getElementById("ui-root"),Bs=document.createElement("div");Bs.className="dim-menu";Bs.innerHTML=`
...
`;ah.appendChild(Bs);Bs.style.visibility="hidden";const Ur=document.querySelector(".mobile-controls");Ur&&(Ur.style.display="none");function pv(s){Bs.style.visibility="visible",Ur&&(Ur.style.display="flex")}const Pn=document.createElement("div");Pn.className="stairs-menu";Pn.style.display="none";Pn.innerHTML='<div class="stairs-inner"><button id="st-up" class="stair-btn" aria-label="Su">&#9650;</button><button id="st-down" class="stair-btn" aria-label="Giu">&#9660;</button></div>';ah.appendChild(Pn);let Yr=!1,zn=null,Ki=0;const mv=700;document.addEventListener("keydown",s=>{if(Yr){if(s.key==="Escape"){Gi();return}s.code==="ArrowUp"?di(1):s.code==="ArrowDown"&&di(-1)}});document.addEventListener("pointerdown",s=>{Yr&&(Pn.contains(s.target)||Gi())});function ch(s){const e=Fs.children.find(t=>t.userData&&t.userData.isStepsGroup);e&&e.traverse(t=>{t.isMesh&&t.material&&(s?(t.material.emissive=new Ce(3368703),t.material.emissiveIntensity=.25):(t.material.emissive=new Ce(0),t.material.emissiveIntensity=0))})}function lh(){if(performance.now()-Ki<mv)return;Pn.style.display="block",Yr=!0,window.__APP.inputBlocked=!0;const e=document.querySelector(".mobile-controls");e&&(e.style.display="none"),ch(!0),Ki=performance.now()}function Gi(){Pn.style.display="none",Yr=!1,window.__APP.inputBlocked=!1;const s=document.querySelector(".mobile-controls");s&&(s.style.display="flex"),ch(!1),Ki=performance.now()}function di(s){const e=_t.getPosition();let t=0,n=1/0;for(let d=0;d<gt.length;d++){const f=Math.abs(e.y-gt[d]);f<n&&(n=f,t=d)}let i=Math.min(gt.length-1,Math.max(0,t+s));if(i===t){Gi();return}const r=Fs.children.find(d=>d.userData&&d.userData.isStairsBound);let o=0,a=0;if(r){const d=new A;r.getWorldPosition(d),o=d.x,a=d.z}const c=[e.clone()];if(t===gt.length-1&&s===-1){c.push(new A(o,gt[t]+.5,a-1.2)),c.push(new A(o,gt[t]-.2,a)),c.push(new A(o,gt[i]+1.2,a)),c.push(new A(o,gt[i]+.5,a+1.8)),zn={curve:new ea(c),startedAt:performance.now(),duration:900},Ki=performance.now(),Gi(),window.__APP.inputBlocked=!0,_t.setMoveState({forward:!1});return}const l=1.45,u=Math.atan2(e.z-a,e.x-o),h=Math.max(1,Math.abs(i-t))*1.15;c.push(new A(o+Math.cos(u)*l,e.y,a+Math.sin(u)*l));for(let d=1;d<=12;d++){const f=d/12,g=u+s*h*Math.PI*2*f;c.push(new A(o+Math.cos(g)*l,ru.lerp(gt[t]+.5,gt[i]+.5,f),a+Math.sin(g)*l))}c.push(new A(o,gt[i]+.5,a+2.8)),zn={curve:new ea(c),startedAt:performance.now(),duration:1150+Math.abs(gt[i]-gt[t])*260},Ki=performance.now(),Gi(),window.__APP.inputBlocked=!0,_t.setMoveState({forward:!1})}const uh=Pn.querySelector("#st-up"),hh=Pn.querySelector("#st-down");uh.addEventListener("click",()=>di(1));uh.addEventListener("touchstart",s=>{s.preventDefault(),di(1)});hh.addEventListener("click",()=>di(-1));hh.addEventListener("touchstart",s=>{s.preventDefault(),di(-1)});let Hl=0;const gv=400;Cn.domElement.addEventListener("click",s=>{if(window.__APP&&window.__APP.inputBlocked||zn)return;const e=Cn.domElement.getBoundingClientRect();if(Go.x=(s.clientX-e.left)/e.width*2-1,Go.y=-((s.clientY-e.top)/e.height)*2+1,sn.updateMatrixWorld(),la.setFromCamera(Go,sn),la.intersectObject(Fs,!0).some(r=>!r.object.userData.isStairsBound)){const r=_t.getPosition();let o=0,a=1/0;for(let c=0;c<gt.length;c++){const l=Math.abs(r.y-gt[c]);l<a&&(a=l,o=c)}if(o===gt.length-1){di(-1);return}lh();return}const n=performance.now();if(n-Hl<gv)return;const i=_v();i&&(fv.show(i.userData.roomName),Hl=n)});function dh(s){for(const e of jr)if(new nn().setFromObject(e).containsPoint(s))return e;return null}function _v(){const s=la.intersectObjects(jr,!0);if(s.length>0){let e=s[0].object;for(;e&&!(e.userData&&e.userData.roomName);)e=e.parent;if(e)return e}return dh(_t.getPosition())}window.addEventListener("resize",()=>{sn.aspect=window.innerWidth/window.innerHeight,sn.updateProjectionMatrix(),Cn.setSize(window.innerWidth,window.innerHeight)});let Wl=performance.now();function fh(){try{const s=performance.now(),e=(s-Wl)/1e3;if(Wl=s,rv(s),Nr.userData.animateGrass&&Nr.userData.animateGrass(s*.001),ti){const n=Math.min(1,(s-ti.startedAt)/ti.duration),i=n*n*(3-2*n);_t.setPosition(new A().lerpVectors(ti.start,ti.end,i)),_t.velocity.set(0,0,0),oh(rh),n===1&&(ti=null,window.__APP.inputBlocked=!1,pv(!0))}else if(zn){const n=Math.min(1,(s-zn.startedAt)/zn.duration),i=n*n*(3-2*n);_t.setPosition(zn.curve.getPointAt(i)),_t.velocity.set(0,0,0),n===1&&(zn=null,window.__APP.inputBlocked=!1,Ki=performance.now())}else _t.update(e,uv);const t=dh(_t.getPosition());t&&(sn.userData.currentRoom=t.userData.roomName),Cn.render(wt,sn),Nt.textContent="Running — pos: "+_t.getPosition().toArray().map(n=>n.toFixed(2)).join(",")}catch(s){console.error("Render error",s),Nt.textContent="ERROR: "+(s&&s.message?s.message:String(s));return}requestAnimationFrame(fh)}fh();window.__APP={scene:wt,camera:sn,player:_t,rooms:jr,inputBlocked:!!ti,openStairsMenu:lh,closeStairsMenu:Gi};
