...
`)+`
`+p);const x=M+m+o,v=M+p+a,T=$c(i,i.VERTEX_SHADER,x),R=$c(i,i.FRAGMENT_SHADER,v);i.attachShader(_,T),i.attachShader(_,R),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function C(F){if(s.debug.checkShaderErrors){const k=i.getProgramInfoLog(_).trim(),J=i.getShaderInfoLog(T).trim(),P=i.getShaderInfoLog(R).trim();let G=!0,q=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(G=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,T,R);else{const j=Qc(i,T,"vertex"),ee=Qc(i,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`

Program Info Log: `+k+`
`+j+`
`+ee)}else k!==""?console.warn("THREE.WebGLProgram: Program Info Log:",k):(J===""||P==="")&&(q=!1);q&&(F.diagnostics={runnable:G,programLog:k,vertexShader:{log:J,prefix:m},fragmentShader:{log:P,prefix:p}})}i.deleteShader(T),i.deleteShader(R),L=new Er(i,_),y=$g(i,_)}let L;this.getUniforms=function(){return L===void 0&&C(this),L};let y;this.getAttributes=function(){return y===void 0&&C(this),y};let b=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return b===!1&&(b=i.getProgramParameter(_,Wg)),b},this.destroy=function(){n.releaseStatesOfProgram(this),i.deleteProgram(_),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Xg++,this.cacheKey=e,this.usedTimes=1,this.program=_,this.vertexShader=T,this.fragmentShader=R,this}let u0=0;class h0{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,i=this._getShaderStage(t),r=this._getShaderStage(n),o=this._getShaderCacheForMaterial(e);return o.has(i)===!1&&(o.add(i),i.usedTimes++),o.has(r)===!1&&(o.add(r),r.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new d0(e),t.set(e,n)),n}}class d0{constructor(e){this.id=u0++,this.code=e,this.usedTimes=0}}function f0(s,e,t,n,i,r,o){const a=new pa,c=new h0,l=[],u=i.isWebGL2,h=i.logarithmicDepthBuffer,d=i.vertexTextures;let f=i.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(y){return y===0?"uv":`uv${y}`}function m(y,b,F,k,J){const P=k.fog,G=J.geometry,q=y.isMeshStandardMaterial?k.environment:null,j=(y.isMeshStandardMaterial?t:e).get(y.envMap||q),ee=j&&j.mapping===Or?j.image.height:null,$=g[y.type];y.precision!==null&&(f=i.getMaxPrecision(y.precision),f!==y.precision&&console.warn("THREE.WebGLProgram.getParameters:",y.precision,"not supported, using",f,"instead."));const K=G.morphAttributes.position||G.morphAttributes.normal||G.morphAttributes.color,D=K!==void 0?K.length:0;let W=0;G.morphAttributes.position!==void 0&&(W=1),G.morphAttributes.normal!==void 0&&(W=2),G.morphAttributes.color!==void 0&&(W=3);let de,fe,ye,U;if($){const ft=un[$];de=ft.vertexShader,fe=ft.fragmentShader}else de=y.vertexShader,fe=y.fragmentShader,c.update(y),ye=c.getVertexShaderID(y),U=c.getFragmentShaderID(y);const V=s.getRenderTarget(),Z=J.isInstancedMesh===!0,Q=!!y.map,le=!!y.matcap,pe=!!j,N=!!y.aoMap,He=!!y.lightMap,_e=!!y.bumpMap,Se=!!y.normalMap,Ee=!!y.displacementMap,Ke=!!y.emissiveMap,Le=!!y.metalnessMap,Pe=!!y.roughnessMap,$e=y.anisotropy>0,St=y.clearcoat>0,Pt=y.iridescence>0,w=y.sheen>0,S=y.transmission>0,B=$e&&!!y.anisotropyMap,se=St&&!!y.clearcoatMap,te=St&&!!y.clearcoatNormalMap,re=St&&!!y.clearcoatRoughnessMap,Te=Pt&&!!y.iridescenceMap,ce=Pt&&!!y.iridescenceThicknessMap,xe=w&&!!y.sheenColorMap,Ie=w&&!!y.sheenRoughnessMap,qe=!!y.specularMap,ie=!!y.specularColorMap,et=!!y.specularIntensityMap,Ue=S&&!!y.transmissionMap,De=S&&!!y.thicknessMap,Ae=!!y.gradientMap,Me=!!y.alphaMap,Xe=y.alphaTest>0,I=!!y.alphaHash,ge=!!y.extensions,oe=!!G.attributes.uv1,Y=!!G.attributes.uv2,ae=!!G.attributes.uv3;let we=Vn;return y.toneMapped&&(V===null||V.isXRRenderTarget===!0)&&(we=s.toneMapping),{isWebGL2:u,shaderID:$,shaderType:y.type,shaderName:y.name,vertexShader:de,fragmentShader:fe,defines:y.defines,customVertexShaderID:ye,customFragmentShaderID:U,isRawShaderMaterial:y.isRawShaderMaterial===!0,glslVersion:y.glslVersion,precision:f,instancing:Z,instancingColor:Z&&J.instanceColor!==null,supportsVertexTextures:d,outputColorSpace:V===null?s.outputColorSpace:V.isXRRenderTarget===!0?V.texture.colorSpace:Lt,map:Q,matcap:le,envMap:pe,envMapMode:pe&&j.mapping,envMapCubeUVHeight:ee,aoMap:N,lightMap:He,bumpMap:_e,normalMap:Se,displacementMap:d&&Ee,emissiveMap:Ke,normalMapObjectSpace:Se&&y.normalMapType===hd,normalMapTangentSpace:Se&&y.normalMapType===nu,metalnessMap:Le,roughnessMap:Pe,anisotropy:$e,anisotropyMap:B,clearcoat:St,clearcoatMap:se,clearcoatNormalMap:te,clearcoatRoughnessMap:re,iridescence:Pt,iridescenceMap:Te,iridescenceThicknessMap:ce,sheen:w,sheenColorMap:xe,sheenRoughnessMap:Ie,specularMap:qe,specularColorMap:ie,specularIntensityMap:et,transmission:S,transmissionMap:Ue,thicknessMap:De,gradientMap:Ae,opaque:y.transparent===!1&&y.blending===Fi,alphaMap:Me,alphaTest:Xe,alphaHash:I,combine:y.combine,mapUv:Q&&_(y.map.channel),aoMapUv:N&&_(y.aoMap.channel),lightMapUv:He&&_(y.lightMap.channel),bumpMapUv:_e&&_(y.bumpMap.channel),normalMapUv:Se&&_(y.normalMap.channel),displacementMapUv:Ee&&_(y.displacementMap.channel),emissiveMapUv:Ke&&_(y.emissiveMap.channel),metalnessMapUv:Le&&_(y.metalnessMap.channel),roughnessMapUv:Pe&&_(y.roughnessMap.channel),anisotropyMapUv:B&&_(y.anisotropyMap.channel),clearcoatMapUv:se&&_(y.clearcoatMap.channel),clearcoatNormalMapUv:te&&_(y.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:re&&_(y.clearcoatRoughnessMap.channel),iridescenceMapUv:Te&&_(y.iridescenceMap.channel),iridescenceThicknessMapUv:ce&&_(y.iridescenceThicknessMap.channel),sheenColorMapUv:xe&&_(y.sheenColorMap.channel),sheenRoughnessMapUv:Ie&&_(y.sheenRoughnessMap.channel),specularMapUv:qe&&_(y.specularMap.channel),specularColorMapUv:ie&&_(y.specularColorMap.channel),specularIntensityMapUv:et&&_(y.specularIntensityMap.channel),transmissionMapUv:Ue&&_(y.transmissionMap.channel),thicknessMapUv:De&&_(y.thicknessMap.channel),alphaMapUv:Me&&_(y.alphaMap.channel),vertexTangents:!!G.attributes.tangent&&(Se||$e),vertexColors:y.vertexColors,vertexAlphas:y.vertexColors===!0&&!!G.attributes.color&&G.attributes.color.itemSize===4,vertexUv1s:oe,vertexUv2s:Y,vertexUv3s:ae,pointsUvs:J.isPoints===!0&&!!G.attributes.uv&&(Q||Me),fog:!!P,useFog:y.fog===!0,fogExp2:P&&P.isFogExp2,flatShading:y.flatShading===!0,sizeAttenuation:y.sizeAttenuation===!0,logarithmicDepthBuffer:h,skinning:J.isSkinnedMesh===!0,morphTargets:G.morphAttributes.position!==void 0,morphNormals:G.morphAttributes.normal!==void 0,morphColors:G.morphAttributes.color!==void 0,morphTargetsCount:D,morphTextureStride:W,numDirLights:b.directional.length,numPointLights:b.point.length,numSpotLights:b.spot.length,numSpotLightMaps:b.spotLightMap.length,numRectAreaLights:b.rectArea.length,numHemiLights:b.hemi.length,numDirLightShadows:b.directionalShadowMap.length,numPointLightShadows:b.pointShadowMap.length,numSpotLightShadows:b.spotShadowMap.length,numSpotLightShadowsWithMaps:b.numSpotLightShadowsWithMaps,numLightProbes:b.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:y.dithering,shadowMapEnabled:s.shadowMap.enabled&&F.length>0,shadowMapType:s.shadowMap.type,toneMapping:we,useLegacyLights:s._useLegacyLights,decodeVideoTexture:Q&&y.map.isVideoTexture===!0&&Je.getTransfer(y.map.colorSpace)===rt,premultipliedAlpha:y.premultipliedAlpha,doubleSided:y.side===kt,flipSided:y.side===Gt,useDepthPacking:y.depthPacking>=0,depthPacking:y.depthPacking||0,index0AttributeName:y.index0AttributeName,extensionDerivatives:ge&&y.extensions.derivatives===!0,extensionFragDepth:ge&&y.extensions.fragDepth===!0,extensionDrawBuffers:ge&&y.extensions.drawBuffers===!0,extensionShaderTextureLOD:ge&&y.extensions.shaderTextureLOD===!0,rendererExtensionFragDepth:u||n.has("EXT_frag_depth"),rendererExtensionDrawBuffers:u||n.has("WEBGL_draw_buffers"),rendererExtensionShaderTextureLod:u||n.has("EXT_shader_texture_lod"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:y.customProgramCacheKey()}}function p(y){const b=[];if(y.shaderID?b.push(y.shaderID):(b.push(y.customVertexShaderID),b.push(y.customFragmentShaderID)),y.defines!==void 0)for(const F in y.defines)b.push(F),b.push(y.defines[F]);return y.isRawShaderMaterial===!1&&(M(b,y),x(b,y),b.push(s.outputColorSpace)),b.push(y.customProgramCacheKey),b.join()}function M(y,b){y.push(b.precision),y.push(b.outputColorSpace),y.push(b.envMapMode),y.push(b.envMapCubeUVHeight),y.push(b.mapUv),y.push(b.alphaMapUv),y.push(b.lightMapUv),y.push(b.aoMapUv),y.push(b.bumpMapUv),y.push(b.normalMapUv),y.push(b.displacementMapUv),y.push(b.emissiveMapUv),y.push(b.metalnessMapUv),y.push(b.roughnessMapUv),y.push(b.anisotropyMapUv),y.push(b.clearcoatMapUv),y.push(b.clearcoatNormalMapUv),y.push(b.clearcoatRoughnessMapUv),y.push(b.iridescenceMapUv),y.push(b.iridescenceThicknessMapUv),y.push(b.sheenColorMapUv),y.push(b.sheenRoughnessMapUv),y.push(b.specularMapUv),y.push(b.specularColorMapUv),y.push(b.specularIntensityMapUv),y.push(b.transmissionMapUv),y.push(b.thicknessMapUv),y.push(b.combine),y.push(b.fogExp2),y.push(b.sizeAttenuation),y.push(b.morphTargetsCount),y.push(b.morphAttributeCount),y.push(b.numDirLights),y.push(b.numPointLights),y.push(b.numSpotLights),y.push(b.numSpotLightMaps),y.push(b.numHemiLights),y.push(b.numRectAreaLights),y.push(b.numDirLightShadows),y.push(b.numPointLightShadows),y.push(b.numSpotLightShadows),y.push(b.numSpotLightShadowsWithMaps),y.push(b.numLightProbes),y.push(b.shadowMapType),y.push(b.toneMapping),y.push(b.numClippingPlanes),y.push(b.numClipIntersection),y.push(b.depthPacking)}function x(y,b){a.disableAll(),b.isWebGL2&&a.enable(0),b.supportsVertexTextures&&a.enable(1),b.instancing&&a.enable(2),b.instancingColor&&a.enable(3),b.matcap&&a.enable(4),b.envMap&&a.enable(5),b.normalMapObjectSpace&&a.enable(6),b.normalMapTangentSpace&&a.enable(7),b.clearcoat&&a.enable(8),b.iridescence&&a.enable(9),b.alphaTest&&a.enable(10),b.vertexColors&&a.enable(11),b.vertexAlphas&&a.enable(12),b.vertexUv1s&&a.enable(13),b.vertexUv2s&&a.enable(14),b.vertexUv3s&&a.enable(15),b.vertexTangents&&a.enable(16),b.anisotropy&&a.enable(17),b.alphaHash&&a.enable(18),y.push(a.mask),a.disableAll(),b.fog&&a.enable(0),b.useFog&&a.enable(1),b.flatShading&&a.enable(2),b.logarithmicDepthBuffer&&a.enable(3),b.skinning&&a.enable(4),b.morphTargets&&a.enable(5),b.morphNormals&&a.enable(6),b.morphColors&&a.enable(7),b.premultipliedAlpha&&a.enable(8),b.shadowMapEnabled&&a.enable(9),b.useLegacyLights&&a.enable(10),b.doubleSided&&a.enable(11),b.flipSided&&a.enable(12),b.useDepthPacking&&a.enable(13),b.dithering&&a.enable(14),b.transmission&&a.enable(15),b.sheen&&a.enable(16),b.opaque&&a.enable(17),b.pointsUvs&&a.enable(18),b.decodeVideoTexture&&a.enable(19),y.push(a.mask)}function v(y){const b=g[y.type];let F;if(b){const k=un[b];F=Kd.clone(k.uniforms)}else F=y.uniforms;return F}function T(y,b){let F;for(let k=0,J=l.length;k<J;k++){const P=l[k];if(P.cacheKey===b){F=P,++F.usedTimes;break}}return F===void 0&&(F=new l0(s,b,y,r),l.push(F)),F}function R(y){if(--y.usedTimes===0){const b=l.indexOf(y);l[b]=l[l.length-1],l.pop(),y.destroy()}}function C(y){c.remove(y)}function L(){c.dispose()}return{getParameters:m,getProgramCacheKey:p,getUniforms:v,acquireProgram:T,releaseProgram:R,releaseShaderCache:C,programs:l,dispose:L}}function p0(){let s=new WeakMap;function e(r){let o=s.get(r);return o===void 0&&(o={},s.set(r,o)),o}function t(r){s.delete(r)}function n(r,o,a){s.get(r)[o]=a}function i(){s=new WeakMap}return{get:e,remove:t,update:n,dispose:i}}function m0(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.material.id!==e.material.id?s.material.id-e.material.id:s.z!==e.z?s.z-e.z:s.id-e.id}function sl(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.z!==e.z?e.z-s.z:s.id-e.id}function rl(){const s=[];let e=0;const t=[],n=[],i=[];function r(){e=0,t.length=0,n.length=0,i.length=0}function o(h,d,f,g,_,m){let p=s[e];return p===void 0?(p={id:h.id,object:h,geometry:d,material:f,groupOrder:g,renderOrder:h.renderOrder,z:_,group:m},s[e]=p):(p.id=h.id,p.object=h,p.geometry=d,p.material=f,p.groupOrder=g,p.renderOrder=h.renderOrder,p.z=_,p.group=m),e++,p}function a(h,d,f,g,_,m){const p=o(h,d,f,g,_,m);f.transmission>0?n.push(p):f.transparent===!0?i.push(p):t.push(p)}function c(h,d,f,g,_,m){const p=o(h,d,f,g,_,m);f.transmission>0?n.unshift(p):f.transparent===!0?i.unshift(p):t.unshift(p)}function l(h,d){t.length>1&&t.sort(h||m0),n.length>1&&n.sort(d||sl),i.length>1&&i.sort(d||sl)}function u(){for(let h=e,d=s.length;h<d;h++){const f=s[h];if(f.id===null)break;f.id=null,f.object=null,f.geometry=null,f.material=null,f.group=null}}return{opaque:t,transmissive:n,transparent:i,init:r,push:a,unshift:c,finish:u,sort:l}}function g0(){let s=new WeakMap;function e(n,i){const r=s.get(n);let o;return r===void 0?(o=new rl,s.set(n,[o])):i>=r.length?(o=new rl,r.push(o)):o=r[i],o}function t(){s=new WeakMap}return{get:e,dispose:t}}function _0(){const s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new A,color:new Ce};break;case"SpotLight":t={position:new A,direction:new A,color:new Ce,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new A,color:new Ce,distance:0,decay:0};break;case"HemisphereLight":t={direction:new A,skyColor:new Ce,groundColor:new Ce};break;case"RectAreaLight":t={color:new Ce,position:new A,halfWidth:new A,halfHeight:new A};break}return s[e.id]=t,t}}}function x0(){const s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new he};break;case"SpotLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new he};break;case"PointLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new he,shadowCameraNear:1,shadowCameraFar:1e3};break}return s[e.id]=t,t}}}let v0=0;function y0(s,e){return(e.castShadow?2:0)-(s.castShadow?2:0)+(e.map?1:0)-(s.map?1:0)}function M0(s,e){const t=new _0,n=x0(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let u=0;u<9;u++)i.probe.push(new A);const r=new A,o=new Be,a=new Be;function c(u,h){let d=0,f=0,g=0;for(let k=0;k<9;k++)i.probe[k].set(0,0,0);let _=0,m=0,p=0,M=0,x=0,v=0,T=0,R=0,C=0,L=0,y=0;u.sort(y0);const b=h===!0?Math.PI:1;for(let k=0,J=u.length;k<J;k++){const P=u[k],G=P.color,q=P.intensity,j=P.distance,ee=P.shadow&&P.shadow.map?P.shadow.map.texture:null;if(P.isAmbientLight)d+=G.r*q*b,f+=G.g*q*b,g+=G.b*q*b;else if(P.isLightProbe){for(let $=0;$<9;$++)i.probe[$].addScaledVector(P.sh.coefficients[$],q);y++}else if(P.isDirectionalLight){const $=t.get(P);if($.color.copy(P.color).multiplyScalar(P.intensity*b),P.castShadow){const K=P.shadow,D=n.get(P);D.shadowBias=K.bias,D.shadowNormalBias=K.normalBias,D.shadowRadius=K.radius,D.shadowMapSize=K.mapSize,i.directionalShadow[_]=D,i.directionalShadowMap[_]=ee,i.directionalShadowMatrix[_]=P.shadow.matrix,v++}i.directional[_]=$,_++}else if(P.isSpotLight){const $=t.get(P);$.position.setFromMatrixPosition(P.matrixWorld),$.color.copy(G).multiplyScalar(q*b),$.distance=j,$.coneCos=Math.cos(P.angle),$.penumbraCos=Math.cos(P.angle*(1-P.penumbra)),$.decay=P.decay,i.spot[p]=$;const K=P.shadow;if(P.map&&(i.spotLightMap[C]=P.map,C++,K.updateMatrices(P),P.castShadow&&L++),i.spotLightMatrix[p]=K.matrix,P.castShadow){const D=n.get(P);D.shadowBias=K.bias,D.shadowNormalBias=K.normalBias,D.shadowRadius=K.radius,D.shadowMapSize=K.mapSize,i.spotShadow[p]=D,i.spotShadowMap[p]=ee,R++}p++}else if(P.isRectAreaLight){const $=t.get(P);$.color.copy(G).multiplyScalar(q),$.halfWidth.set(P.width*.5,0,0),$.halfHeight.set(0,P.height*.5,0),i.rectArea[M]=$,M++}else if(P.isPointLight){const $=t.get(P);if($.color.copy(P.color).multiplyScalar(P.intensity*b),$.distance=P.distance,$.decay=P.decay,P.castShadow){const K=P.shadow,D=n.get(P);D.shadowBias=K.bias,D.shadowNormalBias=K.normalBias,D.shadowRadius=K.radius,D.shadowMapSize=K.mapSize,D.shadowCameraNear=K.camera.near,D.shadowCameraFar=K.camera.far,i.pointShadow[m]=D,i.pointShadowMap[m]=ee,i.pointShadowMatrix[m]=P.shadow.matrix,T++}i.point[m]=$,m++}else if(P.isHemisphereLight){const $=t.get(P);$.skyColor.copy(P.color).multiplyScalar(q*b),$.groundColor.copy(P.groundColor).multiplyScalar(q*b),i.hemi[x]=$,x++}}M>0&&(e.isWebGL2||s.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=ue.LTC_FLOAT_1,i.rectAreaLTC2=ue.LTC_FLOAT_2):s.has("OES_texture_half_float_linear")===!0?(i.rectAreaLTC1=ue.LTC_HALF_1,i.rectAreaLTC2=ue.LTC_HALF_2):console.error("THREE.WebGLRenderer: Unable to use RectAreaLight. Missing WebGL extensions.")),i.ambient[0]=d,i.ambient[1]=f,i.ambient[2]=g;const F=i.hash;(F.directionalLength!==_||F.pointLength!==m||F.spotLength!==p||F.rectAreaLength!==M||F.hemiLength!==x||F.numDirectionalShadows!==v||F.numPointShadows!==T||F.numSpotShadows!==R||F.numSpotMaps!==C||F.numLightProbes!==y)&&(i.directional.length=_,i.spot.length=p,i.rectArea.length=M,i.point.length=m,i.hemi.length=x,i.directionalShadow.length=v,i.directionalShadowMap.length=v,i.pointShadow.length=T,i.pointShadowMap.length=T,i.spotShadow.length=R,i.spotShadowMap.length=R,i.directionalShadowMatrix.length=v,i.pointShadowMatrix.length=T,i.spotLightMatrix.length=R+C-L,i.spotLightMap.length=C,i.numSpotLightShadowsWithMaps=L,i.numLightProbes=y,F.directionalLength=_,F.pointLength=m,F.spotLength=p,F.rectAreaLength=M,F.hemiLength=x,F.numDirectionalShadows=v,F.numPointShadows=T,F.numSpotShadows=R,F.numSpotMaps=C,F.numLightProbes=y,i.version=v0++)}function l(u,h){let d=0,f=0,g=0,_=0,m=0;const p=h.matrixWorldInverse;for(let M=0,x=u.length;M<x;M++){const v=u[M];if(v.isDirectionalLight){const T=i.directional[d];T.direction.setFromMatrixPosition(v.matrixWorld),r.setFromMatrixPosition(v.target.matrixWorld),T.direction.sub(r),T.direction.transformDirection(p),d++}else if(v.isSpotLight){const T=i.spot[g];T.position.setFromMatrixPosition(v.matrixWorld),T.position.applyMatrix4(p),T.direction.setFromMatrixPosition(v.matrixWorld),r.setFromMatrixPosition(v.target.matrixWorld),T.direction.sub(r),T.direction.transformDirection(p),g++}else if(v.isRectAreaLight){const T=i.rectArea[_];T.position.setFromMatrixPosition(v.matrixWorld),T.position.applyMatrix4(p),a.identity(),o.copy(v.matrixWorld),o.premultiply(p),a.extractRotation(o),T.halfWidth.set(v.width*.5,0,0),T.halfHeight.set(0,v.height*.5,0),T.halfWidth.applyMatrix4(a),T.halfHeight.applyMatrix4(a),_++}else if(v.isPointLight){const T=i.point[f];T.position.setFromMatrixPosition(v.matrixWorld),T.position.applyMatrix4(p),f++}else if(v.isHemisphereLight){const T=i.hemi[m];T.direction.setFromMatrixPosition(v.matrixWorld),T.direction.transformDirection(p),m++}}}return{setup:c,setupView:l,state:i}}function ol(s,e){const t=new M0(s,e),n=[],i=[];function r(){n.length=0,i.length=0}function o(h){n.push(h)}function a(h){i.push(h)}function c(h){t.setup(n,h)}function l(h){t.setupView(n,h)}return{init:r,state:{lightsArray:n,shadowsArray:i,lights:t},setupLights:c,setupLightsView:l,pushLight:o,pushShadow:a}}function S0(s,e){let t=new WeakMap;function n(r,o=0){const a=t.get(r);let c;return a===void 0?(c=new ol(s,e),t.set(r,[c])):o>=a.length?(c=new ol(s,e),a.push(c)):c=a[o],c}function i(){t=new WeakMap}return{get:n,dispose:i}}class E0 extends an{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=ld,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class T0 extends an{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const b0=`void main() {
	gl_Position = vec4( position, 1.0 );
...
void main() {
  ...
  <style>
    ...
    touch-action: none;
    z-index: 1000;
  `,_.addEventListener("touchstart",L=>{L.preventDefault(),n.Space=!0,o(),_.style.background="rgba(50, 50, 60, 0.9)",_.style.transform="scale(0.95)"}),_.addEventListener("touchend",L=>{L.preventDefault(),n.Space=!1,o(),_.style.background="rgba(30, 30, 40, 0.7)",_.style.transform="scale(1)"}),g.appendChild(_),f.appendChild(g),"ontouchstart"in window||navigator.maxTouchPoints>0){let $=function(){J=null,P=!1,G=0,q=0,k.style.transform="translate(0, 0)"},K=function(U,V){const Z=F.getBoundingClientRect(),Q=Math.max(-ee,Math.min(ee,U-(Z.left+Z.width/2))),le=Math.max(-ee,Math.min(ee,V-(Z.top+Z.height/2))),pe=Math.hypot(Q,le),N=5;G=pe>N?Q/ee:0,q=pe>N?le/ee:0,k.style.transform=`translate(${Q}px, ${le}px)`},D=function(U){const V=Math.min((U-j)/1e3,.05);j=U,P&&!(window.__APP&&window.__APP.inputBlocked)&&t.rotateView(G*220*V,q*220*V),requestAnimationFrame(D)},W=function(U){for(const V of U)if(V.identifier===L)return V;return null},de=function(U){for(const V of U)if(V.clientX>=window.innerWidth*.35)return V;return null},fe=function(U){return U instanceof Element&&!!U.closest(".mobile-controls")},ye=function(U){L!==null&&W(U.changedTouches)&&(L=null)};var p=$,M=K,x=D,v=W,T=de,R=fe,C=ye;s.style.touchAction="none",document.body.style.touchAction="none",document.documentElement.style.touchAction="none";let L=null,y=0,b=0;const F=document.createElement("div");F.className="camera-joystick",F.setAttribute("aria-label","Controllo visuale"),F.style.cssText=`
      position: fixed;
      right: 30px;
      bottom: 30px;
      width: 112px;
    ...
    `;const k=document.createElement("div");k.style.cssText=`
      ...
      pointer-events: none;
    `,F.appendChild(k),g.appendChild(F);let J=null,P=!1,G=0,q=0,j=performance.now();const ee=33;if(requestAnimationFrame(D),F.addEventListener("pointerdown",U=>{window.__APP&&window.__APP.inputBlocked||(J=U.pointerId,P=!0,K(U.clientX,U.clientY),F.setPointerCapture(U.pointerId),U.preventDefault())}),F.addEventListener("pointermove",U=>{U.pointerId===J&&(K(U.clientX,U.clientY),U.preventDefault())}),F.addEventListener("pointerup",U=>{U.pointerId===J&&$()}),F.addEventListener("pointercancel",U=>{U.pointerId===J&&$()}),!window.PointerEvent){let U=null;const V=Q=>{for(const le of Q)if(le.identifier===U)return le;return null};F.addEventListener("touchstart",Q=>{if(window.__APP&&window.__APP.inputBlocked)return;const le=Q.changedTouches[0];!le||U!==null||(U=le.identifier,P=!0,K(le.clientX,le.clientY),Q.preventDefault())},{passive:!1}),F.addEventListener("touchmove",Q=>{const le=V(Q.changedTouches);le&&(K(le.clientX,le.clientY),Q.preventDefault())},{passive:!1});const Z=Q=>{V(Q.changedTouches)&&(U=null,$())};F.addEventListener("touchend",Z),F.addEventListener("touchcancel",Z)}window.addEventListener("touchstart",U=>{if(window.__APP&&window.__APP.inputBlocked||fe(U.target)||L!==null)return;const V=de(U.changedTouches);V&&(L=V.identifier,y=V.clientX,b=V.clientY,U.preventDefault())},{passive:!1,capture:!0}),window.addEventListener("touchmove",U=>{if(L===null)return;const V=W(U.changedTouches);V&&(t.rotateView((V.clientX-y)*.85,(V.clientY-b)*.85),y=V.clientX,b=V.clientY,U.preventDefault())},{passive:!1,capture:!0}),window.addEventListener("touchend",ye),window.addEventListener("touchcancel",ye)}}const ps=new A;function qt(s,e,t,n,i,r){const o=2*Math.PI*i/4,a=Math.max(r-2*i,0),c=Math.PI/4;ps.copy(e),ps[n]=0,ps.normalize();const l=.5*o/(o+a),u=1-ps.angleTo(s)/c;return Math.sign(ps[t])===1?u*l:a/(o+a)+l+l*(1-u)}class nx extends Ye{constructor(e=1,t=1,n=1,i=2,r=.1){if(i=i*2+1,r=Math.min(e/2,t/2,n/2,r),super(1,1,1,i,i,i),i===1)return;const o=this.toNonIndexed();this.index=null,this.attributes.position=o.attributes.position,this.attributes.normal=o.attributes.normal,this.attributes.uv=o.attributes.uv;const a=new A,c=new A,l=new A(e,t,n).divideScalar(2).subScalar(r),u=this.attributes.position.array,h=this.attributes.normal.array,d=this.attributes.uv.array,f=u.length/6,g=new A,_=.5/i;for(let m=0,p=0;m<u.length;m+=3,p+=2)switch(a.fromArray(u,m),c.copy(a),c.x-=Math.sign(c.x)*_,c.y-=Math.sign(c.y)*_,c.z-=Math.sign(c.z)*_,c.normalize(),u[m+0]=l.x*Math.sign(a.x)+c.x*r,u[m+1]=l.y*Math.sign(a.y)+c.y*r,u[m+2]=l.z*Math.sign(a.z)+c.z*r,h[m+0]=c.x,h[m+1]=c.y,h[m+2]=c.z,Math.floor(m/f)){case 0:g.set(1,0,0),d[p+0]=qt(g,c,"z","y",r,n),d[p+1]=1-qt(g,c,"y","z",r,t);break;case 1:g.set(-1,0,0),d[p+0]=1-qt(g,c,"z","y",r,n),d[p+1]=1-qt(g,c,"y","z",r,t);break;case 2:g.set(0,1,0),d[p+0]=1-qt(g,c,"x","z",r,e),d[p+1]=qt(g,c,"z","x",r,n);break;case 3:g.set(0,-1,0),d[p+0]=1-qt(g,c,"x","z",r,e),d[p+1]=1-qt(g,c,"z","x",r,n);break;case 4:g.set(0,0,1),d[p+0]=1-qt(g,c,"x","y",r,e),d[p+1]=1-qt(g,c,"y","x",r,t);break;case 5:g.set(0,0,-1),d[p+0]=qt(g,c,"x","y",r,e),d[p+1]=1-qt(g,c,"y","x",r,t);break}}}function fn(s,e,t,n=.12){const i=Math.min(n,s/2-.01,e/2-.01,t/2-.01);return new nx(s,e,t,2,Math.max(.01,i))}function Wr(s,e,t,n,i=40){const r=new ba;r.moveTo(-s/2,-e/2),r.lineTo(s/2,-e/2),r.lineTo(s/2,e/2),r.lineTo(-s/2,e/2),r.closePath();const o=new ta;o.absarc(0,0,t,0,Math.PI*2,!0),r.holes.push(o);const a=new Vr(r,i);n.side=kt;const c=new ne(a,n);return c.rotation.x=Math.PI/2,c.userData.collidable=!1,c}function ix(){const s=new ut;s.name="Observatory",s.userData.roomName="Osservatorio";const e=14.2,t=12,n=14,i=5.45,r=new ne(new dn(t,n),new me({color:2434378,roughness:.75}));r.rotation.x=-Math.PI/2,r.position.set(0,e,0),r.userData.collidable=!0,s.add(r);const o=new me({color:2434629,roughness:.8}),a=new ne(fn(.2,i,n),o);a.position.set(-t/2-.1,e+i/2,0),a.userData.collidable=!0,s.add(a);const c=a.clone();c.position.set(t/2+.1,e+i/2,0),s.add(c);const l=new ne(fn(t,i,.2),o);l.position.set(0,e+i/2,-n/2-.1),l.userData.collidable=!0,s.add(l);const u=4.4,h=Wr(t,n,u,new me({color:3042135,roughness:.8}));h.position.set(0,e+i,0),s.add(h);const d=new ne(new dt(u+.15,u+.15,.45,28,1,!0),new me({color:1850675,roughness:.75,side:kt}));d.position.set(0,e+i+.22,0),d.userData.collidable=!1,s.add(d);const f=new ne(new Wn(u+.2,32,16,0,Math.PI*2,0,Math.PI/2),new me({color:1119025,emissive:3547483,emissiveIntensity:.42,metalness:.2,transparent:!0,opacity:.55,roughness:.25,side:kt}));f.position.set(0,e+i+.45,0),f.userData.collidable=!1,s.add(f),s.userData.shells=[a,c,l,h,d,f];const g=new me({color:855586,roughness:.6});for(let R=0;R<8;R++){const C=R/8*Math.PI*2,L=new ne(new wa(u+.2,.035,6,16,Math.PI),g);L.rotation.x=Math.PI/2,L.rotation.z=C,L.position.set(0,e+i+.45,0),L.userData.collidable=!1,s.add(L)}const _=new me({color:1710618,metalness:.6,roughness:.3}),m=new ne(new dt(.22,.3,3.4,16),_);m.rotation.z=Math.PI/2.2,m.position.set(1.4,e+1.8,-1.2),m.userData.collidable=!0,s.add(m);const p=new ne(new dt(.34,.34,.16,16),new me({color:8054783,emissive:1272467,emissiveIntensity:.8,metalness:.7}));p.rotation.z=Math.PI/2.2,p.position.set(2.9,e+2.48,-1.2),p.userData.collidable=!1,s.add(p);for(const[R,C]of[[1.1,-1.7],[1.8,-1.7],[1.45,-.55]]){const L=new ne(new dt(.07,.07,1.8,8),_);L.position.set(R,e+.9,C),L.rotation.z=(R-1.45)*.25,L.userData.collidable=!1,s.add(L)}const M=new me({color:5917242}),x=new ne(new Ye(2.2,.75,1),M);x.position.set(-3.8,e+.6,3.7),x.userData.collidable=!0,s.add(x);const v=new ne(new dt(.48,.58,.75,8),new me({color:9198238}));v.position.set(-3.8,e+.38,5),v.userData.collidable=!0,s.add(v);const T=new me({color:1647681,emissive:2506627,emissiveIntensity:.35});for(const R of[-3.8,-1.5,1.5,3.8]){const C=new ne(new Ye(1.45,1.05,.05),T);C.position.set(R,e+1.9,-n/2+.13),C.userData.collidable=!1,s.add(C);const L=new ne(new Wn(.07,8,8),new me({color:15129087,emissive:10717695,emissiveIntensity:1}));L.position.set(R,e+2,-n/2+.08),L.userData.collidable=!1,s.add(L)}return s}const sx="/casa3d/assets/animal-house-logo-BXBQ06OO.png",rx="/casa3d/assets/animal-house-intro-TpwfSi1P.mp4";function ox(){const s=new ut;s.name="LivingRoom",s.userData.roomName="Salotto";const e=1.05,t=18,n=18,i=5.95,r=new ne(new dn(t,n),new me({color:3230558,roughness:.82}));r.rotation.x=-Math.PI/2,r.position.set(0,e,0),r.userData.collidable=!0,s.add(r);const o=new me({color:3424859,roughness:.82}),a=new ne(fn(.2,i,n),o);a.position.set(-t/2-.1,e+i/2,0),a.userData.collidable=!0,s.add(a);const c=a.clone();c.position.set(t/2+.1,e+i/2,0),s.add(c);const l=new ne(fn(t,i,.2),o);l.position.set(0,e+i/2,-n/2-.1),l.userData.collidable=!0,s.add(l);const u=Wr(t,n,2,new me({color:2701394,roughness:.88}));u.position.set(0,e+i,0),s.add(u),s.userData.shells=[a,c,l,u];const h=new me({color:8408465,roughness:.65}),d=new ne(new Ye(3.6,.45,1.25),h);d.position.set(-1.1,e+.45,-1.2),d.userData.collidable=!0,s.add(d);const f=new ne(new Ye(3.6,.9,.26),h);f.position.set(-1.1,e+.95,-1.72),f.userData.collidable=!0,s.add(f);for(const J of[-2.15,-1.1,-.05]){const P=new ne(new Wn(.42,12,8),new me({color:14118813}));P.scale.set(1,.55,1),P.position.set(J,e+.78,-1.18),P.userData.collidable=!1,s.add(P)}const g=new ut;g.name="AnimalHouseTV",g.position.set(-1.1,e,2.55);const _=new me({color:1513511,metalness:.55,roughness:.3}),m=new ne(fn(3.35,1.95,.24,.13),_);m.position.y=1.65,m.userData.collidable=!0,g.add(m);const p=document.createElement("video");p.src=rx,p.muted=!0,p.loop=!0,p.playsInline=!0,p.preload="auto",p.autoplay=!0;const M=new Y0(p);M.colorSpace=ot,M.minFilter=Rt,g.userData.video=p;const x=new ne(new dn(3.05,1.68),new wn({map:M,toneMapped:!1}));x.position.set(0,1.65,-.125),x.rotation.y=Math.PI,x.userData.collidable=!1,g.add(x),p.addEventListener("canplay",()=>{p.play().catch(J=>console.warn("TV video autoplay was blocked:",J))},{once:!0}),p.load();const v=new Ou().load(sx);v.colorSpace=ot;const T=new ne(new dn(1.62,1.62),new wn({map:v,transparent:!0,toneMapped:!1}));T.position.set(0,1.65,.126),T.userData.collidable=!1,g.add(T);const R=new ne(new dt(.42,.55,.18,16),_);R.position.set(0,.18,0),R.userData.collidable=!0,g.add(R),g.userData.interactable=!0,s.add(g);const C=new ne(new Ye(1.2,2.4,.35),new me({color:2827586}));C.position.set(5.5,e+1.2,-4),C.userData.collidable=!0,s.add(C);const L=new ne(new Ye(1.8,1.4,.6),new me({color:4993099}));L.position.set(-5.2,e+.7,-5.5),L.userData.collidable=!0,s.add(L);const y=new ne(new Ns(.35,.7,8),new me({color:16742938,emissive:16719514,emissiveIntensity:1.1}));y.position.set(-5.2,e+.75,-5.14),y.userData.collidable=!1,s.add(y);const b=new ne(new dt(.95,1.05,.35,6),new me({color:4112824,metalness:.25}));b.position.set(-1.1,e+.18,.9),b.userData.collidable=!0,s.add(b);const F=new ne(new zi(3.5,32),new me({color:2381686,roughness:.9}));F.rotation.x=-Math.PI/2,F.position.set(-1.1,e+.011,.9),F.userData.collidable=!1,s.add(F);const k=new ne(new Ye(1.2,2.4,.35),new me({color:2827586}));return k.position.set(5.5,e+1.2,-1.8),k.userData.collidable=!0,s.add(k),s}function ax(){const s=new ut;s.name="Kitchen",s.userData.roomName="Cucina";const e=7,t=18,n=18,i=6.05,r=new ne(new dn(t,n),new me({color:12175301,roughness:.8}));r.rotation.x=-Math.PI/2,r.position.set(0,e,0),r.userData.collidable=!0,s.add(r);const o=new me({color:7377819,roughness:.75}),a=new ne(fn(.2,i,n),o);a.position.set(-t/2-.1,e+i/2,0),a.userData.collidable=!0,s.add(a);const c=a.clone();c.position.set(t/2+.1,e+i/2,0),s.add(c);const l=new ne(fn(t,i,.2),o);l.position.set(0,e+i/2,-n/2-.1),l.userData.collidable=!0,s.add(l);const u=Wr(t,n,2,new me({color:9414051,roughness:.85}));u.position.set(0,e+i,0),s.add(u),s.userData.shells=[a,c,l,u];const h=new me({color:15329755,metalness:.25,roughness:.35}),d=new ne(new Ye(1.5,2.4,1),h);d.position.set(6.2,e+1.2,-4.8),d.userData.collidable=!0,s.add(d);const f=new ne(new Ye(1.32,1.05,.04),new me({color:11984861,emissive:1858928,emissiveIntensity:.15}));f.position.set(6.2,e+1.55,-4.28),f.userData.collidable=!1,s.add(f);const g=new ne(new dt(.035,.035,.65,8),new me({color:3754853,metalness:.8}));g.position.set(6.7,e+1.55,-4.22),g.userData.collidable=!1,s.add(g);const _=new ne(new dt(1.65,1.45,.16,6),new me({color:11823992,roughness:.6}));_.position.set(0,e+.9,2.8),_.userData.collidable=!0,s.add(_);const m=new ne(new dt(.17,.3,.9,12),new me({color:5978454}));m.position.set(0,e+.45,2.8),m.userData.collidable=!1,s.add(m);const p=new me({color:6771362,roughness:.6});for(const[b,F]of[[-2.2,2.8],[2.2,2.8],[0,5]]){const k=new ne(new dt(.48,.55,.62,8),p);k.position.set(b,e+.31,F),k.userData.collidable=!0,s.add(k);const J=new ne(new Ye(.8,.75,.13),p);J.position.set(b,e+.72,F+.35),J.userData.collidable=!1,s.add(J)}const M=new me({color:2829099,metalness:.4,roughness:.5}),x=new ne(new Ye(1.4,1.05,.9),M);x.position.set(-6.1,e+.53,-4.8),x.userData.collidable=!0,s.add(x);const v=new me({color:1118481});for(const b of[-6.45,-5.75]){const F=new ne(new dt(.18,.18,.03,16),v);F.position.set(b,e+1.06,-4.8),F.userData.collidable=!1,s.add(F)}const T=new me({color:14272936}),R=new ne(new Ye(3.6,1,.85),T);R.position.set(1.7,e+.5,-5),R.userData.collidable=!0,s.add(R);const C=new ne(new Ye(3.8,.12,1),new me({color:4798287,roughness:.35}));C.position.set(1.7,e+1.06,-5),C.userData.collidable=!1,s.add(C);const L=new me({color:16771496,emissive:16764779,emissiveIntensity:.5}),y=new ne(new Ns(.48,.55,12),L);return y.position.set(0,e+2.6,2.8),y.userData.collidable=!1,s.add(y),s}function cx(){const s=new ut;s.name="Basement",s.userData.roomName="Cantina";const e=-5.5,t=18,n=18,i=6.55,r=new ne(new Ye(t,.2,n),new me({color:3681096,roughness:.9}));r.position.set(0,e,0),r.userData.collidable=!0,s.add(r);const o=new me({color:2828608,roughness:.92}),a=new ne(fn(.2,i,n),o);a.position.set(-t/2-.1,e+i/2,0),a.userData.collidable=!0,s.add(a);const c=a.clone();c.position.set(t/2+.1,e+i/2,0),s.add(c);const l=new ne(fn(t,i,.2),o);l.position.set(0,e+i/2,-n/2-.1),l.userData.collidable=!0,s.add(l);const u=new ne(fn(t,i,.2),o);u.position.set(0,e+i/2,n/2+.1),u.userData.collidable=!0,s.add(u);const h=Wr(t,n,2,new me({color:2366771,roughness:.95}));h.position.set(0,e+i,0),s.add(h),s.userData.shells=[a,c,l,u,h];const d=new ne(new Ye(1.25,2.1,.8),new me({color:15706688,metalness:.15}));d.position.set(-4.4,e+1.05,4.5),d.userData.collidable=!0,s.add(d);const f=new ne(new Ye(1.35,.45,.68),new me({color:13717907,emissive:6231629,emissiveIntensity:.35}));f.position.set(-4.4,e+1.82,4.58),f.rotation.x=-.35,f.userData.collidable=!1,s.add(f);const g=new me({color:5979951}),_=new ne(new Ye(4.5,1.4,.7),g);_.position.set(5.5,e+1.2,4.8),_.userData.collidable=!0,s.add(_);const m=new ne(new Ye(1.5,1.05,.6),new me({color:3484226}));m.position.set(5.3,e+1.5,-4.6),m.userData.collidable=!0,s.add(m);const p=new ne(new Ye(1.18,.72,.02),new me({color:1118481,emissive:2789317,emissiveIntensity:.65}));p.position.set(5.3,e+1.5,-4.28),p.userData.collidable=!1,s.add(p);const M=new me({color:9137991});for(let v=0;v<3;v++){const T=new ne(new Ye(.9,.9,.9),M);T.position.set(-5.8,e+.45+v*.92,-4.7),T.userData.collidable=v===0,s.add(T)}const x=new ne(new Ye(.75,.6,.05),new me({color:1118481,emissive:7791871,emissiveIntensity:.65}));return x.position.set(-4.4,e+1.38,4.91),x.userData.collidable=!1,s.add(x),s}function Nl(s,e){if(e===cd)return console.warn("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles."),s;if(e===Yo||e===eu){let t=s.getIndex();if(t===null){const o=[],a=s.getAttribute("position");if(a!==void 0){for(let c=0;c<a.count;c++)o.push(c);s.setIndex(o),t=s.getIndex()}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible."),s}const n=t.count-2,i=[];if(e===Yo)for(let o=1;o<=n;o++)i.push(t.getX(0)),i.push(t.getX(o)),i.push(t.getX(o+1));else for(let o=0;o<n;o++)o%2===0?(i.push(t.getX(o)),i.push(t.getX(o+1)),i.push(t.getX(o+2))):(i.push(t.getX(o+2)),i.push(t.getX(o+1)),i.push(t.getX(o)));i.length/3!==n&&console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.");const r=s.clone();return r.setIndex(i),r.clearGroups(),r}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:",e),s}class ms extends ns{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(t){return new fx(t)}),this.register(function(t){return new Mx(t)}),this.register(function(t){return new Sx(t)}),this.register(function(t){return new Ex(t)}),this.register(function(t){return new mx(t)}),this.register(function(t){return new gx(t)}),this.register(function(t){return new _x(t)}),this.register(function(t){return new xx(t)}),this.register(function(t){return new dx(t)}),this.register(function(t){return new vx(t)}),this.register(function(t){return new px(t)}),this.register(function(t){return new yx(t)}),this.register(function(t){return new ux(t)}),this.register(function(t){return new Tx(t)}),this.register(function(t){return new bx(t)})}load(e,t,n,i){const r=this;let o;this.resourcePath!==""?o=this.resourcePath:this.path!==""?o=this.path:o=sa.extractUrlBase(e),this.manager.itemStart(e);const a=function(l){i?i(l):console.error(l),r.manager.itemError(e),r.manager.itemEnd(e)},c=new Uu(this.manager);c.setPath(this.path),c.setResponseType("arraybuffer"),c.setRequestHeader(this.requestHeader),c.setWithCredentials(this.withCredentials),c.load(e,function(l){try{r.parse(l,o,function(u){t(u),r.manager.itemEnd(e)},a)}catch(u){a(u)}},n,a)}setDRACOLoader(e){return this.dracoLoader=e,this}setDDSLoader(){throw new Error('THREE.GLTFLoader: "MSFT_texture_dds" no longer supported. Please update to "KHR_texture_basisu".')}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,i){let r;const o={},a={},c=new TextDecoder;if(typeof e=="string")r=JSON.parse(e);else if(e instanceof ArrayBuffer)if(c.decode(new Uint8Array(e,0,4))===Bu){try{o[We.KHR_BINARY_GLTF]=new Ax(e)}catch(h){i&&i(h);return}r=JSON.parse(o[We.KHR_BINARY_GLTF].content)}else r=JSON.parse(c.decode(e));else r=e;if(r.asset===void 0||r.asset.version[0]<2){i&&i(new Error("THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported."));return}const l=new zx(r,{path:t||this.resourcePath||"",crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});l.fileLoader.setRequestHeader(this.requestHeader);for(let u=0;u<this.pluginCallbacks.length;u++){const h=this.pluginCallbacks[u](l);h.name||console.error("THREE.GLTFLoader: Invalid plugin found: missing name"),a[h.name]=h,o[h.name]=!0}if(r.extensionsUsed)for(let u=0;u<r.extensionsUsed.length;++u){const h=r.extensionsUsed[u],d=r.extensionsRequired||[];switch(h){case We.KHR_MATERIALS_UNLIT:o[h]=new hx;break;case We.KHR_DRACO_MESH_COMPRESSION:o[h]=new wx(r,this.dracoLoader);break;case We.KHR_TEXTURE_TRANSFORM:o[h]=new Rx;break;case We.KHR_MESH_QUANTIZATION:o[h]=new Cx;break;default:d.indexOf(h)>=0&&a[h]===void 0&&console.warn('THREE.GLTFLoader: Unknown extension "'+h+'".')}}l.setExtensions(o),l.setPlugins(a),l.parse(n,i)}parseAsync(e,t){const n=this;return new Promise(function(i,r){n.parse(e,t,i,r)})}}function lx(){let s={};return{get:function(e){return s[e]},add:function(e,t){s[e]=t},remove:function(e){delete s[e]},removeAll:function(){s={}}}}const We={KHR_BINARY_GLTF:"KHR_binary_glTF",KHR_DRACO_MESH_COMPRESSION:"KHR_draco_mesh_compression",KHR_LIGHTS_PUNCTUAL:"KHR_lights_punctual",KHR_MATERIALS_CLEARCOAT:"KHR_materials_clearcoat",KHR_MATERIALS_IOR:"KHR_materials_ior",KHR_MATERIALS_SHEEN:"KHR_materials_sheen",KHR_MATERIALS_SPECULAR:"KHR_materials_specular",KHR_MATERIALS_TRANSMISSION:"KHR_materials_transmission",KHR_MATERIALS_IRIDESCENCE:"KHR_materials_iridescence",KHR_MATERIALS_ANISOTROPY:"KHR_materials_anisotropy",KHR_MATERIALS_UNLIT:"KHR_materials_unlit",KHR_MATERIALS_VOLUME:"KHR_materials_volume",KHR_TEXTURE_BASISU:"KHR_texture_basisu",KHR_TEXTURE_TRANSFORM:"KHR_texture_transform",KHR_MESH_QUANTIZATION:"KHR_mesh_quantization",KHR_MATERIALS_EMISSIVE_STRENGTH:"KHR_materials_emissive_strength",EXT_TEXTURE_WEBP:"EXT_texture_webp",EXT_TEXTURE_AVIF:"EXT_texture_avif",EXT_MESHOPT_COMPRESSION:"EXT_meshopt_compression",EXT_MESH_GPU_INSTANCING:"EXT_mesh_gpu_instancing"};class ux{constructor(e){this.parser=e,this.name=We.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){const e=this.parser,t=this.parser.json.nodes||[];for(let n=0,i=t.length;n<i;n++){const r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){const t=this.parser,n="light:"+e;let i=t.cache.get(n);if(i)return i;const r=t.json,c=((r.extensions&&r.extensions[this.name]||{}).lights||[])[e];let l;const u=new Ce(16777215);c.color!==void 0&&u.setRGB(c.color[0],c.color[1],c.color[2],Lt);const h=c.range!==void 0?c.range:0;switch(c.type){case"directional":l=new Fu(u),l.target.position.set(0,0,-1),l.add(l.target);break;case"point":l=new Ca(u),l.distance=h;break;case"spot":l=new B_(u),l.distance=h,c.spot=c.spot||{},c.spot.innerConeAngle=c.spot.innerConeAngle!==void 0?c.spot.innerConeAngle:0,c.spot.outerConeAngle=c.spot.outerConeAngle!==void 0?c.spot.outerConeAngle:Math.PI/4,l.angle=c.spot.outerConeAngle,l.penumbra=1-c.spot.innerConeAngle/c.spot.outerConeAngle,l.target.position.set(0,0,-1),l.add(l.target);break;default:throw new Error("THREE.GLTFLoader: Unexpected light type: "+c.type)}return l.position.set(0,0,0),l.decay=2,Bn(l,c),c.intensity!==void 0&&(l.intensity=c.intensity),l.name=t.createUniqueName(c.name||"light_"+e),i=Promise.resolve(l),t.cache.add(n,i),i}getDependency(e,t){if(e==="light")return this._loadLight(t)}createNodeAttachment(e){const t=this,n=this.parser,r=n.json.nodes[e],a=(r.extensions&&r.extensions[this.name]||{}).light;return a===void 0?null:this._loadLight(a).then(function(c){return n._getNodeRef(t.cache,a,c)})}}class hx{constructor(){this.name=We.KHR_MATERIALS_UNLIT}getMaterialType(){return wn}extendParams(e,t,n){const i=[];e.color=new Ce(1,1,1),e.opacity=1;const r=t.pbrMetallicRoughness;if(r){if(Array.isArray(r.baseColorFactor)){const o=r.baseColorFactor;e.color.setRGB(o[0],o[1],o[2],Lt),e.opacity=o[3]}r.baseColorTexture!==void 0&&i.push(n.assignTexture(e,"map",r.baseColorTexture,ot))}return Promise.all(i)}}class dx{constructor(e){this.parser=e,this.name=We.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){const i=this.parser.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=i.extensions[this.name].emissiveStrength;return r!==void 0&&(t.emissiveIntensity=r),Promise.resolve()}}class fx{constructor(e){this.parser=e,this.name=We.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Xn}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[],o=i.extensions[this.name];if(o.clearcoatFactor!==void 0&&(t.clearcoat=o.clearcoatFactor),o.clearcoatTexture!==void 0&&r.push(n.assignTexture(t,"clearcoatMap",o.clearcoatTexture)),o.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=o.clearcoatRoughnessFactor),o.clearcoatRoughnessTexture!==void 0&&r.push(n.assignTexture(t,"clearcoatRoughnessMap",o.clearcoatRoughnessTexture)),o.clearcoatNormalTexture!==void 0&&(r.push(n.assignTexture(t,"clearcoatNormalMap",o.clearcoatNormalTexture)),o.clearcoatNormalTexture.scale!==void 0)){const a=o.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new he(a,a)}return Promise.all(r)}}class px{constructor(e){this.parser=e,this.name=We.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Xn}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[],o=i.extensions[this.name];return o.iridescenceFactor!==void 0&&(t.iridescence=o.iridescenceFactor),o.iridescenceTexture!==void 0&&r.push(n.assignTexture(t,"iridescenceMap",o.iridescenceTexture)),o.iridescenceIor!==void 0&&(t.iridescenceIOR=o.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),o.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=o.iridescenceThicknessMinimum),o.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=o.iridescenceThicknessMaximum),o.iridescenceThicknessTexture!==void 0&&r.push(n.assignTexture(t,"iridescenceThicknessMap",o.iridescenceThicknessTexture)),Promise.all(r)}}class mx{constructor(e){this.parser=e,this.name=We.KHR_MATERIALS_SHEEN}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Xn}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[];t.sheenColor=new Ce(0,0,0),t.sheenRoughness=0,t.sheen=1;const o=i.extensions[this.name];if(o.sheenColorFactor!==void 0){const a=o.sheenColorFactor;t.sheenColor.setRGB(a[0],a[1],a[2],Lt)}return o.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=o.sheenRoughnessFactor),o.sheenColorTexture!==void 0&&r.push(n.assignTexture(t,"sheenColorMap",o.sheenColorTexture,ot)),o.sheenRoughnessTexture!==void 0&&r.push(n.assignTexture(t,"sheenRoughnessMap",o.sheenRoughnessTexture)),Promise.all(r)}}class gx{constructor(e){this.parser=e,this.name=We.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Xn}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[],o=i.extensions[this.name];return o.transmissionFactor!==void 0&&(t.transmission=o.transmissionFactor),o.transmissionTexture!==void 0&&r.push(n.assignTexture(t,"transmissionMap",o.transmissionTexture)),Promise.all(r)}}class _x{constructor(e){this.parser=e,this.name=We.KHR_MATERIALS_VOLUME}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Xn}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[],o=i.extensions[this.name];t.thickness=o.thicknessFactor!==void 0?o.thicknessFactor:0,o.thicknessTexture!==void 0&&r.push(n.assignTexture(t,"thicknessMap",o.thicknessTexture)),t.attenuationDistance=o.attenuationDistance||1/0;const a=o.attenuationColor||[1,1,1];return t.attenuationColor=new Ce().setRGB(a[0],a[1],a[2],Lt),Promise.all(r)}}class xx{constructor(e){this.parser=e,this.name=We.KHR_MATERIALS_IOR}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Xn}extendMaterialParams(e,t){const i=this.parser.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=i.extensions[this.name];return t.ior=r.ior!==void 0?r.ior:1.5,Promise.resolve()}}class vx{constructor(e){this.parser=e,this.name=We.KHR_MATERIALS_SPECULAR}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Xn}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[],o=i.extensions[this.name];t.specularIntensity=o.specularFactor!==void 0?o.specularFactor:1,o.specularTexture!==void 0&&r.push(n.assignTexture(t,"specularIntensityMap",o.specularTexture));const a=o.specularColorFactor||[1,1,1];return t.specularColor=new Ce().setRGB(a[0],a[1],a[2],Lt),o.specularColorTexture!==void 0&&r.push(n.assignTexture(t,"specularColorMap",o.specularColorTexture,ot)),Promise.all(r)}}class yx{constructor(e){this.parser=e,this.name=We.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Xn}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[],o=i.extensions[this.name];return o.anisotropyStrength!==void 0&&(t.anisotropy=o.anisotropyStrength),o.anisotropyRotation!==void 0&&(t.anisotropyRotation=o.anisotropyRotation),o.anisotropyTexture!==void 0&&r.push(n.assignTexture(t,"anisotropyMap",o.anisotropyTexture)),Promise.all(r)}}class Mx{constructor(e){this.parser=e,this.name=We.KHR_TEXTURE_BASISU}loadTexture(e){const t=this.parser,n=t.json,i=n.textures[e];if(!i.extensions||!i.extensions[this.name])return null;const r=i.extensions[this.name],o=t.options.ktx2Loader;if(!o){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures");return null}return t.loadTextureImage(e,r.source,o)}}class Sx{constructor(e){this.parser=e,this.name=We.EXT_TEXTURE_WEBP,this.isSupported=null}loadTexture(e){const t=this.name,n=this.parser,i=n.json,r=i.textures[e];if(!r.extensions||!r.extensions[t])return null;const o=r.extensions[t],a=i.images[o.source];let c=n.textureLoader;if(a.uri){const l=n.options.manager.getHandler(a.uri);l!==null&&(c=l)}return this.detectSupport().then(function(l){if(l)return n.loadTextureImage(e,o.source,c);if(i.extensionsRequired&&i.extensionsRequired.indexOf(t)>=0)throw new Error("THREE.GLTFLoader: WebP required by asset but unsupported.");return n.loadTexture(e)})}detectSupport(){return this.isSupported||(this.isSupported=new Promise(function(e){const t=new Image;t.src="data:image/webp;base64,UklGRiIAAABXRUJQVlA4IBYAAAAwAQCdASoBAAEADsD+JaQAA3AAAAAA",t.onload=t.onerror=function(){e(t.height===1)}})),this.isSupported}}class Ex{constructor(e){this.parser=e,this.name=We.EXT_TEXTURE_AVIF,this.isSupported=null}loadTexture(e){const t=this.name,n=this.parser,i=n.json,r=i.textures[e];if(!r.extensions||!r.extensions[t])return null;const o=r.extensions[t],a=i.images[o.source];let c=n.textureLoader;if(a.uri){const l=n.options.manager.getHandler(a.uri);l!==null&&(c=l)}return this.detectSupport().then(function(l){if(l)return n.loadTextureImage(e,o.source,c);if(i.extensionsRequired&&i.extensionsRequired.indexOf(t)>=0)throw new Error("THREE.GLTFLoader: AVIF required by asset but unsupported.");return n.loadTexture(e)})}detectSupport(){return this.isSupported||(this.isSupported=new Promise(function(e){const t=new Image;t.src="data:image/avif;base64,",t.onload=t.onerror=function(){e(t.height===1)}})),this.isSupported}}class Tx{constructor(e){this.name=We.EXT_MESHOPT_COMPRESSION,this.parser=e}loadBufferView(e){const t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){const i=n.extensions[this.name],r=this.parser.getDependency("buffer",i.buffer),o=this.parser.options.meshoptDecoder;if(!o||!o.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files");return null}return r.then(function(a){const c=i.byteOffset||0,l=i.byteLength||0,u=i.count,h=i.byteStride,d=new Uint8Array(a,c,l);return o.decodeGltfBufferAsync?o.decodeGltfBufferAsync(u,h,d,i.mode,i.filter).then(function(f){return f.buffer}):o.ready.then(function(){const f=new ArrayBuffer(u*h);return o.decodeGltfBuffer(new Uint8Array(f),u,h,d,i.mode,i.filter),f})})}else return null}}class bx{constructor(e){this.name=We.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){const t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;const i=t.meshes[n.mesh];for(const l of i.primitives)if(l.mode!==Zt.TRIANGLES&&l.mode!==Zt.TRIANGLE_STRIP&&l.mode!==Zt.TRIANGLE_FAN&&l.mode!==void 0)return null;const o=n.extensions[this.name].attributes,a=[],c={};for(const l in o)a.push(this.parser.getDependency("accessor",o[l]).then(u=>(c[l]=u,c[l])));return a.length<1?null:(a.push(this.parser.createNodeMesh(e)),Promise.all(a).then(l=>{const u=l.pop(),h=u.isGroup?u.children:[u],d=l[0].count,f=[];for(const g of h){const _=new Be,m=new A,p=new Ln,M=new A(1,1,1),x=new bu(g.geometry,g.material,d);for(let v=0;v<d;v++)c.TRANSLATION&&m.fromBufferAttribute(c.TRANSLATION,v),c.ROTATION&&p.fromBufferAttribute(c.ROTATION,v),c.SCALE&&M.fromBufferAttribute(c.SCALE,v),x.setMatrixAt(v,_.compose(m,p,M));for(const v in c)if(v==="_COLOR_0"){const T=c[v];x.instanceColor=new $o(T.array,T.itemSize,T.normalized)}else v!=="TRANSLATION"&&v!=="ROTATION"&&v!=="SCALE"&&g.geometry.setAttribute(v,c[v]);at.prototype.copy.call(x,g),this.parser.assignFinalMaterial(x),f.push(x)}return u.isGroup?(u.clear(),u.add(...f),u):f[0]}))}}const Bu="glTF",gs=12,Ul={JSON:1313821514,BIN:5130562};class Ax{constructor(e){this.name=We.KHR_BINARY_GLTF,this.content=null,this.body=null;const t=new DataView(e,0,gs),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==Bu)throw new Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");if(this.header.version<2)throw new Error("THREE.GLTFLoader: Legacy binary file detected.");const i=this.header.length-gs,r=new DataView(e,gs);let o=0;for(;o<i;){const a=r.getUint32(o,!0);o+=4;const c=r.getUint32(o,!0);if(o+=4,c===Ul.JSON){const l=new Uint8Array(e,gs+o,a);this.content=n.decode(l)}else if(c===Ul.BIN){const l=gs+o;this.body=e.slice(l,l+a)}o+=a}if(this.content===null)throw new Error("THREE.GLTFLoader: JSON content not found.")}}class wx{constructor(e,t){if(!t)throw new Error("THREE.GLTFLoader: No DRACOLoader instance provided.");this.name=We.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){const n=this.json,i=this.dracoLoader,r=e.extensions[this.name].bufferView,o=e.extensions[this.name].attributes,a={},c={},l={};for(const u in o){const h=oa[u]||u.toLowerCase();a[h]=o[u]}for(const u in e.attributes){const h=oa[u]||u.toLowerCase();if(o[u]!==void 0){const d=n.accessors[e.attributes[u]],f=ki[d.componentType];l[h]=f.name,c[h]=d.normalized===!0}}return t.getDependency("bufferView",r).then(function(u){return new Promise(function(h){i.decodeDracoFile(u,function(d){for(const f in d.attributes){const g=d.attributes[f],_=c[f];_!==void 0&&(g.normalized=_)}h(d)},a,l)})})}}class Rx{constructor(){this.name=We.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0||(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0),e}}class Cx{constructor(){this.name=We.KHR_MESH_QUANTIZATION}}class zu extends Us{constructor(e,t,n,i){super(e,t,n,i)}copySampleValue_(e){const t=this.resultBuffer,n=this.sampleValues,i=this.valueSize,r=e*i*3+i;for(let o=0;o!==i;o++)t[o]=n[r+o];return t}interpolate_(e,t,n,i){const r=this.resultBuffer,o=this.sampleValues,a=this.valueSize,c=a*2,l=a*3,u=i-t,h=(n-t)/u,d=h*h,f=d*h,g=e*l,_=g-l,m=-2*f+3*d,p=f-d,M=1-m,x=p-d+h;for(let v=0;v!==a;v++){const T=o[_+v+a],R=o[_+v+c]*u,C=o[g+v+a],L=o[g+v]*u;r[v]=M*T+x*R+m*C+p*L}return r}}const Lx=new Ln;class Px extends zu{interpolate_(e,t,n,i){const r=super.interpolate_(e,t,n,i);return Lx.fromArray(r).normalize().toArray(r),r}}const Zt={POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6},ki={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},Ol={9728:bt,9729:Rt,9984:jo,9985:Yl,9986:Sr,9987:ai},Fl={33071:Kt,33648:Rr,10497:pn},Fo={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},oa={POSITION:"position",NORMAL:"normal",TANGENT:"tangent",TEXCOORD_0:"uv",TEXCOORD_1:"uv1",TEXCOORD_2:"uv2",TEXCOORD_3:"uv3",COLOR_0:"color",WEIGHTS_0:"skinWeight",JOINTS_0:"skinIndex"},Fn={scale:"scale",translation:"position",rotation:"quaternion",weights:"morphTargetInfluences"},Ix={CUBICSPLINE:void 0,LINEAR:Xi,STEP:As},Bo={OPAQUE:"OPAQUE",MASK:"MASK",BLEND:"BLEND"};function Dx(s){return s.DefaultMaterial===void 0&&(s.DefaultMaterial=new me({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:Rn})),s.DefaultMaterial}function $n(s,e,t){for(const n in t.extensions)s[n]===void 0&&(e.userData.gltfExtensions=e.userData.gltfExtensions||{},e.userData.gltfExtensions[n]=t.extensions[n])}function Bn(s,e){e.extras!==void 0&&(typeof e.extras=="object"?Object.assign(s.userData,e.extras):console.warn("THREE.GLTFLoader: Ignoring primitive type .extras, "+e.extras))}function Nx(s,e,t){let n=!1,i=!1,r=!1;for(let l=0,u=e.length;l<u;l++){const h=e[l];if(h.POSITION!==void 0&&(n=!0),h.NORMAL!==void 0&&(i=!0),h.COLOR_0!==void 0&&(r=!0),n&&i&&r)break}if(!n&&!i&&!r)return Promise.resolve(s);const o=[],a=[],c=[];for(let l=0,u=e.length;l<u;l++){const h=e[l];if(n){const d=h.POSITION!==void 0?t.getDependency("accessor",h.POSITION):s.attributes.position;o.push(d)}if(i){const d=h.NORMAL!==void 0?t.getDependency("accessor",h.NORMAL):s.attributes.normal;a.push(d)}if(r){const d=h.COLOR_0!==void 0?t.getDependency("accessor",h.COLOR_0):s.attributes.color;c.push(d)}}return Promise.all([Promise.all(o),Promise.all(a),Promise.all(c)]).then(function(l){const u=l[0],h=l[1],d=l[2];return n&&(s.morphAttributes.position=u),i&&(s.morphAttributes.normal=h),r&&(s.morphAttributes.color=d),s.morphTargetsRelative=!0,s})}function Ux(s,e){if(s.updateMorphTargets(),e.weights!==void 0)for(let t=0,n=e.weights.length;t<n;t++)s.morphTargetInfluences[t]=e.weights[t];if(e.extras&&Array.isArray(e.extras.targetNames)){const t=e.extras.targetNames;if(s.morphTargetInfluences.length===t.length){s.morphTargetDictionary={};for(let n=0,i=t.length;n<i;n++)s.morphTargetDictionary[t[n]]=n}else console.warn("THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.")}}function Ox(s){let e;const t=s.extensions&&s.extensions[We.KHR_DRACO_MESH_COMPRESSION];if(t?e="draco:"+t.bufferView+":"+t.indices+":"+zo(t.attributes):e=s.indices+":"+zo(s.attributes)+":"+s.mode,s.targets!==void 0)for(let n=0,i=s.targets.length;n<i;n++)e+=":"+zo(s.targets[n]);return e}function zo(s){let e="";const t=Object.keys(s).sort();for(let n=0,i=t.length;n<i;n++)e+=t[n]+":"+s[t[n]]+";";return e}function aa(s){switch(s){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw new Error("THREE.GLTFLoader: Unsupported normalized accessor component type.")}}function Fx(s){return s.search(/\.jpe?g($|\?)/i)>0||s.search(/^data\:image\/jpeg/)===0?"image/jpeg":s.search(/\.webp($|\?)/i)>0||s.search(/^data\:image\/webp/)===0?"image/webp":"image/png"}const Bx=new Be;class zx{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new lx,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,i=!1,r=-1;typeof navigator<"u"&&(n=/^((?!chrome|android).)*safari/i.test(navigator.userAgent)===!0,i=navigator.userAgent.indexOf("Firefox")>-1,r=i?navigator.userAgent.match(/Firefox\/([0-9]+)\./)[1]:-1),typeof createImageBitmap>"u"||n||i&&r<98?this.textureLoader=new Ou(this.options.manager):this.textureLoader=new V_(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new Uu(this.options.manager),this.fileLoader.setResponseType("arraybuffer"),this.options.crossOrigin==="use-credentials"&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){const n=this,i=this.json,r=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(o){return o._markDefs&&o._markDefs()}),Promise.all(this._invokeAll(function(o){return o.beforeRoot&&o.beforeRoot()})).then(function(){return Promise.all([n.getDependencies("scene"),n.getDependencies("animation"),n.getDependencies("camera")])}).then(function(o){const a={scene:o[0][i.scene||0],scenes:o[0],animations:o[1],cameras:o[2],asset:i.asset,parser:n,userData:{}};return $n(r,a,i),Bn(a,i),Promise.all(n._invokeAll(function(c){return c.afterRoot&&c.afterRoot(a)})).then(function(){e(a)})}).catch(t)}_markDefs(){const e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let i=0,r=t.length;i<r;i++){const o=t[i].joints;for(let a=0,c=o.length;a<c;a++)e[o[a]].isBone=!0}for(let i=0,r=e.length;i<r;i++){const o=e[i];o.mesh!==void 0&&(this._addNodeRef(this.meshCache,o.mesh),o.skin!==void 0&&(n[o.mesh].isSkinnedMesh=!0)),o.camera!==void 0&&this._addNodeRef(this.cameraCache,o.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;const i=n.clone(),r=(o,a)=>{const c=this.associations.get(o);c!=null&&this.associations.set(a,c);for(const[l,u]of o.children.entries())r(u,a.children[l])};return r(n,i),i.name+="_instance_"+e.uses[t]++,i}_invokeOne(e){const t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){const i=e(t[n]);if(i)return i}return null}_invokeAll(e){const t=Object.values(this.plugins);t.unshift(this);const n=[];for(let i=0;i<t.length;i++){const r=e(t[i]);r&&n.push(r)}return n}getDependency(e,t){const n=e+":"+t;let i=this.cache.get(n);if(!i){switch(e){case"scene":i=this.loadScene(t);break;case"node":i=this._invokeOne(function(r){return r.loadNode&&r.loadNode(t)});break;case"mesh":i=this._invokeOne(function(r){return r.loadMesh&&r.loadMesh(t)});break;case"accessor":i=this.loadAccessor(t);break;case"bufferView":i=this._invokeOne(function(r){return r.loadBufferView&&r.loadBufferView(t)});break;case"buffer":i=this.loadBuffer(t);break;case"material":i=this._invokeOne(function(r){return r.loadMaterial&&r.loadMaterial(t)});break;case"texture":i=this._invokeOne(function(r){return r.loadTexture&&r.loadTexture(t)});break;case"skin":i=this.loadSkin(t);break;case"animation":i=this._invokeOne(function(r){return r.loadAnimation&&r.loadAnimation(t)});break;case"camera":i=this.loadCamera(t);break;default:if(i=this._invokeOne(function(r){return r!=this&&r.getDependency&&r.getDependency(e,t)}),!i)throw new Error("Unknown type: "+e);break}this.cache.add(n,i)}return i}getDependencies(e){let t=this.cache.get(e);if(!t){const n=this,i=this.json[e+(e==="mesh"?"es":"s")]||[];t=Promise.all(i.map(function(r,o){return n.getDependency(e,o)})),this.cache.add(e,t)}return t}loadBuffer(e){const t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!=="arraybuffer")throw new Error("THREE.GLTFLoader: "+t.type+" buffer type is not supported.");if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[We.KHR_BINARY_GLTF].body);const i=this.options;return new Promise(function(r,o){n.load(sa.resolveURL(t.uri,i.path),r,void 0,function(){o(new Error('THREE.GLTFLoader: Failed to load buffer "'+t.uri+'".'))})})}loadBufferView(e){const t=this.json.bufferViews[e];return this.getDependency("buffer",t.buffer).then(function(n){const i=t.byteLength||0,r=t.byteOffset||0;return n.slice(r,r+i)})}loadAccessor(e){const t=this,n=this.json,i=this.json.accessors[e];if(i.bufferView===void 0&&i.sparse===void 0){const o=Fo[i.type],a=ki[i.componentType],c=i.normalized===!0,l=new a(i.count*o);return Promise.resolve(new Ct(l,o,c))}const r=[];return i.bufferView!==void 0?r.push(this.getDependency("bufferView",i.bufferView)):r.push(null),i.sparse!==void 0&&(r.push(this.getDependency("bufferView",i.sparse.indices.bufferView)),r.push(this.getDependency("bufferView",i.sparse.values.bufferView))),Promise.all(r).then(function(o){const a=o[0],c=Fo[i.type],l=ki[i.componentType],u=l.BYTES_PER_ELEMENT,h=u*c,d=i.byteOffset||0,f=i.bufferView!==void 0?n.bufferViews[i.bufferView].byteStride:void 0,g=i.normalized===!0;let _,m;if(f&&f!==h){const p=Math.floor(d/f),M="InterleavedBuffer:"+i.bufferView+":"+i.componentType+":"+p+":"+i.count;let x=t.cache.get(M);x||(_=new l(a,p*f,i.count*f/u),x=new Mu(_,f/u),t.cache.add(M,x)),m=new Rs(x,c,d%f/u,g)}else a===null?_=new l(i.count*c):_=new l(a,d,i.count*c),m=new Ct(_,c,g);if(i.sparse!==void 0){const p=Fo.SCALAR,M=ki[i.sparse.indices.componentType],x=i.sparse.indices.byteOffset||0,v=i.sparse.values.byteOffset||0,T=new M(o[1],x,i.sparse.count*p),R=new l(o[2],v,i.sparse.count*c);a!==null&&(m=new Ct(m.array.slice(),m.itemSize,m.normalized));for(let C=0,L=T.length;C<L;C++){const y=T[C];if(m.setX(y,R[C*c]),c>=2&&m.setY(y,R[C*c+1]),c>=3&&m.setZ(y,R[C*c+2]),c>=4&&m.setW(y,R[C*c+3]),c>=5)throw new Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.")}}return m})}loadTexture(e){const t=this.json,n=this.options,r=t.textures[e].source,o=t.images[r];let a=this.textureLoader;if(o.uri){const c=n.manager.getHandler(o.uri);c!==null&&(a=c)}return this.loadTextureImage(e,r,a)}loadTextureImage(e,t,n){const i=this,r=this.json,o=r.textures[e],a=r.images[t],c=(a.uri||a.bufferView)+":"+o.sampler;if(this.textureCache[c])return this.textureCache[c];const l=this.loadImageSource(t,n).then(function(u){u.flipY=!1,u.name=o.name||a.name||"",u.name===""&&typeof a.uri=="string"&&a.uri.startsWith("data:image/")===!1&&(u.name=a.uri);const d=(r.samplers||{})[o.sampler]||{};return u.magFilter=Ol[d.magFilter]||Rt,u.minFilter=Ol[d.minFilter]||ai,u.wrapS=Fl[d.wrapS]||pn,u.wrapT=Fl[d.wrapT]||pn,i.associations.set(u,{textures:e}),u}).catch(function(){return null});return this.textureCache[c]=l,l}loadImageSource(e,t){const n=this,i=this.json,r=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(h=>h.clone());const o=i.images[e],a=self.URL||self.webkitURL;let c=o.uri||"",l=!1;if(o.bufferView!==void 0)c=n.getDependency("bufferView",o.bufferView).then(function(h){l=!0;const d=new Blob([h],{type:o.mimeType});return c=a.createObjectURL(d),c});else if(o.uri===void 0)throw new Error("THREE.GLTFLoader: Image "+e+" is missing URI and bufferView");const u=Promise.resolve(c).then(function(h){return new Promise(function(d,f){let g=d;t.isImageBitmapLoader===!0&&(g=function(_){const m=new vt(_);m.needsUpdate=!0,d(m)}),t.load(sa.resolveURL(h,r.path),g,void 0,f)})}).then(function(h){return l===!0&&a.revokeObjectURL(c),h.userData.mimeType=o.mimeType||Fx(o.uri),h}).catch(function(h){throw console.error("THREE.GLTFLoader: Couldn't load texture",c),h});return this.sourceCache[e]=u,u}assignTexture(e,t,n,i){const r=this;return this.getDependency("texture",n.index).then(function(o){if(!o)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(o=o.clone(),o.channel=n.texCoord),r.extensions[We.KHR_TEXTURE_TRANSFORM]){const a=n.extensions!==void 0?n.extensions[We.KHR_TEXTURE_TRANSFORM]:void 0;if(a){const c=r.associations.get(o);o=r.extensions[We.KHR_TEXTURE_TRANSFORM].extendTexture(o,a),r.associations.set(o,c)}}return i!==void 0&&(o.colorSpace=i),e[t]=o,o})}assignFinalMaterial(e){const t=e.geometry;let n=e.material;const i=t.attributes.tangent===void 0,r=t.attributes.color!==void 0,o=t.attributes.normal===void 0;if(e.isPoints){const a="PointsMaterial:"+n.uuid;let c=this.cache.get(a);c||(c=new kr,an.prototype.copy.call(c,n),c.color.copy(n.color),c.map=n.map,c.sizeAttenuation=!1,this.cache.add(a,c)),n=c}else if(e.isLine){const a="LineBasicMaterial:"+n.uuid;let c=this.cache.get(a);c||(c=new ya,an.prototype.copy.call(c,n),c.color.copy(n.color),c.map=n.map,this.cache.add(a,c)),n=c}if(i||r||o){let a="ClonedMaterial:"+n.uuid+":";i&&(a+="derivative-tangents:"),r&&(a+="vertex-colors:"),o&&(a+="flat-shading:");let c=this.cache.get(a);c||(c=n.clone(),r&&(c.vertexColors=!0),o&&(c.flatShading=!0),i&&(c.normalScale&&(c.normalScale.y*=-1),c.clearcoatNormalScale&&(c.clearcoatNormalScale.y*=-1)),this.cache.add(a,c),this.associations.set(c,this.associations.get(n))),n=c}e.material=n}getMaterialType(){return me}loadMaterial(e){const t=this,n=this.json,i=this.extensions,r=n.materials[e];let o;const a={},c=r.extensions||{},l=[];if(c[We.KHR_MATERIALS_UNLIT]){const h=i[We.KHR_MATERIALS_UNLIT];o=h.getMaterialType(),l.push(h.extendParams(a,r,t))}else{const h=r.pbrMetallicRoughness||{};if(a.color=new Ce(1,1,1),a.opacity=1,Array.isArray(h.baseColorFactor)){const d=h.baseColorFactor;a.color.setRGB(d[0],d[1],d[2],Lt),a.opacity=d[3]}h.baseColorTexture!==void 0&&l.push(t.assignTexture(a,"map",h.baseColorTexture,ot)),a.metalness=h.metallicFactor!==void 0?h.metallicFactor:1,a.roughness=h.roughnessFactor!==void 0?h.roughnessFactor:1,h.metallicRoughnessTexture!==void 0&&(l.push(t.assignTexture(a,"metalnessMap",h.metallicRoughnessTexture)),l.push(t.assignTexture(a,"roughnessMap",h.metallicRoughnessTexture))),o=this._invokeOne(function(d){return d.getMaterialType&&d.getMaterialType(e)}),l.push(Promise.all(this._invokeAll(function(d){return d.extendMaterialParams&&d.extendMaterialParams(e,a)})))}r.doubleSided===!0&&(a.side=kt);const u=r.alphaMode||Bo.OPAQUE;if(u===Bo.BLEND?(a.transparent=!0,a.depthWrite=!1):(a.transparent=!1,u===Bo.MASK&&(a.alphaTest=r.alphaCutoff!==void 0?r.alphaCutoff:.5)),r.normalTexture!==void 0&&o!==wn&&(l.push(t.assignTexture(a,"normalMap",r.normalTexture)),a.normalScale=new he(1,1),r.normalTexture.scale!==void 0)){const h=r.normalTexture.scale;a.normalScale.set(h,h)}if(r.occlusionTexture!==void 0&&o!==wn&&(l.push(t.assignTexture(a,"aoMap",r.occlusionTexture)),r.occlusionTexture.strength!==void 0&&(a.aoMapIntensity=r.occlusionTexture.strength)),r.emissiveFactor!==void 0&&o!==wn){const h=r.emissiveFactor;a.emissive=new Ce().setRGB(h[0],h[1],h[2],Lt)}return r.emissiveTexture!==void 0&&o!==wn&&l.push(t.assignTexture(a,"emissiveMap",r.emissiveTexture,ot)),Promise.all(l).then(function(){const h=new o(a);return r.name&&(h.name=r.name),Bn(h,r),t.associations.set(h,{materials:e}),r.extensions&&$n(i,h,r),h})}createUniqueName(e){const t=Qe.sanitizeNodeName(e||"");return t in this.nodeNamesUsed?t+"_"+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){const t=this,n=this.extensions,i=this.primitiveCache;function r(a){return n[We.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(a,t).then(function(c){return Bl(c,a,t)})}const o=[];for(let a=0,c=e.length;a<c;a++){const l=e[a],u=Ox(l),h=i[u];if(h)o.push(h.promise);else{let d;l.extensions&&l.extensions[We.KHR_DRACO_MESH_COMPRESSION]?d=r(l):d=Bl(new xt,l,t),i[u]={primitive:l,promise:d},o.push(d)}}return Promise.all(o)}loadMesh(e){const t=this,n=this.json,i=this.extensions,r=n.meshes[e],o=r.primitives,a=[];for(let c=0,l=o.length;c<l;c++){const u=o[c].material===void 0?Dx(this.cache):this.getDependency("material",o[c].material);a.push(u)}return a.push(t.loadGeometries(o)),Promise.all(a).then(function(c){const l=c.slice(0,c.length-1),u=c[c.length-1],h=[];for(let f=0,g=u.length;f<g;f++){const _=u[f],m=o[f];let p;const M=l[f];if(m.mode===Zt.TRIANGLES||m.mode===Zt.TRIANGLE_STRIP||m.mode===Zt.TRIANGLE_FAN||m.mode===void 0)p=r.isSkinnedMesh===!0?new G0(_,M):new ne(_,M),p.isSkinnedMesh===!0&&p.normalizeSkinWeights(),m.mode===Zt.TRIANGLE_STRIP?p.geometry=Nl(p.geometry,eu):m.mode===Zt.TRIANGLE_FAN&&(p.geometry=Nl(p.geometry,Yo));else if(m.mode===Zt.LINES)p=new X0(_,M);else if(m.mode===Zt.LINE_STRIP)p=new zr(_,M);else if(m.mode===Zt.LINE_LOOP)p=new j0(_,M);else if(m.mode===Zt.POINTS)p=new Ma(_,M);else throw new Error("THREE.GLTFLoader: Primitive mode unsupported: "+m.mode);Object.keys(p.geometry.morphAttributes).length>0&&Ux(p,r),p.name=t.createUniqueName(r.name||"mesh_"+e),Bn(p,r),m.extensions&&$n(i,p,m),t.assignFinalMaterial(p),h.push(p)}for(let f=0,g=h.length;f<g;f++)t.associations.set(h[f],{meshes:e,primitives:f});if(h.length===1)return r.extensions&&$n(i,h[0],r),h[0];const d=new ut;r.extensions&&$n(i,d,r),t.associations.set(d,{meshes:e});for(let f=0,g=h.length;f<g;f++)d.add(h[f]);return d})}loadCamera(e){let t;const n=this.json.cameras[e],i=n[n.type];if(!i){console.warn("THREE.GLTFLoader: Missing camera parameters.");return}return n.type==="perspective"?t=new zt(su.radToDeg(i.yfov),i.aspectRatio||1,i.znear||1,i.zfar||2e6):n.type==="orthographic"&&(t=new ga(-i.xmag,i.xmag,i.ymag,-i.ymag,i.znear,i.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),Bn(t,n),Promise.resolve(t)}loadSkin(e){const t=this.json.skins[e],n=[];for(let i=0,r=t.joints.length;i<r;i++)n.push(this._loadNodeShallow(t.joints[i]));return t.inverseBindMatrices!==void 0?n.push(this.getDependency("accessor",t.inverseBindMatrices)):n.push(null),Promise.all(n).then(function(i){const r=i.pop(),o=i,a=[],c=[];for(let l=0,u=o.length;l<u;l++){const h=o[l];if(h){a.push(h);const d=new Be;r!==null&&d.fromArray(r.array,l*16),c.push(d)}else console.warn('THREE.GLTFLoader: Joint "%s" could not be found.',t.joints[l])}return new va(a,c)})}loadAnimation(e){const t=this.json,n=this,i=t.animations[e],r=i.name?i.name:"animation_"+e,o=[],a=[],c=[],l=[],u=[];for(let h=0,d=i.channels.length;h<d;h++){const f=i.channels[h],g=i.samplers[f.sampler],_=f.target,m=_.node,p=i.parameters!==void 0?i.parameters[g.input]:g.input,M=i.parameters!==void 0?i.parameters[g.output]:g.output;_.node!==void 0&&(o.push(this.getDependency("node",m)),a.push(this.getDependency("accessor",p)),c.push(this.getDependency("accessor",M)),l.push(g),u.push(_))}return Promise.all([Promise.all(o),Promise.all(a),Promise.all(c),Promise.all(l),Promise.all(u)]).then(function(h){const d=h[0],f=h[1],g=h[2],_=h[3],m=h[4],p=[];for(let M=0,x=d.length;M<x;M++){const v=d[M],T=f[M],R=g[M],C=_[M],L=m[M];if(v===void 0)continue;v.updateMatrix&&v.updateMatrix();const y=n._createAnimationTracks(v,T,R,C,L);if(y)for(let b=0;b<y.length;b++)p.push(y[b])}return new L_(r,void 0,p)})}createNodeMesh(e){const t=this.json,n=this,i=t.nodes[e];return i.mesh===void 0?null:n.getDependency("mesh",i.mesh).then(function(r){const o=n._getNodeRef(n.meshCache,i.mesh,r);return i.weights!==void 0&&o.traverse(function(a){if(a.isMesh)for(let c=0,l=i.weights.length;c<l;c++)a.morphTargetInfluences[c]=i.weights[c]}),o})}loadNode(e){const t=this.json,n=this,i=t.nodes[e],r=n._loadNodeShallow(e),o=[],a=i.children||[];for(let l=0,u=a.length;l<u;l++)o.push(n.getDependency("node",a[l]));const c=i.skin===void 0?Promise.resolve(null):n.getDependency("skin",i.skin);return Promise.all([r,Promise.all(o),c]).then(function(l){const u=l[0],h=l[1],d=l[2];d!==null&&u.traverse(function(f){f.isSkinnedMesh&&f.bind(d,Bx)});for(let f=0,g=h.length;f<g;f++)u.add(h[f]);return u})}_loadNodeShallow(e){const t=this.json,n=this.extensions,i=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];const r=t.nodes[e],o=r.name?i.createUniqueName(r.name):"",a=[],c=i._invokeOne(function(l){return l.createNodeMesh&&l.createNodeMesh(e)});return c&&a.push(c),r.camera!==void 0&&a.push(i.getDependency("camera",r.camera).then(function(l){return i._getNodeRef(i.cameraCache,r.camera,l)})),i._invokeAll(function(l){return l.createNodeAttachment&&l.createNodeAttachment(e)}).forEach(function(l){a.push(l)}),this.nodeCache[e]=Promise.all(a).then(function(l){let u;if(r.isBone===!0?u=new Tu:l.length>1?u=new ut:l.length===1?u=l[0]:u=new at,u!==l[0])for(let h=0,d=l.length;h<d;h++)u.add(l[h]);if(r.name&&(u.userData.name=r.name,u.name=o),Bn(u,r),r.extensions&&$n(n,u,r),r.matrix!==void 0){const h=new Be;h.fromArray(r.matrix),u.applyMatrix4(h)}else r.translation!==void 0&&u.position.fromArray(r.translation),r.rotation!==void 0&&u.quaternion.fromArray(r.rotation),r.scale!==void 0&&u.scale.fromArray(r.scale);return i.associations.has(u)||i.associations.set(u,{}),i.associations.get(u).nodes=e,u}),this.nodeCache[e]}loadScene(e){const t=this.extensions,n=this.json.scenes[e],i=this,r=new ut;n.name&&(r.name=i.createUniqueName(n.name)),Bn(r,n),n.extensions&&$n(t,r,n);const o=n.nodes||[],a=[];for(let c=0,l=o.length;c<l;c++)a.push(i.getDependency("node",o[c]));return Promise.all(a).then(function(c){for(let u=0,h=c.length;u<h;u++)r.add(c[u]);const l=u=>{const h=new Map;for(const[d,f]of i.associations)(d instanceof an||d instanceof vt)&&h.set(d,f);return u.traverse(d=>{const f=i.associations.get(d);f!=null&&h.set(d,f)}),h};return i.associations=l(r),r})}_createAnimationTracks(e,t,n,i,r){const o=[],a=e.name?e.name:e.uuid,c=[];Fn[r.path]===Fn.weights?e.traverse(function(d){d.morphTargetInfluences&&c.push(d.name?d.name:d.uuid)}):c.push(a);let l;switch(Fn[r.path]){case Fn.weights:l=qi;break;case Fn.rotation:l=hi;break;case Fn.position:case Fn.scale:l=Zi;break;default:switch(n.itemSize){case 1:l=qi;break;case 2:case 3:default:l=Zi;break}break}const u=i.interpolation!==void 0?Ix[i.interpolation]:Xi,h=this._getArrayFromAccessor(n);for(let d=0,f=c.length;d<f;d++){const g=new l(c[d]+"."+Fn[r.path],t.array,h,u);i.interpolation==="CUBICSPLINE"&&this._createCubicSplineTrackInterpolant(g),o.push(g)}return o}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){const n=aa(t.constructor),i=new Float32Array(t.length);for(let r=0,o=t.length;r<o;r++)i[r]=t[r]*n;t=i}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(n){const i=this instanceof hi?Px:zu;return new i(this.times,this.values,this.getValueSize()/3,n)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}}function kx(s,e,t){const n=e.attributes,i=new tn;if(n.POSITION!==void 0){const a=t.json.accessors[n.POSITION],c=a.min,l=a.max;if(c!==void 0&&l!==void 0){if(i.set(new A(c[0],c[1],c[2]),new A(l[0],l[1],l[2])),a.normalized){const u=aa(ki[a.componentType]);i.min.multiplyScalar(u),i.max.multiplyScalar(u)}}else{console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.");return}}else return;const r=e.targets;if(r!==void 0){const a=new A,c=new A;for(let l=0,u=r.length;l<u;l++){const h=r[l];if(h.POSITION!==void 0){const d=t.json.accessors[h.POSITION],f=d.min,g=d.max;if(f!==void 0&&g!==void 0){if(c.setX(Math.max(Math.abs(f[0]),Math.abs(g[0]))),c.setY(Math.max(Math.abs(f[1]),Math.abs(g[1]))),c.setZ(Math.max(Math.abs(f[2]),Math.abs(g[2]))),d.normalized){const _=aa(ki[d.componentType]);c.multiplyScalar(_)}a.max(c)}else console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.")}}i.expandByVector(a)}s.boundingBox=i;const o=new cn;i.getCenter(o.center),o.radius=i.min.distanceTo(i.max)/2,s.boundingSphere=o}function Bl(s,e,t){const n=e.attributes,i=[];function r(o,a){return t.getDependency("accessor",o).then(function(c){s.setAttribute(a,c)})}for(const o in n){const a=oa[o]||o.toLowerCase();a in s.attributes||i.push(r(n[o],a))}if(e.indices!==void 0&&!s.index){const o=t.getDependency("accessor",e.indices).then(function(a){s.setIndex(a)});i.push(o)}return Je.workingColorSpace!==Lt&&"COLOR_0"in n&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${Je.workingColorSpace}" not supported.`),Bn(s,e),kx(s,e,t),Promise.all(i).then(function(){return e.targets!==void 0?Nx(s,e.targets,t):s})}const Gx="data:model/gltf-binary;base64,",Vx="/casa3d/assets/alien-rock-outcrop-CFto1PsC.glb",Hx="/casa3d/assets/exterior-home-D41XIbTe.glb",Wx="/casa3d/assets/grass-blade-HskW7sY2.glb",Xx="/casa3d/assets/rocks-Bd6hQ_gw.glb",jx="/casa3d/assets/soccer-pitch-CKvzog4j.glb";function Os(s=128){const e=document.createElement("canvas");return e.width=e.height=s,{canvas:e,ctx:e.getContext("2d")}}function Xr(s,e,t){return s.wrapS=pn,s.wrapT=pn,s.repeat.set(e,t),s.needsUpdate=!0,s}function je(s){const e=Math.sin(s*12.9898+78.233)*43758.5453;return e-Math.floor(e)}function Yx(){const{canvas:s,ctx:e}=Os(128);e.fillStyle="#3a7d2e",e.fillRect(0,0,128,128);for(let t=0;t<40;t++){const n=je(t*3.1)*128,i=je(t*5.7)*128,r=6+je(t*7.3)*14,o=20+je(t*9.1)*25;e.fillStyle=`rgba(${20+o*.3},${60-o*.4},25,${.18+je(t*2.2)*.14})`,e.beginPath(),e.ellipse(n,i,r,r*.6,je(t)*Math.PI,0,Math.PI*2),e.fill()}for(let t=0;t<260;t++){const n=je(t*4.3+1)*128,i=je(t*6.9+1)*128,r=1.5+je(t*1.7)*2.5,o=120+je(t*3.3)*90;e.strokeStyle=`rgba(70,${o},60,${.25+je(t*8.8)*.3})`,e.lineWidth=.8,e.beginPath(),e.moveTo(n,i),e.lineTo(n+(je(t*2.1)-.5)*2,i-r),e.stroke()}return Xr(new fi(s),14,14)}function qx(){const{canvas:s,ctx:e}=Os(128),t=e.createLinearGradient(0,0,128,128);t.addColorStop(0,"#1b7d94"),t.addColorStop(1,"#0e4f61"),e.fillStyle=t,e.fillRect(0,0,128,128);for(let n=0;n<18;n++){const i=je(n*3.7)*128,r=je(n*5.1)*128,o=8+je(n*2.6)*26;e.strokeStyle=`rgba(200,235,245,${.08+je(n*4.4)*.1})`,e.lineWidth=1+je(n*1.3)*1.5,e.beginPath(),e.ellipse(i,r,o,o*.4,0,0,Math.PI*2),e.stroke()}return e.fillStyle="rgba(255,255,255,0.06)",e.fillRect(0,40,128,10),Xr(new fi(s),3,3)}function Zx(){const{canvas:s,ctx:e}=Os(64);e.fillStyle="#5a3a2a",e.fillRect(0,0,64,128);for(let n=0;n<22;n++){const i=je(n*2.9)*64;e.strokeStyle=`rgba(${30+je(n*1.1)*20},${18+je(n*3.3)*15},10,${.3+je(n*5.5)*.3})`,e.lineWidth=1+je(n*2.2)*2,e.beginPath(),e.moveTo(i,0);let r=i;for(let o=0;o<=128;o+=16)r+=(je(n*7+o)-.5)*6,e.lineTo(r,o);e.stroke()}const t=new fi(s);return t.wrapS=pn,t.wrapT=pn,t.repeat.set(2,3),t.needsUpdate=!0,t}function Jx(){const{canvas:s,ctx:e}=Os(64);e.fillStyle="#9b9b8b",e.fillRect(0,0,64,64);for(let t=0;t<90;t++){const n=je(t*3.4)*64,i=je(t*5.8)*64,r=1+je(t*2.1)*2.5,o=je(t*6.6)>.5?"40,40,35":"210,210,195";e.fillStyle=`rgba(${o},${.12+je(t*1.4)*.18})`,e.beginPath(),e.arc(n,i,r,0,Math.PI*2),e.fill()}return Xr(new fi(s),1,1)}function Kx(){const{canvas:s,ctx:e}=Os(64);e.fillStyle="#6b4a34",e.fillRect(0,0,64,64);for(let t=0;t<64;t+=3)e.strokeStyle=`rgba(40,25,15,${.15+je(t*.7)*.2})`,e.lineWidth=1,e.beginPath(),e.moveTo(0,t+(je(t)-.5)*1.5),e.lineTo(64,t+(je(t*2.1)-.5)*1.5),e.stroke();return Xr(new fi(s),2,1)}function $x(){const s=new ut;s.name="Garden",s.userData.roomName="Giardino",new ms().loadAsync(Hx).then(U=>{const V=U.scene;V.name="ExteriorHome",V.position.set(1.65,0,-.57),V.traverse(Z=>{Z.isMesh&&(Z.castShadow=!0,Z.receiveShadow=!0,Z.userData.collidable=!1)}),s.userData.exteriorHome=V,s.add(V)}).catch(U=>{console.warn("Exterior home failed to load.",U)});const e=Yx(),t=qx(),n=Zx(),i=Jx(),r=Kx(),o=(U,V)=>!(Math.abs(U)<9.4&&Math.abs(V)<9.4||Math.abs(U)<2.1&&V>3&&V<17||Math.hypot(U-10,V-10)<3.9||U>10.5&&U<20.4&&V>9.2&&V<18.4||U>-1.4&&U<15.4&&V>-25.9&&V<-16.7),a=new me({color:16777215,map:e,roughness:.85,metalness:0}),c=new ne(new dn(52,52),a);c.rotation.x=-Math.PI/2,c.position.y=0,c.receiveShadow=!0,c.userData.collidable=!0,s.add(c);const l=typeof window<"u"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,u=typeof navigator<"u"&&/Android|iPhone|iPad|iPod/i.test(navigator.userAgent),h=typeof navigator<"u"&&navigator.hardwareConcurrency||4,d=l?{primary:0,alien:0}:u||h<=4?{primary:7500,alien:3e3}:{primary:24e3,alien:1e4},f=(U,V)=>{const Z=Math.sin((U+1)*12.9898+V*78.233)*43758.5453;return Z-Math.floor(Z)};function g(U,V,Z,Q=0){const le=new bu(U,V,Z),pe=new Be,N=new A,He=new Ds,_e=new A;let Se=Q;for(let Ee=0;Ee<Z;Ee++){let Ke=0,Le=0;do Se+=1,Ke=-25.3+f(Se,1)*50.6,Le=-25.3+f(Se,2)*50.6;while(!o(Ke,Le));N.set(Ke,.012,Le),He.set(0,f(Se,3)*Math.PI,(f(Se,4)-.5)*.12);const Pe=.5+f(Se,5)*.4;_e.set(.8+f(Se,6)*.55,Pe,1),pe.compose(N,new Ln().setFromEuler(He),_e),le.setMatrixAt(Ee,pe)}return le.instanceMatrix.needsUpdate=!0,le.computeBoundingSphere(),le.userData.collidable=!1,le.name="InstancedGrassBlades",le}function _(U,V,Z,Q,le){return U.side=kt,U.onBeforeCompile=pe=>{pe.uniforms.uGrassWindTime=V,pe.vertexShader=pe.vertexShader.replace("#include <common>",`#include <common>
uniform float uGrassWindTime;`),pe.vertexShader=pe.vertexShader.replace("#include <begin_vertex>",`#include <begin_vertex>
          ...
          transformed.x += sin(grassPhase) * ${Q.toFixed(3)} * grassBend;
          transformed.z += cos(grassPhase * 0.8) * ${le.toFixed(3)} * grassBend;`)},U.customProgramCacheKey=()=>`grass-wind-${Z}`,U.needsUpdate=!0,U}function m({bladeHeight:U,windWidth:V,windDepth:Z,...Q}){const le={value:0};return{material:_(new me(Q),le,U,V,Z),windTime:le}}function p(U,V,Z={value:0}){const Q=(Array.isArray(U)?U:[U]).map(le=>_(le.clone(),Z,V.bladeHeight,V.windWidth,V.windDepth));return{material:Array.isArray(U)?Q:Q[0],windTime:Z}}if(d.primary>0){let le=function(pe,N,He,_e){return new ms().loadAsync(pe).then(Se=>{const Ee=[];if(Se.scene.traverse(Pe=>{Pe.isMesh&&Ee.push(Pe)}),Ee.length===0)throw new Error("Grass GLB has no mesh");const Ke={value:0},Le=new ut;return Le.name="InstancedGrassTuft",Ee.forEach(Pe=>{const $e=p(Pe.material,_e,Ke);Le.add(g(Pe.geometry,$e.material,N,He))}),{tuftInstances:Le,windTime:Ke}})};var ye=le;const U=new dn(.016,.08,1,2);U.translate(0,.04,0);const V=m({color:5216827,roughness:.92,side:kt,bladeHeight:.08,windWidth:.025,windDepth:.014}),Z=[V.windTime];let Q=g(U,V.material,d.primary);s.add(Q),s.userData.animateGrass=pe=>{Z.forEach(N=>{N.value=pe})},le(Wx,d.primary,0,{bladeHeight:.182,windWidth:.045,windDepth:.025}).then(({tuftInstances:pe,windTime:N})=>{s.remove(Q),Q.geometry.dispose(),Q.material.dispose(),s.add(pe),Z[0]=N,Q=null}).catch(pe=>{console.warn("Sculpted grass blade failed to load, keeping flat fallback.",pe)}),le(Gx,d.alien,1e5,{bladeHeight:.222,windWidth:.065,windDepth:.038}).then(({tuftInstances:pe,windTime:N})=>{pe.name="InstancedAlienGrassTuft",s.add(pe),Z.push(N)}).catch(pe=>{console.warn("Alien grass tuft failed to load.",pe)})}const M=[new me({color:2645304,roughness:.88}),new me({color:3766082,roughness:.86}),new me({color:4952397,roughness:.84})];function x(U,V,Z=1){const Q=new ut;[[0,0,.52],[-.38,.05,.38],[.38,.02,.42],[.06,.2,.36]].forEach(([pe,N,He],_e)=>{const Se=new ne(new Wn(He*Z,10,7),M[_e%M.length]);Se.scale.set(1.15,.72,1),Se.position.set(pe*Z,(He*.58+N)*Z,0),Se.userData.collidable=!1,Q.add(Se)}),Q.position.set(U,0,V),s.add(Q)}const v=new me({color:16777215,map:n,roughness:.82});function T(U,V,Z=1){const Q=new ut,le=new ne(new dt(.22*Z,.34*Z,3.4*Z,10),v);le.position.y=1.7*Z,le.userData.collidable=!0,Q.add(le);const pe=new me({color:2976573,roughness:.75});[[0,3.55,0,1.38],[-.72,3.2,.15,1.05],[.72,3.25,-.12,1.08],[.05,4.15,0,1]].forEach(([N,He,_e,Se])=>{const Ee=new ne(new Wn(Se*Z,12,8),pe);Ee.scale.set(1,.82,1),Ee.position.set(N*Z,He*Z,_e*Z),Ee.userData.collidable=!1,Q.add(Ee)}),Q.position.set(U,0,V),s.add(Q)}const R=new me({color:16777215,map:t,emissive:537671,emissiveIntensity:.2,metalness:.45,roughness:.28}),C=new ne(new zi(3.45,40),new me({color:16777215,map:e,roughness:.95}));C.rotation.x=-Math.PI/2,C.position.set(10,.015,10),C.userData.collidable=!1,s.add(C);const L=new ne(new zi(3.12,40),R);L.rotation.x=-Math.PI/2,L.position.set(10,.03,10),L.userData.collidable=!1,s.add(L);const y=new me({color:4357694,roughness:.75});[[9.1,9.45,.34],[10.65,10.45,.26],[11.35,9.25,.22],[9.7,11.2,.2]].forEach(([U,V,Z])=>{const Q=new ne(new zi(Z,12),y);Q.rotation.x=-Math.PI/2,Q.position.set(U,.055,V),Q.userData.collidable=!1,s.add(Q)});const b=new me({color:6720835,roughness:.9});function F(U,V){[-.13,0,.14].forEach((Z,Q)=>{const le=new ne(new dt(.025,.035,.65+Q*.08,5),b);le.position.set(U+Z,.32+Q*.04,V+(Q-1)*.06),le.rotation.z=(Q-1)*.12,le.userData.collidable=!1,s.add(le)})}[[7.45,9.1],[7.65,11.1],[12.3,8.9],[12.45,10.9]].forEach(([U,V])=>F(U,V));const k=new ba;[[11.8,10.2],[13.6,10.9],[14.8,12.7],[16.1,14.2],[18.6,15.6],[19.3,17.4],[18.3,17.7],[17.1,16.2],[15.2,14.9],[13.7,13.3],[12.5,11.7],[11.2,11.15]].forEach(([U,V],Z)=>Z===0?k.moveTo(U,V):k.lineTo(U,V)),k.closePath();const J=new ne(new Vr(k),R);J.rotation.x=-Math.PI/2,J.position.y=.028,J.userData.collidable=!1,s.add(J),[[7.25,8.1,.75],[7,10.35,.85],[8,12.25,.72],[10,13.05,.78],[12.3,12.15,.68],[13.45,11.4,.66],[14.45,13,.72],[15.9,14.9,.78],[17.75,16.3,.7],[19.35,16,.82]].forEach(([U,V,Z])=>x(U,V,Z));const P=new me({color:16777215,map:r,roughness:.85}),G=new ut,q=new ne(new Ye(1.6,.1,.55),P);q.position.set(0,.46,0),G.add(q);const j=new ne(new Ye(1.6,.55,.08),P);j.position.set(0,.75,-.24),G.add(j);for(const[U,V]of[[-.7,.2],[.7,.2],[-.7,-.2],[.7,-.2]]){const Z=new ne(new Ye(.08,.46,.08),P);Z.position.set(U,.23,V),Z.userData.collidable=!1,G.add(Z)}q.userData.collidable=!0,q.userData.interactable=!0,G.position.set(7.2,0,8.5),G.rotation.y=-.5,s.add(G),new ms().loadAsync(jx).then(U=>{const V=U.scene;V.name="BlenderSoccerPitch",V.position.set(7.01,.02,-21.54),V.traverse(Z=>{Z.isMesh&&(Z.castShadow=!0,Z.receiveShadow=!0,Z.userData.collidable=!1)}),s.add(V)}).catch(U=>{console.warn("Blender soccer pitch failed to load.",U)}),[[-22,-1,1.1],[-6,-21,.92],[19,-16,1.04],[21,-11,1.08],[-17,17,1],[19,14,.95],[-21,5,.88],[3,-20,.9]].forEach(([U,V,Z])=>T(U,V,Z)),[[-22,-5,.9],[-4,-20,.72],[-3,-18,.85],[-4,-18,.8],[19,-18,.82],[22,-4,.9],[-22,10,.78],[-13,19,.88],[2,20,.82],[20,20,.9],[-9,9,.7],[5,15,.75]].forEach(([U,V,Z])=>x(U,V,Z));const ee=new me({color:16777215,map:i,roughness:.9});for(let U=0;U<9;U++){const V=new ne(new Ye(1.2,.12,1.2),ee);V.position.set(0,.06,10.9+U*1.2),V.userData.collidable=!1,s.add(V)}new ms().loadAsync(Xx).then(U=>{const V=new ut;V.name="BlenderRockClusters",[[-20,2,1.8,.2],[-8,-20,1.6,1.1],[20,-19,1.9,2.4],[21,-6,1.7,3.1],[-20,13,1.8,4.2],[16,19,1.7,5],[-15,3,1.5,5.8]].forEach(([Q,le,pe,N])=>{const He=U.scene.clone(!0);He.position.set(Q,.11,le),He.rotation.y=N,He.scale.setScalar(pe),He.traverse(_e=>{_e.isMesh&&(_e.castShadow=!0,_e.receiveShadow=!0,_e.userData.collidable=!1)}),V.add(He)}),s.add(V)}).catch(U=>{console.warn("Blender rocks failed to load.",U)}),new ms().loadAsync(Vx).then(U=>{const V=new ut;V.name="BlenderAlienRockOutcrops",[[19,-5,.78,.4],[18,18,.92,2.3],[-21,13,.8,4.7],[20,5,.67,5.6]].forEach(([Q,le,pe,N])=>{const He=U.scene.clone(!0);He.position.set(Q,.03,le),He.rotation.y=N,He.scale.setScalar(pe),He.traverse(_e=>{_e.isMesh&&(_e.castShadow=!0,_e.receiveShadow=!0,_e.userData.collidable=!1)}),V.add(He)}),s.add(V)}).catch(U=>{console.warn("Detailed Blender rock outcrop failed to load.",U)});const $=new me({color:3959602,roughness:.85}),D=[15228011,15909198,9333713,16052714].map(U=>new me({color:U,roughness:.55}));function W(U,V,Z){const Q=new ne(new dt(.014,.018,.32,5),$);Q.position.set(U,.16,V),Q.userData.collidable=!1,s.add(Q);const le=new ne(new Aa(.07,0),D[Math.floor(je(Z)*D.length)]);le.position.set(U,.34,V),le.scale.set(1,.7,1),le.userData.collidable=!1,s.add(le)}const de=[[3,6],[-2.5,9],[6.5,6.5],[8.6,12.6],[11.6,12.3],[6.4,9.6],[3.6,12.4]];let fe=0;return de.forEach(([U,V])=>{for(let Z=0;Z<3;Z++){fe+=1;const Q=U+(je(fe*4.3)-.5)*1.1,le=V+(je(fe*6.7)-.5)*1.1;o(Q,le)&&W(Q,le,fe*9.1)}}),s}class Qx{constructor(e){this.container=e||document.body,this.el=document.createElement("div"),this.el.className="room-label",this.container.appendChild(this.el),this._timeout=null}show(e,t=2e3){this.el.textContent=e.toUpperCase(),this.el.style.opacity="1",this._timeout&&clearTimeout(this._timeout),this._timeout=setTimeout(()=>{this.el.style.opacity="0"},t)}}function ev(){const s=new ut;s.name="SpiralStairs",s.userData.isStairs=!0;const e=new ut,t=new me({color:7429045,emissive:2168649,emissiveIntensity:.35,metalness:.45,roughness:.45}),n=120,i=19.7;for(let l=0;l<n;l++){const u=l/(n-1),h=u*Math.PI*2*2,d=1.35,f=Math.cos(h)*d,g=Math.sin(h)*d,_=-5.5+u*i,m=new ne(new Ye(.75,.1,.3),t);m.position.set(f,_,g),m.rotation.y=-h,m.userData.collidable=!1,e.add(m)}s.add(e),e.userData.isStepsGroup=!0;const r=new ne(new dt(1.75,1.75,.12,24),new me({color:5560530,emissive:1330281,emissiveIntensity:.8,metalness:.5,roughness:.28}));r.position.set(0,14.28,0),r.userData.isStairsLanding=!0,s.add(r);const o=new ne(new Ns(.32,.65,4),new me({color:16766073,emissive:10699354,emissiveIntensity:.65}));o.position.set(0,14.66,0),o.rotation.x=Math.PI,o.userData.isStairsLanding=!0,s.add(o);const a=new ne(new dt(.2,.2,i,12),new me({color:3355443}));a.position.set(0,4.35,0),a.userData.collidable=!0,s.add(a);const c=new ne(new dt(2.4,2.4,i,24),new me({visible:!1}));return c.position.set(0,4.35,0),c.userData.collidable=!1,c.userData.isStairsBound=!0,s.add(c),s}const gt=[-5.5,1.05,7,14.2],Cn=new yu({antialias:!0});Cn.setSize(window.innerWidth,window.innerHeight);Cn.shadowMap.enabled=!0;Cn.setClearColor(462885,1);document.body.appendChild(Cn.domElement);window.__APP={inputBlocked:!0};const Nt=document.createElement("div");Nt.style.position="fixed";Nt.style.left="12px";Nt.style.top="12px";Nt.style.padding="6px 10px";Nt.style.background="rgba(0,0,0,0.7)";Nt.style.color="#9fd";Nt.style.zIndex="9999";Nt.style.fontFamily="monospace";Nt.textContent="Initializing...";document.body.appendChild(Nt);window.addEventListener("error",s=>{Nt.style.background="rgba(80,0,0,0.9)",Nt.textContent="ERROR: "+(s.message||s.error||s),console.error(s)});window.addEventListener("unhandledrejection",s=>{Nt.style.background="rgba(80,0,0,0.9)",Nt.textContent="UNHANDLED REJECTION: "+(s.reason&&s.reason.message?s.reason.message:s.reason),console.error(s)});const wt=new B0;wt.fog=new xa(725024,.02);const nn=new zt(75,window.innerWidth/window.innerHeight,.1,1e3);wt.add(nn);const ku=new Ca(16773334,1,6);ku.position.set(0,.2,.5);nn.add(ku);const tv=new G_(16777215,.35);wt.add(tv);const Gu=new Fu(16775398,.6);Gu.position.set(5,10,2);wt.add(Gu);function nv(){const s=document.createElement("canvas");s.width=s.height=96;const e=s.getContext("2d"),t=e.createRadialGradient(48,48,0,48,48,48);t.addColorStop(0,"rgba(255,255,255,1)"),t.addColorStop(.12,"rgba(232,244,255,0.98)"),t.addColorStop(.3,"rgba(180,211,255,0.46)"),t.addColorStop(.62,"rgba(128,174,255,0.08)"),t.addColorStop(1,"rgba(128,174,255,0)"),e.fillStyle=t,e.fillRect(0,0,96,96);const n=new fi(s);return n.colorSpace=ot,n}const Vu=nv(),Hu=new xt,Wu=600,Tr=new Float32Array(Wu*3);for(let s=0;s<Wu;s++){const e=40+Math.random()*80,t=Math.random()*Math.PI*2,n=Math.acos(Math.random()*2-1);Tr[s*3]=e*Math.sin(n)*Math.cos(t),Tr[s*3+1]=e*Math.sin(n)*Math.sin(t),Tr[s*3+2]=e*Math.cos(n)}Hu.setAttribute("position",new Ct(Tr,3));const Xu=new kr({color:15397887,map:Vu,size:.24,transparent:!0,opacity:.9,alphaTest:.03,depthWrite:!1,blending:Ar,sizeAttenuation:!0}),ju=new Ma(Hu,Xu);wt.add(ju);const Yu=new xt,qu=120,br=new Float32Array(qu*3);for(let s=0;s<qu;s++){const e=50+Math.random()*75,t=Math.random()*Math.PI*2,n=Math.acos(Math.random()*2-1);br[s*3]=e*Math.sin(n)*Math.cos(t),br[s*3+1]=e*Math.sin(n)*Math.sin(t),br[s*3+2]=e*Math.cos(n)}Yu.setAttribute("position",new Ct(br,3));const Zu=new kr({color:13097215,map:Vu,size:.42,transparent:!0,opacity:.76,alphaTest:.03,depthWrite:!1,blending:Ar,sizeAttenuation:!0}),Ju=new Ma(Yu,Zu);wt.add(Ju);function iv(s,e){const t=document.createElement("canvas");t.width=t.height=256;const n=t.getContext("2d"),i=n.createRadialGradient(128,128,0,128,128,128);return i.addColorStop(0,s),i.addColorStop(.45,e),i.addColorStop(1,"rgba(0,0,0,0)"),n.fillStyle=i,n.fillRect(0,0,256,256),new fi(t)}const Ia=new ut;[{position:[-48,25,-62],scale:[35,18,1],inner:"rgba(125,75,195,0.25)",outer:"rgba(35,35,115,0.08)"},{position:[42,18,-60],scale:[28,14,1],inner:"rgba(54,122,178,0.20)",outer:"rgba(35,55,130,0.06)"}].forEach(({position:s,scale:e,inner:t,outer:n})=>{const i=new z0(new Su({map:iv(t,n),transparent:!0,depthWrite:!1,opacity:.8}));i.position.set(...s),i.scale.set(...e),Ia.add(i)});wt.add(Ia);const Ku=new xt().setFromPoints([new A,new A]),ca=new ya({color:15267327,transparent:!0,opacity:0}),$u=new zr(Ku,ca);$u.frustumCulled=!1;wt.add($u);const Mr=new A,ko=new A,zl=new A,kl=new A;let Gl=performance.now()+2800+Math.random()*4e3,_s=0;function sv(s){const e=s*.001;if(Xu.opacity=.88+Math.sin(e*.75)*.035,Zu.opacity=.72+Math.sin(e*1.15+1.7)*.075,ju.rotation.y=e*15e-5,Ju.rotation.y=-e*25e-5,Ia.rotation.y=e*.006,!_s&&s>=Gl){_s=s;const t=nn.getWorldDirection(new A);t.y=0,t.normalize();const n=new A().crossVectors(t,new A(0,1,0)),i=34+Math.random()*16;Mr.copy(nn.position).addScaledVector(t,i).addScaledVector(n,(Math.random()-.5)*30).add(new A(0,7+Math.random()*22,0)),ko.copy(Mr).addScaledVector(n,6+Math.random()*8).add(new A(0,-3-Math.random()*3,-2)),ca.opacity=.95}if(_s){const t=(s-_s)/320;zl.lerpVectors(Mr,ko,t),kl.lerpVectors(Mr,ko,Math.max(0,t-.28)),Ku.setFromPoints([kl,zl]),ca.opacity=Math.max(0,.95*(1-t)),t>=1&&(_s=0,Gl=s+4500+Math.random()*8500)}}const rv=new Wn(60,32,32),ov=new me({color:3231025,roughness:.92,metalness:.02}),Da=new ne(rv,ov);Da.position.y=-60;Da.receiveShadow=!0;wt.add(Da);const Nr=$x();wt.add(Nr);const Qu=cx();wt.add(Qu);const eh=ax();wt.add(eh);const th=ox();wt.add(th);const nh=ix();wt.add(nh);const Fs=ev();wt.add(Fs);const av=[{y:gt[0]+3,color:16757370,intensity:1.1},{y:gt[1]+3,color:16769200,intensity:1.3},{y:gt[2]+3,color:16773840,intensity:1.2},{y:gt[3]+2.7,color:10471167,intensity:1}];av.forEach(s=>{const e=new Ca(s.color,s.intensity,9,2);e.position.set(0,s.y,-2),wt.add(e)});const jr=[Nr,Qu,eh,th,nh],la=new $_,Go=new he;function cv(){const s=[];return jr.forEach(e=>{e.traverse(t=>{if(t.userData&&t.userData.collidable){const n=new tn().setFromObject(t);s.push(n)}})}),Fs.traverse(e=>{e.userData&&e.userData.collidable&&s.push(new tn().setFromObject(e))}),s}let lv=cv();const _t=new Q_(nn,null,{gravity:-6,speed:4.2,runMultiplier:1.9}),uv=new A(0,_t.colliderRadius+.02,23),ih=new A(0,13,23);_t.setPosition(ih);const sh=new A(0,5.4,0);function rh(s){const e=new A().subVectors(s,_t.getPosition()).normalize();_t.yaw=Math.atan2(e.x,e.z),_t.pitch=Math.asin(e.y),_t.updateCamera()}rh(sh);let ti={start:ih.clone(),end:uv.clone(),startedAt:performance.now(),duration:4200};const hv=null;tx(Cn.domElement,hv,_t);const dv=new Qx(document.getElementById("ui-root")),oh=document.getElementById("ui-root"),Bs=document.createElement("div");Bs.className="dim-menu";Bs.innerHTML=`
