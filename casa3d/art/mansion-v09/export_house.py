...
assert S.name=='Mansion_Architecture_v09_Trees'
...
try:
    ...
    bpy.ops.export_scene.gltf(filepath=str(ROOT/'src/assets/models/mansion-v09.glb'),export_format='GLB',
...
result={'file':str(ROOT/'src/assets/models/mansion-v09.glb'),'bytes':(ROOT/'src/assets/models/mansion-v09.glb').stat().st_size,'objects':len(objects),'evaluated_modifiers':len(temporary)}
