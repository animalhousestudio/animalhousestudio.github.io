...
assert S.name=='Mansion_Architecture_v07_Refined'
...
try:
    ...
    bpy.ops.export_scene.gltf(filepath=str(ROOT/'src/assets/models/mansion-v07.glb'),export_format='GLB',
...
result={'file':str(ROOT/'src/assets/models/mansion-v07.glb'),'bytes':(ROOT/'src/assets/models/mansion-v07.glb').stat().st_size,'objects':len(objects),'evaluated_modifiers':len(temporary)}
